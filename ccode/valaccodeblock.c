...
static void vala_ccode_block_real_write (ValaCCodeNode* base, ValaCCodeWriter* writer) {
	...
	vala_ccode_writer_write_begin_block (_tmp0_);
	{
		...
		while (TRUE) {
			...
			_tmp15_ = statement;
			if (VALA_IS_CCODE_LABEL (_tmp15_)) {
				_tmp14_ = TRUE;
			} else {
				ValaCCodeNode* _tmp16_;
				_tmp16_ = statement;
				_tmp14_ = VALA_IS_CCODE_CASE_STATEMENT (_tmp16_);
			}
			_tmp17_ = _tmp14_;
			if (_tmp17_) {
				...
				gboolean _tmp27_;
				_tmp21_ = statement;
				if (VALA_IS_CCODE_RETURN_STATEMENT (_tmp21_)) {
					_tmp20_ = TRUE;
				} else {
					ValaCCodeNode* _tmp22_;
					_tmp22_ = statement;
					_tmp20_ = VALA_IS_CCODE_GOTO_STATEMENT (_tmp22_);
				}
				_tmp23_ = _tmp20_;
				if (_tmp23_) {
					_tmp19_ = TRUE;
					...
					_tmp24_ = statement;
					_tmp19_ = VALA_IS_CCODE_CONTINUE_STATEMENT (_tmp24_);
				}
				_tmp25_ = _tmp19_;
				if (_tmp25_) {
					_tmp18_ = TRUE;
					...
					_tmp26_ = statement;
					_tmp18_ = VALA_IS_CCODE_BREAK_STATEMENT (_tmp26_);
				}
				_tmp27_ = _tmp18_;
				if (_tmp27_) {

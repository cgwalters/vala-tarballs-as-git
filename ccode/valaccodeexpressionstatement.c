...
static void vala_ccode_expression_statement_real_write (ValaCCodeNode* base, ValaCCodeWriter* writer) {
	...
	if (VALA_IS_CCODE_COMMA_EXPRESSION (_tmp0_)) {
		...
		if (VALA_IS_CCODE_PARENTHESIZED_EXPRESSION (_tmp16_)) {
			...
			_tmp18_ = _vala_ccode_node_ref0 (VALA_IS_CCODE_PARENTHESIZED_EXPRESSION (_tmp17_) ? ((ValaCCodeParenthesizedExpression*) _tmp17_) : NULL);
			cpar = _tmp18_;
			_tmp19_ = writer;
			_tmp20_ = cpar;

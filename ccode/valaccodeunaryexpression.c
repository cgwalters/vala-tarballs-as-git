			...
			if (_tmp4_ == VALA_CCODE_UNARY_OPERATOR_LOGICAL_NEGATION) {
				...
				if (_tmp6_ == VALA_CCODE_UNARY_OPERATOR_BITWISE_COMPLEMENT) {
					...
					if (_tmp8_ == VALA_CCODE_UNARY_OPERATOR_POINTER_INDIRECTION) {
						...
						_tmp10_ = _vala_ccode_node_ref0 (VALA_IS_CCODE_UNARY_EXPRESSION (_tmp9_) ? ((ValaCCodeUnaryExpression*) _tmp9_) : NULL);
						inner_unary = _tmp10_;
						_tmp12_ = inner_unary;
						if (_tmp12_ != NULL) {
						...
						if (_tmp20_ == VALA_CCODE_UNARY_OPERATOR_ADDRESS_OF) {
							...
							_tmp22_ = _vala_ccode_node_ref0 (VALA_IS_CCODE_UNARY_EXPRESSION (_tmp21_) ? ((ValaCCodeUnaryExpression*) _tmp21_) : NULL);
							inner_unary = _tmp22_;
							_tmp24_ = inner_unary;
							if (_tmp24_ != NULL) {

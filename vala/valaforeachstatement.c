...
static void vala_foreach_statement_real_accept (ValaCodeNode* base, ValaCodeVisitor* visitor) {
	...
	if (_tmp0_) {
		...
		_tmp1_ = visitor;
		VALA_CODE_NODE_CLASS (vala_foreach_statement_parent_class)->accept ((ValaCodeNode*) VALA_BLOCK (self), _tmp1_);
		return;
	}
	_tmp2_ = visitor;
...
static void vala_foreach_statement_real_accept_children (ValaCodeNode* base, ValaCodeVisitor* visitor) {
	...
	if (_tmp0_) {
		ValaCodeVisitor* _tmp1_;
		_tmp1_ = visitor;
		VALA_CODE_NODE_CLASS (vala_foreach_statement_parent_class)->accept_children ((ValaCodeNode*) VALA_BLOCK (self), _tmp1_);
		return;
	}
...
static gboolean vala_foreach_statement_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	_tmp27_ = context;
	_tmp28_ = vala_code_context_get_profile (_tmp27_);
	_tmp29_ = _tmp28_;
	if (_tmp29_ != VALA_PROFILE_DOVA) {
		ValaDataType* _tmp30_;
		gboolean _tmp31_ = FALSE;
		_tmp30_ = collection_type;
		_tmp31_ = vala_data_type_is_array (_tmp30_);
		_tmp26_ = _tmp31_;
	} else {
		_tmp26_ = FALSE;
	}
	...
	if (_tmp32_) {
		...
		_tmp34_ = _vala_code_node_ref0 (VALA_ARRAY_TYPE (_tmp33_));
		array_type = _tmp34_;
		_tmp35_ = array_type;
		vala_array_type_set_inline_allocated (_tmp35_, FALSE);
		_tmp36_ = context;
		_tmp37_ = collection_type;
		_tmp38_ = array_type;
		_tmp39_ = vala_array_type_get_element_type (_tmp38_);
		_tmp40_ = _tmp39_;
		_tmp41_ = vala_foreach_statement_check_without_iterator (self, _tmp36_, _tmp37_, _tmp40_);
		result = _tmp41_;
		...
		if (_tmp45_ == VALA_PROFILE_GOBJECT) {
			...
			_tmp50_ = _tmp49_;
			_tmp51_ = _tmp50_->glist_type;
			_tmp52_ = vala_data_type_compatible (_tmp47_, _tmp51_);
			if (_tmp52_) {
				_tmp46_ = TRUE;
			} else {
				...
				_tmp56_ = _tmp55_;
				_tmp57_ = _tmp56_->gslist_type;
				_tmp58_ = vala_data_type_compatible (_tmp53_, _tmp57_);
				_tmp46_ = _tmp58_;
			}
			_tmp59_ = _tmp46_;
			_tmp42_ = _tmp59_;
		...
		if (_tmp60_) {
			...
			_tmp62_ = vala_data_type_get_type_arguments (_tmp61_);
			_tmp63_ = _tmp62_;
			...
			_tmp74_ = vala_data_type_get_type_arguments (_tmp73_);
			_tmp75_ = _tmp74_;
			_tmp76_ = vala_list_get (_tmp75_, 0);
			_tmp77_ = (ValaDataType*) _tmp76_;
			_tmp78_ = vala_foreach_statement_check_without_iterator (self, _tmp71_, _tmp72_, _tmp77_);
			_tmp79_ = _tmp78_;
			...
			gboolean _tmp90_;
			_tmp81_ = context;
			_tmp82_ = vala_code_context_get_profile (_tmp81_);
			_tmp83_ = _tmp82_;
			if (_tmp83_ == VALA_PROFILE_GOBJECT) {
				...
				_tmp87_ = _tmp86_;
				_tmp88_ = _tmp87_->gvaluearray_type;
				_tmp89_ = vala_data_type_compatible (_tmp84_, _tmp88_);
				_tmp80_ = _tmp89_;
			} else {
				_tmp80_ = FALSE;
			}
			...
			if (_tmp90_) {
				...
				ValaStructValueType* _tmp96_;
				gboolean _tmp97_ = FALSE;
				_tmp91_ = context;
				_tmp92_ = collection_type;
				_tmp93_ = context;
				_tmp94_ = vala_code_context_get_analyzer (_tmp93_);
				_tmp95_ = _tmp94_;
				_tmp96_ = _tmp95_->gvalue_type;
				_tmp97_ = vala_foreach_statement_check_without_iterator (self, _tmp91_, _tmp92_, (ValaDataType*) _tmp96_);
				result = _tmp97_;
				_vala_code_node_unref0 (collection_type);
				return result;
			} else {
				...
				_tmp98_ = context;
				_tmp99_ = collection_type;
				_tmp100_ = vala_foreach_statement_check_with_iterator (self, _tmp98_, _tmp99_);
				result = _tmp100_;
				_vala_code_node_unref0 (collection_type);
				return result;
			}
...
static gboolean vala_foreach_statement_check_with_index (ValaForeachStatement* self, ValaCodeContext* context, ValaDataType* collection_type) {
	...
	size_property = VALA_IS_PROPERTY (_tmp10_) ? ((ValaProperty*) _tmp10_) : NULL;
	...
	_tmp133_ = context;
	_tmp134_ = VALA_CODE_NODE_CLASS (vala_foreach_statement_parent_class)->check ((ValaCodeNode*) VALA_BLOCK (self), _tmp133_);
	result = _tmp134_;
...
static gboolean vala_foreach_statement_check_with_iterator (ValaForeachStatement* self, ValaCodeContext* context, ValaDataType* collection_type) {
	...
	iterator_method = VALA_IS_METHOD (_tmp4_) ? ((ValaMethod*) _tmp4_) : NULL;
	...
	next_value_method = VALA_IS_METHOD (_tmp69_) ? ((ValaMethod*) _tmp69_) : NULL;
	_tmp70_ = iterator_type;
	_tmp71_ = vala_data_type_get_member (_tmp70_, "next");
	next_method = VALA_IS_METHOD (_tmp71_) ? ((ValaMethod*) _tmp71_) : NULL;
	...
	if (_tmp72_ != NULL) {
		...
		if (_tmp159_ != NULL) {
			...
			get_method = VALA_IS_METHOD (_tmp193_) ? ((ValaMethod*) _tmp193_) : NULL;
			_tmp194_ = get_method;
			if (_tmp194_ == NULL) {
	...
	vala_code_node_set_checked ((ValaCodeNode*) self, FALSE);
	_tmp296_ = context;
	_tmp297_ = VALA_CODE_NODE_CLASS (vala_foreach_statement_parent_class)->check ((ValaCodeNode*) VALA_BLOCK (self), _tmp296_);
	result = _tmp297_;
	_vala_code_node_unref0 (next_method);
	_vala_code_node_unref0 (next_value_method);
	_vala_code_node_unref0 (iterator_call);
...
static void vala_foreach_statement_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	if (_tmp0_) {
		...
		_tmp1_ = codegen;
		VALA_CODE_NODE_CLASS (vala_foreach_statement_parent_class)->emit ((ValaCodeNode*) VALA_BLOCK (self), _tmp1_);
		return;
	}
	_tmp2_ = vala_foreach_statement_get_collection (self);
	_tmp3_ = _tmp2_;

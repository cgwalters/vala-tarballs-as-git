...
static gboolean vala_lambda_expression_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	ValaMethod* _tmp280_;
	ValaMethodType* _tmp281_;
	ValaMethodType* _tmp282_;
	...
	_tmp9_ = _tmp8_;
	_tmp10_ = vala_delegate_type_get_delegate_symbol (VALA_DELEGATE_TYPE (_tmp9_));
	_tmp11_ = _tmp10_;
	_tmp12_ = _vala_code_node_ref0 (VALA_DELEGATE (_tmp11_));
	cb = _tmp12_;
	_tmp13_ = cb;
	...
	if (_tmp42_) {
		...
		while (TRUE) {
			...
			if (VALA_IS_PROPERTY (_tmp53_)) {
				...
				_tmp54_ = sym;
				_tmp55_ = _vala_code_node_ref0 (VALA_PROPERTY (_tmp54_));
				prop = _tmp55_;
				...
				if (VALA_IS_CONSTRUCTOR (_tmp60_)) {
					...
					_tmp61_ = sym;
					_tmp62_ = _vala_code_node_ref0 (VALA_CONSTRUCTOR (_tmp61_));
					c = _tmp62_;
					...
					if (VALA_IS_DESTRUCTOR (_tmp67_)) {
						...
						_tmp68_ = sym;
						_tmp69_ = _vala_code_node_ref0 (VALA_DESTRUCTOR (_tmp68_));
						d = _tmp69_;
	...
	_tmp94_ = self->priv->_method;
	_tmp95_ = vala_method_get_return_type (_tmp94_);
	_tmp96_ = _tmp95_;
	if (!VALA_IS_VOID_TYPE (_tmp96_)) {
		...
		_tmp100_ = _tmp99_;
		_tmp93_ = _tmp100_ == VALA_PROFILE_DOVA;
	...
	if (_tmp101_) {
		...
		_tmp103_ = self->priv->_method;
		_tmp104_ = vala_method_get_return_type (_tmp103_);
		_tmp105_ = _tmp104_;
		_tmp106_ = vala_data_type_copy (_tmp105_);
		_tmp107_ = _tmp106_;
		_tmp108_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
		_tmp109_ = _tmp108_;
		_tmp110_ = vala_local_variable_new (_tmp107_, "result", NULL, _tmp109_);
		_tmp111_ = _tmp110_;
		vala_subroutine_set_result_var ((ValaSubroutine*) _tmp102_, _tmp111_);
		_vala_code_node_unref0 (_tmp111_);
		_vala_code_node_unref0 (_tmp107_);
		_tmp112_ = self->priv->_method;
		_tmp113_ = vala_subroutine_get_result_var ((ValaSubroutine*) _tmp112_);
		_tmp114_ = _tmp113_;
		vala_local_variable_set_is_result (_tmp114_, TRUE);
	}
	_tmp115_ = vala_lambda_expression_get_parameters (self);
	lambda_params = _tmp115_;
	_tmp116_ = lambda_params;
	_tmp117_ = vala_iterable_iterator ((ValaIterable*) _tmp116_);
	lambda_param_it = _tmp117_;
	_tmp119_ = cb;
	_tmp120_ = vala_delegate_get_sender_type (_tmp119_);
	_tmp121_ = _tmp120_;
	if (_tmp121_ != NULL) {
		ValaList* _tmp122_;
		gint _tmp123_;
	...
	if (_tmp130_) {
		...
		vala_iterator_next (_tmp131_);
		_tmp132_ = lambda_param_it;
		_tmp133_ = vala_iterator_get (_tmp132_);
		lambda_param = (ValaParameter*) _tmp133_;
		_tmp134_ = lambda_param;
		_tmp135_ = cb;
		_tmp136_ = vala_delegate_get_sender_type (_tmp135_);
		_tmp137_ = _tmp136_;
		vala_variable_set_variable_type ((ValaVariable*) _tmp134_, _tmp137_);
		_tmp138_ = self->priv->_method;
		_tmp139_ = lambda_param;
		vala_method_add_parameter (_tmp138_, _tmp139_);
	...
	}
	{
		...
		_tmp140_ = cb;
		_tmp141_ = vala_delegate_get_parameters (_tmp140_);
		_cb_param_list = _tmp141_;
		_tmp142_ = _cb_param_list;
		_tmp143_ = vala_collection_get_size ((ValaCollection*) _tmp142_);
		_tmp144_ = _tmp143_;
		_cb_param_size = _tmp144_;
		_cb_param_index = -1;
		while (TRUE) {
			gint _tmp145_;
			gint _tmp146_;
			...
			ValaIterator* _tmp151_;
			gboolean _tmp152_ = FALSE;
			ValaIterator* _tmp153_;
			...
			_tmp145_ = _cb_param_index;
			_cb_param_index = _tmp145_ + 1;
			_tmp146_ = _cb_param_index;
			_tmp147_ = _cb_param_size;
			if (!(_tmp146_ < _tmp147_)) {
				break;
			}
			_tmp148_ = _cb_param_list;
			_tmp149_ = _cb_param_index;
			_tmp150_ = vala_list_get (_tmp148_, _tmp149_);
			cb_param = (ValaParameter*) _tmp150_;
			_tmp151_ = lambda_param_it;
			_tmp152_ = vala_iterator_next (_tmp151_);
			if (!_tmp152_) {
				_vala_code_node_unref0 (cb_param);
				break;
			}
			_tmp153_ = lambda_param_it;
			_tmp154_ = vala_iterator_get (_tmp153_);
			lambda_param = (ValaParameter*) _tmp154_;
			_tmp155_ = lambda_param;
			_tmp156_ = cb_param;
			...
			_tmp160_ = _tmp159_;
			_tmp161_ = vala_data_type_get_actual_type (_tmp158_, _tmp160_, NULL, (ValaCodeNode*) self);
			_tmp162_ = _tmp161_;
			vala_variable_set_variable_type ((ValaVariable*) _tmp155_, _tmp162_);
			_vala_code_node_unref0 (_tmp162_);
			_tmp163_ = self->priv->_method;
			_tmp164_ = lambda_param;
			vala_method_add_parameter (_tmp163_, _tmp164_);
			_vala_code_node_unref0 (lambda_param);
			_vala_code_node_unref0 (cb_param);
		}
		_vala_iterable_unref0 (_cb_param_list);
	}
	_tmp165_ = lambda_param_it;
	_tmp166_ = vala_iterator_next (_tmp165_);
	if (_tmp166_) {
	...
	}
	{
		...
		while (TRUE) {
			...
			_error_type_index = _tmp174_ + 1;
			_tmp175_ = _error_type_index;
			_tmp176_ = _error_type_size;
			...
			error_type = (ValaDataType*) _tmp179_;
			_tmp180_ = self->priv->_method;
			_tmp181_ = error_type;
			_tmp182_ = vala_data_type_copy (_tmp181_);
			_tmp183_ = _tmp182_;
			vala_code_node_add_error_type ((ValaCodeNode*) _tmp180_, _tmp183_);
	...
	if (_tmp184_ != NULL) {
		...
		_tmp186_ = _tmp185_;
		_tmp187_ = vala_block_new (_tmp186_);
		block = _tmp187_;
		_tmp188_ = block;
		...
		_tmp193_ = _tmp192_;
		vala_scope_set_parent_scope (_tmp190_, _tmp193_);
		_tmp194_ = self->priv->_method;
		_tmp195_ = vala_method_get_return_type (_tmp194_);
		_tmp196_ = _tmp195_;
		_tmp197_ = vala_data_type_get_data_type (_tmp196_);
		_tmp198_ = _tmp197_;
		if (_tmp198_ != NULL) {
			ValaCodeContext* _tmp199_;
			ValaProfile _tmp200_;
			ValaProfile _tmp201_;
			_tmp199_ = context;
			_tmp200_ = vala_code_context_get_profile (_tmp199_);
			_tmp201_ = _tmp200_;
			if (_tmp201_ == VALA_PROFILE_DOVA) {
				ValaBlock* _tmp202_;
				...
				ValaReturnStatement* _tmp219_;
				ValaReturnStatement* _tmp220_;
				_tmp202_ = block;
				_tmp203_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
				_tmp204_ = _tmp203_;
				_tmp205_ = vala_member_access_new_simple ("result", _tmp204_);
				_tmp206_ = _tmp205_;
				_tmp207_ = self->priv->_expression_body;
				_tmp208_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
				_tmp209_ = _tmp208_;
				_tmp210_ = vala_assignment_new ((ValaExpression*) _tmp206_, _tmp207_, VALA_ASSIGNMENT_OPERATOR_SIMPLE, _tmp209_);
				_tmp211_ = _tmp210_;
				_tmp212_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
				_tmp213_ = _tmp212_;
				_tmp214_ = vala_expression_statement_new ((ValaExpression*) _tmp211_, _tmp213_);
				_tmp215_ = _tmp214_;
				vala_block_add_statement (_tmp202_, (ValaStatement*) _tmp215_);
				...
				_tmp218_ = _tmp217_;
				_tmp219_ = vala_return_statement_new (NULL, _tmp218_);
				_tmp220_ = _tmp219_;
				vala_block_add_statement (_tmp216_, (ValaStatement*) _tmp220_);
				...
				ValaReturnStatement* _tmp225_;
				ValaReturnStatement* _tmp226_;
				_tmp221_ = block;
				_tmp222_ = self->priv->_expression_body;
				_tmp223_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
				_tmp224_ = _tmp223_;
				_tmp225_ = vala_return_statement_new (_tmp222_, _tmp224_);
				_tmp226_ = _tmp225_;
				vala_block_add_statement (_tmp221_, (ValaStatement*) _tmp226_);
			...
			_tmp227_ = block;
			_tmp228_ = self->priv->_expression_body;
			_tmp229_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
			_tmp230_ = _tmp229_;
			_tmp231_ = vala_expression_statement_new (_tmp228_, _tmp230_);
			_tmp232_ = _tmp231_;
			vala_block_add_statement (_tmp227_, (ValaStatement*) _tmp232_);
			_vala_code_node_unref0 (_tmp232_);
		}
		_tmp233_ = self->priv->_method;
		_tmp234_ = block;
		vala_subroutine_set_body ((ValaSubroutine*) _tmp233_, _tmp234_);
		_vala_code_node_unref0 (block);
	} else {
		ValaMethod* _tmp235_;
		ValaBlock* _tmp236_;
		_tmp235_ = self->priv->_method;
		_tmp236_ = self->priv->_statement_body;
		vala_subroutine_set_body ((ValaSubroutine*) _tmp235_, _tmp236_);
	}
	_tmp237_ = self->priv->_method;
	_tmp238_ = vala_subroutine_get_body ((ValaSubroutine*) _tmp237_);
	_tmp239_ = _tmp238_;
	_tmp240_ = self->priv->_method;
	_tmp241_ = vala_symbol_get_scope ((ValaSymbol*) _tmp240_);
	_tmp242_ = _tmp241_;
	vala_symbol_set_owner ((ValaSymbol*) _tmp239_, _tmp242_);
	_tmp243_ = context;
	_tmp244_ = vala_code_context_get_analyzer (_tmp243_);
	_tmp245_ = _tmp244_;
	_tmp246_ = context;
	_tmp247_ = vala_code_context_get_analyzer (_tmp246_);
	_tmp248_ = _tmp247_;
	_tmp249_ = vala_semantic_analyzer_get_current_symbol (_tmp248_);
	_tmp250_ = _tmp249_;
	_tmp251_ = vala_semantic_analyzer_find_parent_method (_tmp245_, _tmp250_);
	m = _tmp251_;
	_tmp252_ = m;
	if (_tmp252_ != NULL) {
		{
			...
			_tmp253_ = m;
			_tmp254_ = vala_method_get_type_parameters (_tmp253_);
			...
			while (TRUE) {
				...
				_tmp270_ = _tmp269_;
				_tmp271_ = vala_typeparameter_new (_tmp267_, _tmp270_);
				_tmp272_ = _tmp271_;
				vala_method_add_type_parameter (_tmp264_, _tmp272_);
				_vala_code_node_unref0 (_tmp272_);
				_tmp273_ = self->priv->_method;
				vala_method_set_closure (_tmp273_, TRUE);
				_tmp274_ = m;
				_tmp275_ = vala_subroutine_get_body ((ValaSubroutine*) _tmp274_);
				_tmp276_ = _tmp275_;
				vala_block_set_captured (_tmp276_, TRUE);
				_vala_code_node_unref0 (type_param);
			}
			_vala_iterable_unref0 (_type_param_list);
		}
	}
	_tmp277_ = self->priv->_method;
	vala_expression_set_symbol_reference ((ValaExpression*) self, (ValaSymbol*) _tmp277_);
	_tmp278_ = self->priv->_method;
	_tmp279_ = context;
	vala_code_node_check ((ValaCodeNode*) _tmp278_, _tmp279_);
	_tmp280_ = self->priv->_method;
	_tmp281_ = vala_method_type_new (_tmp280_);
	_tmp282_ = _tmp281_;
	vala_expression_set_value_type ((ValaExpression*) self, (ValaDataType*) _tmp282_);
	...
	_tmp286_ = _tmp285_;
	_tmp287_ = vala_data_type_get_value_owned (_tmp286_);
	_tmp288_ = _tmp287_;
	vala_data_type_set_value_owned (_tmp284_, _tmp288_);
...
static void vala_lambda_expression_real_get_used_variables (ValaCodeNode* base, ValaCollection* collection) {
	...
	if (_tmp2_) {
		...
		_tmp4_ = collection;
		vala_method_get_captured_variables (_tmp3_, VALA_COLLECTION (_tmp4_));
	}
}

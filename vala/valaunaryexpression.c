...
static gboolean vala_unary_expression_real_is_constant (ValaExpression* base) {
	...
	if (_tmp7_) {
		...
		_tmp11_ = _tmp10_;
		_tmp12_ = _vala_code_node_ref0 (VALA_IS_FIELD (_tmp11_) ? ((ValaField*) _tmp11_) : NULL);
		field = _tmp12_;
		_tmp14_ = field;
		if (_tmp14_ != NULL) {
			ValaField* _tmp15_;
...
static gboolean vala_unary_expression_is_numeric_type (ValaUnaryExpression* self, ValaDataType* type) {
	...
	_tmp5_ = _tmp4_;
	_tmp6_ = _vala_code_node_ref0 (VALA_STRUCT (_tmp5_));
	st = _tmp6_;
	_tmp8_ = st;
...
static gboolean vala_unary_expression_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	_tmp27_ = _tmp26_;
	if (VALA_IS_FIELD_PROTOTYPE (_tmp27_)) {
		...
		if (_tmp63_ == VALA_UNARY_OPERATOR_LOGICAL_NEGATION) {
			...
			if (_tmp87_ == VALA_UNARY_OPERATOR_BITWISE_COMPLEMENT) {
				...
				if (!_tmp93_) {
					...
					_tmp97_ = _tmp96_;
					_tmp88_ = !VALA_IS_ENUM_VALUE_TYPE (_tmp97_);
				} else {
					_tmp88_ = FALSE;
				}
				_tmp98_ = _tmp88_;
				...
				if (_tmp116_) {
					...
					if (_tmp179_) {
						...
						_tmp181_ = _tmp180_;
						_tmp182_ = _vala_code_node_ref0 (VALA_IS_ELEMENT_ACCESS (_tmp181_) ? ((ValaElementAccess*) _tmp181_) : NULL);
						ea = _tmp182_;
						_tmp186_ = vala_unary_expression_get_inner (self);
						_tmp187_ = _tmp186_;
						_tmp188_ = vala_expression_get_symbol_reference (_tmp187_);
						_tmp189_ = _tmp188_;
						if (VALA_IS_FIELD (_tmp189_)) {
							_tmp185_ = TRUE;
						} else {
							...
							_tmp193_ = _tmp192_;
							_tmp185_ = VALA_IS_PARAMETER (_tmp193_);
						}
						_tmp194_ = _tmp185_;
						if (_tmp194_) {
							_tmp184_ = TRUE;
							...
							_tmp198_ = _tmp197_;
							_tmp184_ = VALA_IS_LOCAL_VARIABLE (_tmp198_);
						}
						_tmp199_ = _tmp184_;
						if (_tmp199_) {
							_tmp183_ = TRUE;
							...
							if (_tmp201_ != NULL) {
								...
								_tmp206_ = _tmp205_;
								_tmp200_ = VALA_IS_ARRAY_TYPE (_tmp206_);
							} else {
								_tmp200_ = FALSE;
							}
							_tmp207_ = _tmp200_;
...
static void vala_unary_expression_real_get_defined_variables (ValaCodeNode* base, ValaCollection* collection) {
	...
	if (_tmp6_) {
		...
		_tmp15_ = _tmp14_;
		_tmp16_ = _vala_code_node_ref0 (VALA_IS_PARAMETER (_tmp15_) ? ((ValaParameter*) _tmp15_) : NULL);
		param = _tmp16_;
		_tmp17_ = local;
		if (_tmp17_ != NULL) {

...
static ValaDataType* vala_integer_type_real_copy (ValaDataType* base) {
	...
	_tmp4_ = vala_integer_type_new (VALA_STRUCT (_tmp1_), _tmp2_, _tmp3_);
	_result_ = _tmp4_;
...
static gboolean vala_integer_type_real_compatible (ValaDataType* base, ValaDataType* target_type) {
	...
	if (_tmp5_) {
		...
		_tmp8_ = _tmp7_;
		_tmp9_ = _vala_code_node_ref0 (VALA_STRUCT (_tmp8_));
		target_st = _tmp9_;
		_tmp10_ = target_st;
	...
	_tmp41_ = target_type;
	_tmp42_ = VALA_DATA_TYPE_CLASS (vala_integer_type_parent_class)->compatible ((ValaDataType*) VALA_VALUE_TYPE (self), _tmp41_);
	result = _tmp42_;
	return result;
}

...
ValaSourceReference* vala_source_reference_construct (GType object_type, ValaSourceFile* _file, gint _first_line, gint _first_column, gint _last_line, gint _last_column) {
	...
	_tmp1_ = _first_line;
	vala_source_reference_set_first_line (self, _tmp1_);
	_tmp2_ = _first_column;
	vala_source_reference_set_first_column (self, _tmp2_);
	_tmp3_ = _last_line;
	vala_source_reference_set_last_line (self, _tmp3_);
	_tmp4_ = _last_column;
	vala_source_reference_set_last_column (self, _tmp4_);
	_tmp5_ = self->priv->_file;
	_tmp6_ = vala_source_file_get_current_using_directives (_tmp5_);
	_tmp7_ = _tmp6_;
	vala_source_reference_set_using_directives (self, _tmp7_);
	return self;
}
...
gchar* vala_source_reference_to_string (ValaSourceReference* self) {
	...
	_tmp2_ = _tmp1_;
	_tmp3_ = self->priv->_first_line;
	_tmp4_ = self->priv->_first_column;
	_tmp5_ = self->priv->_last_line;
	_tmp6_ = self->priv->_last_column;
	_tmp7_ = g_strdup_printf ("%s:%d.%d-%d.%d", _tmp2_, _tmp3_, _tmp4_, _tmp5_, _tmp6_);
	_tmp8_ = _tmp7_;
	_g_free0 (_tmp2_);
	result = _tmp8_;
	return result;
...
void vala_source_reference_set_first_column (ValaSourceReference* self, gint value) {
	...
	g_return_if_fail (self != NULL);
	_tmp0_ = value;
	self->priv->_first_column = _tmp0_;
}

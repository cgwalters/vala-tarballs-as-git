...
static gboolean vala_pointer_type_real_compatible (ValaDataType* base, ValaDataType* target_type) {
	...
	_tmp0_ = target_type;
	if (VALA_IS_POINTER_TYPE (_tmp0_)) {
		ValaDataType* _tmp1_;
		...
		_tmp1_ = target_type;
		_tmp2_ = _vala_code_node_ref0 (VALA_IS_POINTER_TYPE (_tmp1_) ? ((ValaPointerType*) _tmp1_) : NULL);
		tt = _tmp2_;
		_tmp4_ = tt;
		_tmp5_ = vala_pointer_type_get_base_type (_tmp4_);
		_tmp6_ = _tmp5_;
		if (VALA_IS_VOID_TYPE (_tmp6_)) {
			_tmp3_ = TRUE;
		} else {
			ValaDataType* _tmp7_;
			ValaDataType* _tmp8_;
			...
			_tmp8_ = _tmp7_;
			_tmp3_ = VALA_IS_VOID_TYPE (_tmp8_);
		}
		_tmp9_ = _tmp3_;
		if (_tmp9_) {
			result = TRUE;
	...
	_tmp48_ = _tmp47_;
	_tmp49_ = _tmp48_ == VALA_PROFILE_GOBJECT;
	...
	if (_tmp53_) {
		...
		_tmp56_ = _tmp55_;
		_tmp57_ = vala_code_context_get ();
		_tmp58_ = _tmp57_;
		_tmp59_ = vala_code_context_get_analyzer (_tmp58_);
		_tmp60_ = _tmp59_;
		_tmp61_ = _tmp60_->gvalue_type;
		_tmp62_ = vala_data_type_get_data_type ((ValaDataType*) _tmp61_);
		_tmp63_ = _tmp62_;
		_tmp64_ = vala_typesymbol_is_subtype_of (_tmp56_, _tmp63_);
		_tmp43_ = _tmp64_;
		_vala_code_context_unref0 (_tmp58_);
	} else {
		_tmp43_ = FALSE;
	}
	_tmp65_ = _tmp43_;
...
static ValaSymbol* vala_pointer_type_real_get_member (ValaDataType* base, const gchar* member_name) {
	...
	_tmp11_ = base_symbol;
	_tmp12_ = member_name;
	_tmp13_ = vala_semantic_analyzer_symbol_lookup_inherited (_tmp11_, _tmp12_);
	result = _tmp13_;
	_vala_code_node_unref0 (base_symbol);
	return result;
}
...
static ValaDataType* vala_pointer_type_real_get_actual_type (ValaDataType* base, ValaDataType* derived_instance_type, ValaMemberAccess* method_access, ValaCodeNode* node_reference) {
	...
	if (_tmp12_) {
		...
		_result_ = VALA_POINTER_TYPE (_tmp14_);
		_tmp15_ = _result_;
		_tmp16_ = _result_;

...
static gboolean vala_local_variable_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	if (_tmp23_ == NULL) {
		...
		_tmp37_ = _tmp36_;
		if (VALA_IS_FIELD_PROTOTYPE (_tmp37_)) {
	...
	if (_tmp71_) {
		...
		if (_tmp75_ == NULL) {
			...
			if (_tmp91_) {
				...
				_tmp95_ = _tmp94_;
				_tmp96_ = _vala_code_node_ref0 (VALA_METHOD (_tmp95_));
				m = _tmp96_;
				_tmp97_ = vala_variable_get_variable_type ((ValaVariable*) self);
				_tmp98_ = _tmp97_;
				_tmp99_ = _vala_code_node_ref0 (VALA_DELEGATE_TYPE (_tmp98_));
				dt = _tmp99_;
				_tmp100_ = dt;
	...
	_tmp173_ = _tmp172_;
	_tmp174_ = _vala_code_node_ref0 (VALA_IS_BLOCK (_tmp173_) ? ((ValaBlock*) _tmp173_) : NULL);
	block = _tmp174_;
	_tmp175_ = block;
	if (_tmp175_ != NULL) {
		ValaBlock* _tmp176_;

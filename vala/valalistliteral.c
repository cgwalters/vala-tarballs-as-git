...
static gboolean vala_list_literal_real_check (ValaCodeNode* base, ValaCodeContext* context);
...
static void vala_list_literal_real_accept (ValaCodeNode* base, ValaCodeVisitor* visitor) {
	...
	g_return_if_fail (visitor != NULL);
	_tmp0_ = visitor;
	vala_code_visitor_visit_list_literal (_tmp0_, self);
	_tmp1_ = visitor;
...
static gboolean vala_list_literal_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	if (_tmp8_ != NULL) {
		...
		gboolean _tmp11_;
		_tmp9_ = array_type;
		_tmp10_ = vala_array_type_get_inline_allocated (_tmp9_);
		_tmp11_ = _tmp10_;
		_tmp7_ = _tmp11_;
	} else {
		_tmp7_ = FALSE;
	...
	if (_tmp12_) {
		...
		_tmp14_ = _tmp13_;
		_tmp15_ = vala_initializer_list_new (_tmp14_);
		initializer = _tmp15_;
		_tmp16_ = initializer;
		_tmp17_ = vala_expression_get_target_type ((ValaExpression*) self);
		_tmp18_ = _tmp17_;
		vala_expression_set_target_type ((ValaExpression*) _tmp16_, _tmp18_);
		{
			ValaList* _tmp19_;
			ValaList* _tmp20_;
			ValaList* _expr_list;
			...
			gint _expr_size;
			gint _expr_index;
			_tmp19_ = self->priv->expression_list;
			...
			while (TRUE) {
				...
				_tmp30_ = initializer;
				_tmp31_ = expr;
				vala_initializer_list_append (_tmp30_, _tmp31_);
				_vala_code_node_unref0 (expr);
			}
			_vala_iterable_unref0 (_expr_list);
		}
		...
		_tmp34_ = _tmp33_;
		_tmp35_ = _tmp34_->replaced_nodes;
		vala_collection_add ((ValaCollection*) _tmp35_, (ValaCodeNode*) self);
		_tmp36_ = vala_code_node_get_parent_node ((ValaCodeNode*) self);
		_tmp37_ = _tmp36_;
		_tmp38_ = initializer;
		vala_code_node_replace_expression (_tmp37_, (ValaExpression*) self, (ValaExpression*) _tmp38_);
		_tmp39_ = initializer;
		_tmp40_ = context;
		_tmp41_ = vala_code_node_check ((ValaCodeNode*) _tmp39_, _tmp40_);
		result = _tmp41_;
	...
	_tmp42_ = context;
	_tmp43_ = vala_code_context_get_root (_tmp42_);
	_tmp44_ = _tmp43_;
	_tmp45_ = vala_symbol_get_scope ((ValaSymbol*) _tmp44_);
	_tmp46_ = _tmp45_;
	_tmp47_ = vala_scope_lookup (_tmp46_, "Dova");
	_tmp48_ = _tmp47_;
	_tmp49_ = vala_symbol_get_scope (_tmp48_);
	_tmp50_ = _tmp49_;
	_tmp51_ = vala_scope_lookup (_tmp50_, "List");
	_tmp52_ = VALA_CLASS (_tmp51_);
	_tmp53_ = vala_object_type_new ((ValaObjectTypeSymbol*) _tmp52_);
	_tmp54_ = _tmp53_;
	_vala_code_node_unref0 (_tmp52_);
	_vala_code_node_unref0 (_tmp48_);
	list_type = _tmp54_;
	_tmp55_ = list_type;
	vala_data_type_set_value_owned ((ValaDataType*) _tmp55_, TRUE);
	...
	if (_tmp59_ != NULL) {
		...
		_tmp63_ = _tmp62_;
		_tmp64_ = list_type;
		_tmp65_ = vala_data_type_get_data_type ((ValaDataType*) _tmp64_);
		_tmp66_ = _tmp65_;
		_tmp57_ = _tmp63_ == _tmp66_;
	} else {
		_tmp57_ = FALSE;
	}
	_tmp67_ = _tmp57_;
	...
	if (_tmp74_) {
		...
		_tmp80_ = (ValaDataType*) _tmp79_;
		_tmp81_ = vala_data_type_copy (_tmp80_);
		_tmp82_ = _tmp81_;
		vala_list_literal_set_element_type (self, _tmp82_);
		_vala_code_node_unref0 (_tmp82_);
		_vala_code_node_unref0 (_tmp80_);
		_vala_iterable_unref0 (_tmp78_);
		_tmp83_ = self->priv->_element_type;
		vala_data_type_set_value_owned (_tmp83_, FALSE);
	...
	}
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp84_ = FALSE;
				_tmp87_ = i;
				_tmp88_ = self->priv->expression_list;
				_tmp89_ = vala_collection_get_size ((ValaCollection*) _tmp88_);
				_tmp90_ = _tmp89_;
				if (!(_tmp87_ < _tmp90_)) {
					break;
				}
				_tmp91_ = self->priv->expression_list;
				_tmp92_ = i;
				_tmp93_ = vala_list_get (_tmp91_, _tmp92_);
				expr = (ValaExpression*) _tmp93_;
				_tmp94_ = fixed_element_type;
				if (_tmp94_) {
					ValaExpression* _tmp95_;
					ValaDataType* _tmp96_;
					_tmp95_ = expr;
					_tmp96_ = self->priv->_element_type;
					vala_expression_set_target_type (_tmp95_, _tmp96_);
				}
				_tmp97_ = expr;
				_tmp98_ = context;
				_tmp99_ = vala_code_node_check ((ValaCodeNode*) _tmp97_, _tmp98_);
				if (!_tmp99_) {
					result = FALSE;
					_vala_code_node_unref0 (expr);
				...
				_tmp100_ = self->priv->expression_list;
				_tmp101_ = i;
				_tmp102_ = vala_list_get (_tmp100_, _tmp101_);
				_vala_code_node_unref0 (expr);
				expr = (ValaExpression*) _tmp102_;
				_tmp103_ = self->priv->_element_type;
				if (_tmp103_ == NULL) {
					...
					_tmp108_ = _tmp107_;
					vala_list_literal_set_element_type (self, _tmp108_);
					_vala_code_node_unref0 (_tmp108_);
					_tmp109_ = self->priv->_element_type;
	...
	_tmp110_ = self->priv->_element_type;
	if (_tmp110_ == NULL) {
		...
		_tmp112_ = _tmp111_;
		vala_report_error (_tmp112_, "cannot infer element type for list literal");
		result = FALSE;
		_vala_code_node_unref0 (list_type);
		_vala_code_node_unref0 (array_type);
		return result;
	}
	_tmp113_ = self->priv->_element_type;
	_tmp114_ = vala_data_type_copy (_tmp113_);
	_tmp115_ = _tmp114_;
	vala_list_literal_set_element_type (self, _tmp115_);
	_vala_code_node_unref0 (_tmp115_);
	_tmp116_ = self->priv->_element_type;
	vala_data_type_set_value_owned (_tmp116_, TRUE);
	_tmp117_ = list_type;
	_tmp118_ = self->priv->_element_type;
	vala_data_type_add_type_argument ((ValaDataType*) _tmp117_, _tmp118_);
	_tmp119_ = list_type;
	vala_expression_set_value_type ((ValaExpression*) self, (ValaDataType*) _tmp119_);
...
static void vala_list_literal_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	_tmp13_ = codegen;
	vala_code_visitor_visit_list_literal ((ValaCodeVisitor*) _tmp13_, self);
	_tmp14_ = codegen;

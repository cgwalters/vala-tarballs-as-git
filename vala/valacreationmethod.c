...
static gboolean vala_creation_method_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	if (_tmp97_ != NULL) {
		...
		_tmp102_ = _tmp101_;
		_tmp103_ = _vala_code_node_ref0 (VALA_IS_CLASS (_tmp102_) ? ((ValaClass*) _tmp102_) : NULL);
		cl = _tmp103_;
		...
		if (_tmp112_) {
			...
			if (_tmp123_) {
				...
				_tmp128_ = _tmp127_;
				_tmp129_ = vala_method_get_has_construct_function (_tmp128_);
				_tmp130_ = _tmp129_;
				_tmp113_ = !_tmp130_;
			} else {
				_tmp113_ = FALSE;
			...
			if (_tmp131_) {
				...
				_tmp141_ = _tmp140_;
				vala_semantic_analyzer_set_current_symbol (_tmp139_, (ValaSymbol*) _tmp141_);
				_tmp142_ = context;
				_tmp143_ = vala_code_context_get_analyzer (_tmp142_);
				_tmp144_ = _tmp143_;
				_tmp145_ = vala_subroutine_get_body ((ValaSubroutine*) self);
				_tmp146_ = _tmp145_;
				_tmp147_ = _vala_code_node_ref0 (_tmp146_);
				_vala_code_node_unref0 (_tmp144_->insert_block);
				_tmp144_->insert_block = _tmp147_;
				_tmp148_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
				_tmp149_ = _tmp148_;
				_tmp150_ = vala_member_access_new_simple ("GLib", _tmp149_);
				_tmp151_ = _tmp150_;
				_tmp152_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
				_tmp153_ = _tmp152_;
				_tmp154_ = vala_member_access_new ((ValaExpression*) _tmp151_, "Object", _tmp153_);
				_tmp155_ = _tmp154_;
				_tmp156_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
				_tmp157_ = _tmp156_;
				_tmp158_ = vala_method_call_new ((ValaExpression*) _tmp155_, _tmp157_);
				_tmp159_ = _tmp158_;
				_tmp160_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
				_tmp161_ = _tmp160_;
				_tmp162_ = vala_expression_statement_new ((ValaExpression*) _tmp159_, _tmp161_);
				_tmp163_ = _tmp162_;
				...
				_tmp165_ = _tmp164_;
				_tmp166_ = stmt;
				vala_block_insert_statement (_tmp165_, 0, (ValaStatement*) _tmp166_);
				_tmp167_ = stmt;
				_tmp168_ = context;
				vala_code_node_check ((ValaCodeNode*) _tmp167_, _tmp168_);
				_tmp169_ = context;
				_tmp170_ = vala_code_context_get_analyzer (_tmp169_);
				_tmp171_ = _tmp170_;
				vala_semantic_analyzer_set_current_symbol (_tmp171_, (ValaSymbol*) self);
				_tmp172_ = context;
				_tmp173_ = vala_code_context_get_analyzer (_tmp172_);
				_tmp174_ = _tmp173_;
				_tmp175_ = old_insert_block;
				_tmp176_ = _vala_code_node_ref0 (_tmp175_);
				_vala_code_node_unref0 (_tmp174_->insert_block);
				_tmp174_->insert_block = _tmp176_;
				...
				if (_tmp182_ == NULL) {
					...
					_tmp187_ = _tmp186_;
					_tmp188_ = vala_symbol_get_access ((ValaSymbol*) _tmp187_);
					_tmp189_ = _tmp188_;
					_tmp177_ = _tmp189_ == VALA_SYMBOL_ACCESSIBILITY_PRIVATE;
				}
				_tmp190_ = _tmp177_;
				if (_tmp190_) {
					...
					_tmp197_ = _tmp196_;
					_tmp198_ = vala_method_get_required_arguments (_tmp197_);
					if (_tmp198_ > 0) {
						ValaSourceReference* _tmp199_;
						ValaSourceReference* _tmp200_;
						_tmp199_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
						_tmp200_ = _tmp199_;
						vala_report_error (_tmp200_, "unable to chain up to base constructor requiring arguments");
					} else {
						...
						ValaBaseAccess* _tmp219_;
						ValaBaseAccess* _tmp220_;
						...
						_tmp210_ = _tmp209_;
						vala_semantic_analyzer_set_current_symbol (_tmp208_, (ValaSymbol*) _tmp210_);
						_tmp211_ = context;
						_tmp212_ = vala_code_context_get_analyzer (_tmp211_);
						_tmp213_ = _tmp212_;
						_tmp214_ = vala_subroutine_get_body ((ValaSubroutine*) self);
						_tmp215_ = _tmp214_;
						_tmp216_ = _vala_code_node_ref0 (_tmp215_);
						_vala_code_node_unref0 (_tmp213_->insert_block);
						_tmp213_->insert_block = _tmp216_;
						_tmp217_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
						_tmp218_ = _tmp217_;
						_tmp219_ = vala_base_access_new (_tmp218_);
						_tmp220_ = _tmp219_;
						...
						_tmp239_ = _tmp238_;
						_tmp240_ = old_insert_block;
						_tmp241_ = _vala_code_node_ref0 (_tmp240_);
						_vala_code_node_unref0 (_tmp239_->insert_block);
						_tmp239_->insert_block = _tmp241_;
						_vala_code_node_unref0 (stmt);
						_vala_code_node_unref0 (old_insert_block);
					}
				}
	...
	_tmp242_ = context;
	_tmp243_ = vala_code_context_get_analyzer (_tmp242_);
	_tmp244_ = _tmp243_;
	...
	_tmp252_ = vala_method_get_is_abstract ((ValaMethod*) self);
	_tmp253_ = _tmp252_;
	if (_tmp253_) {
		_tmp251_ = TRUE;
	} else {
		gboolean _tmp254_;
		gboolean _tmp255_;
		_tmp254_ = vala_method_get_is_virtual ((ValaMethod*) self);
		_tmp255_ = _tmp254_;
		_tmp251_ = _tmp255_;
	}
	_tmp256_ = _tmp251_;
	if (_tmp256_) {
		...
		gboolean _tmp257_;
		gboolean _tmp258_;
		_tmp257_ = vala_method_get_overrides ((ValaMethod*) self);
		_tmp258_ = _tmp257_;
		_tmp250_ = _tmp258_;
	}
	_tmp259_ = _tmp250_;
	...
	if (_tmp267_ != NULL) {
		{
			...
			while (TRUE) {
				...
				if (!_tmp294_) {
					...
					_tmp296_ = vala_error_type_get_dynamic_error (VALA_ERROR_TYPE (_tmp295_));
					_tmp297_ = _tmp296_;
					_tmp293_ = !_tmp297_;
				} else {
					_tmp293_ = FALSE;
				...
				if (_tmp298_) {
					...
					gchar* _tmp305_ = NULL;
					gchar* _tmp306_;
					_tmp299_ = body_error_type;
					_tmp300_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp299_);
					_tmp301_ = _tmp300_;
					_tmp302_ = body_error_type;
					_tmp303_ = vala_code_node_to_string ((ValaCodeNode*) _tmp302_);
					_tmp304_ = _tmp303_;
					_tmp305_ = g_strdup_printf ("unhandled error `%s'", _tmp304_);
					_tmp306_ = _tmp305_;
					vala_report_warning (_tmp301_, _tmp306_);
					_g_free0 (_tmp306_);
					_g_free0 (_tmp304_);
				}

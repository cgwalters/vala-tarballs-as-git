...
static gboolean vala_throw_statement_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	if (_tmp6_ == VALA_PROFILE_GOBJECT) {
		...
		_tmp7_ = vala_throw_statement_get_error_expression (self);
		_tmp8_ = _tmp7_;
		_tmp9_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
		_tmp10_ = _tmp9_;
		_tmp11_ = vala_error_type_new (NULL, NULL, _tmp10_);
		_tmp12_ = _tmp11_;
		vala_expression_set_target_type (_tmp8_, (ValaDataType*) _tmp12_);
		...
		_tmp13_ = vala_throw_statement_get_error_expression (self);
		_tmp14_ = _tmp13_;
		_tmp15_ = context;
		_tmp16_ = vala_code_context_get_analyzer (_tmp15_);
		_tmp17_ = _tmp16_;
		_tmp18_ = _tmp17_->error_type;
		_tmp19_ = vala_data_type_copy (_tmp18_);
		_tmp20_ = _tmp19_;
		vala_expression_set_target_type (_tmp14_, _tmp20_);
		_vala_code_node_unref0 (_tmp20_);
	}
	_tmp21_ = vala_throw_statement_get_error_expression (self);
	_tmp22_ = _tmp21_;
	_tmp23_ = vala_expression_get_target_type (_tmp22_);
	_tmp24_ = _tmp23_;
	vala_data_type_set_value_owned (_tmp24_, TRUE);
	_tmp25_ = vala_throw_statement_get_error_expression (self);
	_tmp26_ = _tmp25_;
	if (_tmp26_ != NULL) {
		...
		ValaProfile _tmp42_;
		gboolean _tmp47_;
		_tmp27_ = vala_throw_statement_get_error_expression (self);
		_tmp28_ = _tmp27_;
		_tmp29_ = context;
		...
		_tmp31_ = vala_throw_statement_get_error_expression (self);
		_tmp32_ = _tmp31_;
		...
		if (_tmp34_ == NULL) {
			...
			_tmp35_ = vala_throw_statement_get_error_expression (self);
			_tmp36_ = _tmp35_;
			_tmp37_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp36_);
			_tmp38_ = _tmp37_;
			vala_report_error (_tmp38_, "invalid error expression");
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			result = FALSE;
			return result;
		}
		...
		if (_tmp42_ == VALA_PROFILE_GOBJECT) {
			...
			_tmp43_ = vala_throw_statement_get_error_expression (self);
			_tmp44_ = _tmp43_;
			_tmp45_ = vala_expression_get_value_type (_tmp44_);
			_tmp46_ = _tmp45_;
			_tmp39_ = !VALA_IS_ERROR_TYPE (_tmp46_);
		} else {
			_tmp39_ = FALSE;
		}
		_tmp47_ = _tmp39_;
		if (_tmp47_) {
			...
			gchar* _tmp58_ = NULL;
			gchar* _tmp59_;
			_tmp48_ = vala_throw_statement_get_error_expression (self);
			_tmp49_ = _tmp48_;
			_tmp50_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp49_);
			_tmp51_ = _tmp50_;
			_tmp52_ = vala_throw_statement_get_error_expression (self);
			_tmp53_ = _tmp52_;
			_tmp54_ = vala_expression_get_value_type (_tmp53_);
			_tmp55_ = _tmp54_;
			_tmp56_ = vala_code_node_to_string ((ValaCodeNode*) _tmp55_);
			_tmp57_ = _tmp56_;
			_tmp58_ = g_strdup_printf ("`%s' is not an error type", _tmp57_);
			_tmp59_ = _tmp58_;
			vala_report_error (_tmp51_, _tmp59_);
			_g_free0 (_tmp59_);
			_g_free0 (_tmp57_);
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			result = FALSE;
	...
	_tmp60_ = vala_throw_statement_get_error_expression (self);
	_tmp61_ = _tmp60_;
	...
	_tmp67_ = _tmp66_;
	vala_code_node_set_source_reference ((ValaCodeNode*) _tmp65_, _tmp67_);
	_tmp68_ = error_type;
	vala_code_node_add_error_type ((ValaCodeNode*) self, _tmp68_);

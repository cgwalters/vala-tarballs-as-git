...
static gboolean vala_template_real_check (ValaCodeNode* base, ValaCodeContext* context) {
			...
			if (_tmp19_ == VALA_PROFILE_DOVA) {
				{
					...
					i = 1;
					{
						...
						while (TRUE) {
							...
							_tmp32_ = vala_template_stringify (self, _tmp31_);
							_tmp33_ = _tmp32_;
							_tmp34_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
							_tmp35_ = _tmp34_;
							_tmp36_ = vala_binary_expression_new (VALA_BINARY_OPERATOR_PLUS, _tmp27_, _tmp33_, _tmp35_);
							_vala_code_node_unref0 (expr);
				...
				_tmp39_ = _tmp38_;
				_tmp40_ = vala_member_access_new (_tmp37_, "concat", _tmp39_);
				_tmp41_ = _tmp40_;
				_tmp42_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
				_tmp43_ = _tmp42_;
				_tmp44_ = vala_method_call_new ((ValaExpression*) _tmp41_, _tmp43_);
				_tmp45_ = _tmp44_;
				...
				concat = _tmp45_;
				{
					...
					i = 1;
					{
						...
						while (TRUE) {
							...
							_tmp53_ = concat;
							_tmp54_ = self->priv->expression_list;
							_tmp55_ = i;
							_tmp56_ = vala_list_get (_tmp54_, _tmp55_);
							_tmp57_ = (ValaExpression*) _tmp56_;
							_tmp58_ = vala_template_stringify (self, _tmp57_);
							_tmp59_ = _tmp58_;
							vala_method_call_add_argument (_tmp53_, _tmp59_);
				...
				_tmp60_ = concat;
				_tmp61_ = _vala_code_node_ref0 ((ValaExpression*) _tmp60_);
				_vala_code_node_unref0 (expr);
				expr = _tmp61_;
	...
	_tmp62_ = expr;
	_tmp63_ = vala_expression_get_target_type ((ValaExpression*) self);
	_tmp64_ = _tmp63_;
	vala_expression_set_target_type (_tmp62_, _tmp64_);
	_tmp65_ = context;
	_tmp66_ = vala_code_context_get_analyzer (_tmp65_);
	_tmp67_ = _tmp66_;
	_tmp68_ = _tmp67_->replaced_nodes;
	vala_collection_add ((ValaCollection*) _tmp68_, (ValaCodeNode*) self);
	_tmp69_ = vala_code_node_get_parent_node ((ValaCodeNode*) self);
	_tmp70_ = _tmp69_;
	_tmp71_ = expr;
	vala_code_node_replace_expression (_tmp70_, (ValaExpression*) self, _tmp71_);
	_tmp72_ = expr;
	_tmp73_ = context;
	_tmp74_ = vala_code_node_check ((ValaCodeNode*) _tmp72_, _tmp73_);
	result = _tmp74_;
	_vala_code_node_unref0 (expr);
	return result;
}

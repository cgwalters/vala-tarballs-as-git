...
static gboolean vala_property_accessor_real_check (ValaCodeNode* base, ValaCodeContext* context) {
		...
		if (_tmp34_) {
			...
			if (_tmp55_) {
				...
				if (_tmp58_ == VALA_PROFILE_DOVA) {
					...
					_tmp62_ = _tmp61_;
					_tmp63_ = vala_member_access_new_simple ("result", _tmp62_);
					_tmp64_ = _tmp63_;
					_tmp65_ = ma;
					_tmp66_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
					_tmp67_ = _tmp66_;
					_tmp68_ = vala_assignment_new ((ValaExpression*) _tmp64_, (ValaExpression*) _tmp65_, VALA_ASSIGNMENT_OPERATOR_SIMPLE, _tmp67_);
					_tmp69_ = _tmp68_;
					_tmp70_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
					_tmp71_ = _tmp70_;
					_tmp72_ = vala_expression_statement_new ((ValaExpression*) _tmp69_, _tmp71_);
					_tmp73_ = _tmp72_;
					vala_block_add_statement (_tmp60_, (ValaStatement*) _tmp73_);
					...
					_tmp77_ = _tmp76_;
					_tmp78_ = vala_return_statement_new (NULL, _tmp77_);
					_tmp79_ = _tmp78_;
					vala_block_add_statement (_tmp75_, (ValaStatement*) _tmp79_);
					...
					ValaReturnStatement* _tmp85_;
					ValaReturnStatement* _tmp86_;
					_tmp80_ = vala_subroutine_get_body ((ValaSubroutine*) self);
					_tmp81_ = _tmp80_;
					_tmp82_ = ma;
					_tmp83_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
					_tmp84_ = _tmp83_;
					_tmp85_ = vala_return_statement_new ((ValaExpression*) _tmp82_, _tmp84_);
					_tmp86_ = _tmp85_;
				...
				_tmp88_ = _tmp87_;
				_tmp89_ = vala_member_access_new_simple ("value", _tmp88_);
				value = (ValaExpression*) _tmp89_;
				...
				if (_tmp93_) {
					...
					ValaReferenceTransferExpression* _tmp97_;
					_tmp94_ = value;
					_tmp95_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
					_tmp96_ = _tmp95_;
					_tmp97_ = vala_reference_transfer_expression_new (_tmp94_, _tmp96_);
					_vala_code_node_unref0 (value);
					value = (ValaExpression*) _tmp97_;
				}
				_tmp98_ = ma;
				_tmp99_ = value;
				_tmp100_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
				_tmp101_ = _tmp100_;
				_tmp102_ = vala_assignment_new ((ValaExpression*) _tmp98_, _tmp99_, VALA_ASSIGNMENT_OPERATOR_SIMPLE, _tmp101_);
				assignment = _tmp102_;
				_tmp103_ = vala_subroutine_get_body ((ValaSubroutine*) self);
				_tmp104_ = _tmp103_;
				_tmp105_ = assignment;
				_tmp106_ = vala_expression_statement_new ((ValaExpression*) _tmp105_, NULL);
				_tmp107_ = _tmp106_;
				vala_block_add_statement (_tmp104_, (ValaStatement*) _tmp107_);
	...
	if (_tmp109_ != NULL) {
		...
		if (_tmp111_) {
			...
			_tmp114_ = _tmp113_;
			_tmp110_ = _tmp114_ == VALA_PROFILE_DOVA;
		} else {
			_tmp110_ = FALSE;
		}
		_tmp115_ = _tmp110_;
		if (_tmp115_) {
			...
			_tmp116_ = vala_property_accessor_get_value_type (self);
			_tmp117_ = _tmp116_;
			_tmp118_ = vala_data_type_copy (_tmp117_);
			_tmp119_ = _tmp118_;
			_tmp120_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
			_tmp121_ = _tmp120_;
			_tmp122_ = vala_local_variable_new (_tmp119_, "result", NULL, _tmp121_);
			_tmp123_ = _tmp122_;
			vala_subroutine_set_result_var ((ValaSubroutine*) self, _tmp123_);
			_vala_code_node_unref0 (_tmp123_);
			_vala_code_node_unref0 (_tmp119_);
			_tmp124_ = vala_subroutine_get_result_var ((ValaSubroutine*) self);
			_tmp125_ = _tmp124_;
			vala_local_variable_set_is_result (_tmp125_, TRUE);
			_tmp126_ = vala_subroutine_get_result_var ((ValaSubroutine*) self);
			_tmp127_ = _tmp126_;
			_tmp128_ = context;
			vala_code_node_check ((ValaCodeNode*) _tmp127_, _tmp128_);
		} else {
			gboolean _tmp129_ = FALSE;
			gboolean _tmp130_;
			gboolean _tmp132_;
			_tmp130_ = self->priv->_writable;
			if (_tmp130_) {
				_tmp129_ = TRUE;
			} else {
				gboolean _tmp131_;
				_tmp131_ = self->priv->_construction;
				_tmp129_ = _tmp131_;
			}
			_tmp132_ = _tmp129_;
			if (_tmp132_) {
				...
				_tmp136_ = _tmp135_;
				_tmp137_ = vala_parameter_new ("value", _tmp134_, _tmp136_);
				_tmp138_ = _tmp137_;
				vala_property_accessor_set_value_parameter (self, _tmp138_);
				...
				_tmp142_ = _tmp141_;
				_tmp143_ = self->priv->_value_parameter;
				_tmp144_ = vala_symbol_get_name ((ValaSymbol*) _tmp143_);
				_tmp145_ = _tmp144_;
				_tmp146_ = self->priv->_value_parameter;
				vala_scope_add (_tmp142_, _tmp145_, (ValaSymbol*) _tmp146_);
			}
		}
		_tmp147_ = vala_subroutine_get_body ((ValaSubroutine*) self);
		_tmp148_ = _tmp147_;
		_tmp149_ = context;
		vala_code_node_check ((ValaCodeNode*) _tmp148_, _tmp149_);
		_tmp150_ = context;
		_tmp151_ = vala_code_context_get_profile (_tmp150_);
		_tmp152_ = _tmp151_;
		if (_tmp152_ != VALA_PROFILE_DOVA) {
			{
				ValaBlock* _tmp153_;
				ValaBlock* _tmp154_;
				...
				_body_error_type_list = _tmp155_;
				_tmp156_ = _body_error_type_list;
				_tmp157_ = vala_collection_get_size ((ValaCollection*) _tmp156_);
				_tmp158_ = _tmp157_;
				_body_error_type_size = _tmp158_;
				...
				while (TRUE) {
					...
					gboolean _tmp166_;
					gboolean _tmp167_;
					_tmp159_ = _body_error_type_index;
					_body_error_type_index = _tmp159_ + 1;
					_tmp160_ = _body_error_type_index;
					_tmp161_ = _body_error_type_size;
					if (!(_tmp160_ < _tmp161_)) {
						break;
					}
					_tmp162_ = _body_error_type_list;
					_tmp163_ = _body_error_type_index;
					_tmp164_ = vala_list_get (_tmp162_, _tmp163_);
					body_error_type = (ValaDataType*) _tmp164_;
					_tmp165_ = body_error_type;
					_tmp166_ = vala_error_type_get_dynamic_error (VALA_ERROR_TYPE (_tmp165_));
					_tmp167_ = _tmp166_;
					if (!_tmp167_) {
						...
						gchar* _tmp174_ = NULL;
						gchar* _tmp175_;
						_tmp168_ = body_error_type;
						_tmp169_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp168_);
						_tmp170_ = _tmp169_;
						_tmp171_ = body_error_type;
						_tmp172_ = vala_code_node_to_string ((ValaCodeNode*) _tmp171_);
						_tmp173_ = _tmp172_;
						_tmp174_ = g_strdup_printf ("unhandled error `%s'", _tmp173_);
						_tmp175_ = _tmp174_;
						vala_report_warning (_tmp170_, _tmp175_);
						_g_free0 (_tmp175_);
						_g_free0 (_tmp173_);
					}
	...
	_tmp178_ = _tmp177_;
	_tmp179_ = old_symbol;
	vala_semantic_analyzer_set_current_symbol (_tmp178_, _tmp179_);
	_tmp180_ = vala_code_node_get_error ((ValaCodeNode*) self);
	_tmp181_ = _tmp180_;
	result = !_tmp181_;
	_vala_code_node_unref0 (old_symbol);
	return result;

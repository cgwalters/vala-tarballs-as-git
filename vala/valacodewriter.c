...
static void vala_code_writer_real_visit_using_directive (ValaCodeVisitor* base, ValaUsingDirective* ns) {
	...
	if (_tmp0_ == VALA_CODE_WRITER_TYPE_FAST) {
		...
		_tmp5_ = _tmp4_;
		_tmp6_ = g_strdup_printf ("using %s;\n", _tmp5_);
		_tmp7_ = _tmp6_;
...
static gchar* vala_code_writer_get_cheaders (ValaCodeWriter* self, ValaSymbol* sym) {
	...
	if (_tmp6_) {
		...
		if (_tmp20_) {
			...
			_tmp26_ = _tmp25_;
			_tmp14_ = _tmp23_ != VALA_SYMBOL (_tmp26_);
		} else {
			_tmp14_ = FALSE;
		}
		_tmp27_ = _tmp14_;
...
static void vala_code_writer_real_visit_constant (ValaCodeVisitor* base, ValaConstant* c) {
	...
	if (_tmp14_ == VALA_CODE_WRITER_TYPE_FAST) {
		ValaConstant* _tmp15_;
		ValaExpression* _tmp16_;
		ValaExpression* _tmp17_;
		_tmp15_ = c;
		_tmp16_ = vala_constant_get_value (_tmp15_);
		_tmp17_ = _tmp16_;
	...
	if (_tmp18_) {
		...
		vala_code_writer_write_string (self, " = ");
		_tmp19_ = c;
		_tmp20_ = vala_constant_get_value (_tmp19_);
		_tmp21_ = _tmp20_;
...
static void vala_code_writer_real_visit_method (ValaCodeVisitor* base, ValaMethod* m) {
	...
	_tmp23_ = m;
	if (VALA_IS_CREATION_METHOD (_tmp23_)) {
		ValaMethod* _tmp24_;
		gboolean _tmp25_;
		gboolean _tmp26_;
		ValaMethod* _tmp27_;
		...
		_tmp29_ = _tmp28_;
		_tmp30_ = _vala_code_node_ref0 (VALA_TYPESYMBOL (_tmp29_));
		datatype = _tmp30_;
		_tmp31_ = datatype;
	...
	if (_tmp75_ != VALA_PROFILE_DOVA) {
		...
		_tmp78_ = _tmp77_;
		vala_code_writer_write_error_domains (self, _tmp78_);
		_vala_iterable_unref0 (_tmp78_);
	}
	_tmp79_ = m;
	_tmp80_ = vala_subroutine_get_body ((ValaSubroutine*) _tmp79_);
	_tmp81_ = _tmp80_;
	vala_code_writer_write_code_block (self, _tmp81_);
	vala_code_writer_write_newline (self);
}
...
static void vala_code_writer_real_visit_property (ValaCodeVisitor* base, ValaProperty* prop) {
	...
	if (_tmp39_ != NULL) {
		...
		if (_tmp49_ != VALA_PROFILE_DOVA) {
			...
			_tmp54_ = _tmp53_;
			_tmp55_ = vala_data_type_is_disposable (_tmp54_);
			_tmp46_ = _tmp55_;
		} else {
			_tmp46_ = FALSE;
		}
		...
		_tmp59_ = _tmp58_;
		_tmp60_ = vala_subroutine_get_body ((ValaSubroutine*) _tmp59_);
		_tmp61_ = _tmp60_;
		vala_code_writer_write_code_block (self, _tmp61_);
	}
	_tmp62_ = prop;
	...
	if (_tmp64_ != NULL) {
		...
		_tmp67_ = _tmp66_;
		vala_code_writer_write_attributes (self, (ValaCodeNode*) _tmp67_);
		_tmp68_ = prop;
		_tmp69_ = vala_property_get_set_accessor (_tmp68_);
		_tmp70_ = _tmp69_;
		vala_code_writer_write_property_accessor_accessibility (self, (ValaSymbol*) _tmp70_);
		_tmp72_ = self->priv->context;
		_tmp73_ = vala_code_context_get_profile (_tmp72_);
		_tmp74_ = _tmp73_;
		if (_tmp74_ != VALA_PROFILE_DOVA) {
		...
		_tmp97_ = _tmp96_;
		vala_code_writer_write_code_block (self, _tmp97_);
	}
	vala_code_writer_write_string (self, " }");
	vala_code_writer_write_newline (self);
}
...
static void vala_code_writer_write_identifier (ValaCodeWriter* self, const gchar* s) {
	...
	_tmp7_ = _tmp6_;
	if (_tmp7_ != VALA_PROFILE_DOVA) {
		gboolean _tmp8_ = FALSE;
		gchar* _tmp9_;
		gint _tmp10_;
		ValaTokenType _tmp11_ = 0;
		gboolean _tmp15_;
		_tmp9_ = id;
		_tmp10_ = id_length;
		_tmp11_ = vala_scanner_get_identifier_or_keyword (_tmp9_, _tmp10_);
		if (_tmp11_ != VALA_TOKEN_TYPE_IDENTIFIER) {
			_tmp8_ = TRUE;
		} else {
			const gchar* _tmp12_;
			gunichar _tmp13_ = 0U;
			...
			_tmp14_ = g_unichar_isdigit (_tmp13_);
			_tmp8_ = _tmp14_;
		}
		_tmp15_ = _tmp8_;
		_tmp4_ = _tmp15_;
...
static void vala_code_writer_write_attributes (ValaCodeWriter* self, ValaCodeNode* node) {
	...
	if (_tmp7_) {
		ValaSymbol* _tmp8_;
		_tmp8_ = sym;
		_tmp3_ = !VALA_IS_NAMESPACE (_tmp8_);
	} else {
		_tmp3_ = FALSE;
	}
	_tmp9_ = _tmp3_;
	if (_tmp9_) {
		...
		_tmp12_ = _tmp11_;
		_tmp2_ = VALA_IS_NAMESPACE (_tmp12_);
	} else {
		_tmp2_ = FALSE;
	}
	_tmp13_ = _tmp2_;
		...
		keys = _tmp39_;
		{
			...
			while (TRUE) {
				...
				if (g_strcmp0 (_tmp51_, "cheader_filename") == 0) {
					ValaSymbol* _tmp52_;
					_tmp52_ = sym;
					_tmp50_ = VALA_IS_NAMESPACE (_tmp52_);
				} else {
					_tmp50_ = FALSE;
				}
				_tmp53_ = _tmp50_;

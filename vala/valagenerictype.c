...
static ValaSymbol* vala_generic_type_real_get_member (ValaDataType* base, const gchar* member_name) {
	...
	if (_tmp4_) {
		...
		if (g_strcmp0 (_tmp5_, "equals") == 0) {
			...
			_tmp11_ = _tmp10_;
			_tmp12_ = vala_scope_lookup (_tmp11_, "Dova");
			_tmp13_ = _tmp12_;
			_tmp14_ = vala_symbol_get_scope (_tmp13_);
			_tmp15_ = _tmp14_;
			_tmp16_ = vala_scope_lookup (_tmp15_, "Object");
			_tmp17_ = _tmp16_;
			_tmp18_ = vala_symbol_get_scope (_tmp17_);
			_tmp19_ = _tmp18_;
			_tmp20_ = vala_scope_lookup (_tmp19_, "equals");
			_tmp21_ = _tmp20_;
			...
			if (g_strcmp0 (_tmp22_, "hash") == 0) {
				...
				_tmp28_ = _tmp27_;
				_tmp29_ = vala_scope_lookup (_tmp28_, "Dova");
				_tmp30_ = _tmp29_;
				...
				_tmp36_ = _tmp35_;
				_tmp37_ = vala_scope_lookup (_tmp36_, "hash");
				_tmp38_ = _tmp37_;

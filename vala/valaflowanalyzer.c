...
static void vala_flow_analyzer_real_visit_field (ValaCodeVisitor* base, ValaField* f) {
	...
	if (_tmp6_) {
		...
		if (_tmp13_) {
			...
			_tmp19_ = _tmp18_;
			_tmp20_ = g_strdup_printf ("field `%s' never used", _tmp19_);
			_tmp21_ = _tmp20_;
			vala_report_warning (_tmp16_, _tmp21_);
			_g_free0 (_tmp21_);
			_g_free0 (_tmp19_);
		}
	}
...
static void vala_flow_analyzer_real_visit_method (ValaCodeVisitor* base, ValaMethod* m) {
	...
	if (_tmp28_) {
		ValaMethod* _tmp29_;
		_tmp29_ = m;
		_tmp0_ = !VALA_IS_CREATION_METHOD (_tmp29_);
	} else {
		_tmp0_ = FALSE;
	}
	_tmp30_ = _tmp0_;
	if (_tmp30_) {
		...
		if (!_tmp33_) {
			...
			_tmp35_ = vala_code_context_get_internal_header_filename (_tmp34_);
			_tmp36_ = _tmp35_;
			_tmp31_ = _tmp36_ != NULL;
		} else {
			_tmp31_ = FALSE;
		}
		_tmp37_ = _tmp31_;
		if (_tmp37_) {
			...
			_tmp43_ = _tmp42_;
			_tmp44_ = g_strdup_printf ("method `%s' never used", _tmp43_);
			_tmp45_ = _tmp44_;
			vala_report_warning (_tmp40_, _tmp45_);
			_g_free0 (_tmp45_);
			_g_free0 (_tmp43_);
		}
	}
	_tmp46_ = m;
	vala_flow_analyzer_visit_subroutine (self, (ValaSubroutine*) _tmp46_);
}
...
static void vala_flow_analyzer_visit_subroutine (ValaFlowAnalyzer* self, ValaSubroutine* m) {
	...
	_tmp20_ = vala_code_context_get_profile (_tmp19_);
	_tmp21_ = _tmp20_;
	if (_tmp21_ == VALA_PROFILE_DOVA) {
		ValaSubroutine* _tmp22_;
		ValaLocalVariable* _tmp23_;
		ValaLocalVariable* _tmp24_;
		_tmp22_ = m;
		_tmp23_ = vala_subroutine_get_result_var (_tmp22_);
		_tmp24_ = _tmp23_;
	...
	if (_tmp25_) {
		...
		_tmp28_ = _tmp27_;
		_tmp29_ = vala_member_access_new_simple ("result", _tmp28_);
		result_ma = _tmp29_;
		_tmp30_ = result_ma;
		_tmp31_ = m;
		_tmp32_ = vala_subroutine_get_result_var (_tmp31_);
		_tmp33_ = _tmp32_;
		vala_expression_set_symbol_reference ((ValaExpression*) _tmp30_, (ValaSymbol*) _tmp33_);
		_tmp34_ = m;
		_tmp35_ = vala_subroutine_get_return_block (_tmp34_);
		_tmp36_ = _tmp35_;
		_tmp37_ = result_ma;
		vala_basic_block_add_node (_tmp36_, (ValaCodeNode*) _tmp37_);
		_vala_code_node_unref0 (result_ma);
	}
	_tmp38_ = m;
	if (VALA_IS_METHOD (_tmp38_)) {
		{
			ValaSubroutine* _tmp39_;
			...
			gint _param_index;
			_tmp39_ = m;
			_tmp40_ = vala_method_get_parameters (VALA_METHOD (_tmp39_));
			_param_list = _tmp40_;
			_tmp41_ = _param_list;
			...
			while (TRUE) {
				...
				_tmp52_ = _tmp51_;
				if (_tmp52_ == VALA_PARAMETER_DIRECTION_OUT) {
					...
					_tmp58_ = _tmp57_;
					_tmp59_ = vala_member_access_new_simple (_tmp55_, _tmp58_);
					param_ma = _tmp59_;
					_tmp60_ = param_ma;
					_tmp61_ = param;
					vala_expression_set_symbol_reference ((ValaExpression*) _tmp60_, (ValaSymbol*) _tmp61_);
					_tmp62_ = m;
					_tmp63_ = vala_subroutine_get_return_block (_tmp62_);
					_tmp64_ = _tmp63_;
					_tmp65_ = param_ma;
					vala_basic_block_add_node (_tmp64_, (ValaCodeNode*) _tmp65_);
	...
	_tmp66_ = vala_basic_block_new ();
	_vala_basic_block_unref0 (self->priv->current_block);
	self->priv->current_block = _tmp66_;
	_tmp67_ = m;
	_tmp68_ = vala_subroutine_get_entry_block (_tmp67_);
	_tmp69_ = _tmp68_;
	_tmp70_ = self->priv->current_block;
	vala_basic_block_connect (_tmp69_, _tmp70_);
	_tmp71_ = self->priv->current_block;
	_tmp72_ = m;
	vala_basic_block_add_node (_tmp71_, (ValaCodeNode*) _tmp72_);
	_tmp73_ = self->priv->jump_stack;
	_tmp74_ = m;
	_tmp75_ = vala_subroutine_get_return_block (_tmp74_);
	_tmp76_ = _tmp75_;
	_tmp77_ = vala_flow_analyzer_jump_target_new_return_target (_tmp76_);
	_tmp78_ = _tmp77_;
	vala_collection_add ((ValaCollection*) _tmp73_, _tmp78_);
	_vala_flow_analyzer_jump_target_unref0 (_tmp78_);
	_tmp79_ = self->priv->jump_stack;
	_tmp80_ = m;
	_tmp81_ = vala_subroutine_get_exit_block (_tmp80_);
	_tmp82_ = _tmp81_;
	_tmp83_ = vala_flow_analyzer_jump_target_new_exit_target (_tmp82_);
	_tmp84_ = _tmp83_;
	vala_collection_add ((ValaCollection*) _tmp79_, _tmp84_);
	_vala_flow_analyzer_jump_target_unref0 (_tmp84_);
	_tmp85_ = m;
	vala_code_node_accept_children ((ValaCodeNode*) _tmp85_, (ValaCodeVisitor*) self);
	_tmp86_ = self->priv->jump_stack;
	_tmp87_ = self->priv->jump_stack;
	_tmp88_ = vala_collection_get_size ((ValaCollection*) _tmp87_);
	_tmp89_ = _tmp88_;
	vala_list_remove_at (_tmp86_, _tmp89_ - 1);
	...
	if (_tmp90_ != NULL) {
		...
		ValaSubroutine* _tmp104_;
		ValaBasicBlock* _tmp105_;
		ValaBasicBlock* _tmp106_;
		_tmp92_ = self->priv->context;
		_tmp93_ = vala_code_context_get_profile (_tmp92_);
		_tmp94_ = _tmp93_;
		if (_tmp94_ != VALA_PROFILE_DOVA) {
			ValaSubroutine* _tmp95_;
			gboolean _tmp96_;
			gboolean _tmp97_;
			_tmp95_ = m;
			_tmp96_ = vala_subroutine_get_has_result (_tmp95_);
			_tmp97_ = _tmp96_;
			_tmp91_ = _tmp97_;
		} else {
			_tmp91_ = FALSE;
		...
		_tmp98_ = _tmp91_;
		if (_tmp98_) {
			ValaSubroutine* _tmp99_;
			ValaSourceReference* _tmp100_;
			ValaSourceReference* _tmp101_;
			ValaSubroutine* _tmp102_;
			_tmp99_ = m;
			_tmp100_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp99_);
			_tmp101_ = _tmp100_;
			vala_report_error (_tmp101_, "missing return statement at end of subroutine body");
			_tmp102_ = m;
			vala_code_node_set_error ((ValaCodeNode*) _tmp102_, TRUE);
		}
		_tmp103_ = self->priv->current_block;
		_tmp104_ = m;
		_tmp105_ = vala_subroutine_get_return_block (_tmp104_);
		_tmp106_ = _tmp105_;
		vala_basic_block_connect (_tmp103_, _tmp106_);
	}
	_tmp107_ = m;
	_tmp108_ = vala_subroutine_get_entry_block (_tmp107_);
	_tmp109_ = _tmp108_;
	vala_flow_analyzer_analyze_body (self, _tmp109_);
}
...
static void vala_flow_analyzer_insert_phi_functions (ValaFlowAnalyzer* self, ValaList* block_list, ValaBasicBlock* entry_block) {
	...
	phi = _tmp12_;
	{
		...
		while (TRUE) {
			...
			_tmp24_ = added;
			_tmp25_ = block;
			vala_map_set ((ValaMap*) _tmp24_, _tmp25_, GINT_TO_POINTER (0));
			_tmp26_ = phi;
			_tmp27_ = block;
			vala_map_set ((ValaMap*) _tmp26_, _tmp27_, GINT_TO_POINTER (0));
			_vala_basic_block_unref0 (block);
		}
		_vala_iterable_unref0 (_block_list);
	}
		...
		while (TRUE) {
			...
			counter = _tmp37_ + 1;
			{
				...
				while (TRUE) {
					...
					_tmp51_ = block;
					_tmp52_ = counter;
					vala_map_set ((ValaMap*) _tmp50_, _tmp51_, GINT_TO_POINTER (_tmp52_));
					_vala_basic_block_unref0 (block);
				}
			...
			while (TRUE) {
				...
				vala_list_remove_at ((ValaList*) _tmp58_, 0);
				{
					...
					while (TRUE) {
						...
						blockPhi = GPOINTER_TO_INT (_tmp70_);
						_tmp71_ = blockPhi;
						_tmp72_ = counter;
						if (_tmp71_ < _tmp72_) {
							ValaBasicBlock* _tmp73_;
							...
							_tmp83_ = frontier;
							_tmp84_ = counter;
							vala_map_set ((ValaMap*) _tmp82_, _tmp83_, GINT_TO_POINTER (_tmp84_));
							_tmp85_ = added;
							_tmp86_ = frontier;
							_tmp87_ = vala_map_get ((ValaMap*) _tmp85_, _tmp86_);
							block_added = GPOINTER_TO_INT (_tmp87_);
							_tmp88_ = block_added;
							_tmp89_ = counter;
							if (_tmp88_ < _tmp89_) {
								ValaHashMap* _tmp90_;
								...
								_tmp91_ = frontier;
								_tmp92_ = counter;
								vala_map_set ((ValaMap*) _tmp90_, _tmp91_, GINT_TO_POINTER (_tmp92_));
								_tmp93_ = work_list;
								_tmp94_ = frontier;
			...
			vala_code_node_get_used_variables (_tmp30_, (ValaCollection*) _tmp31_);
			{
				...
				while (TRUE) {
					...
					if (_tmp51_) {
						...
						_tmp52_ = var_symbol;
						if (VALA_IS_LOCAL_VARIABLE (_tmp52_)) {
...
static void vala_flow_analyzer_real_visit_declaration_statement (ValaCodeVisitor* base, ValaDeclarationStatement* stmt) {
	...
	_tmp27_ = _tmp26_;
	_tmp28_ = _vala_code_node_ref0 (VALA_IS_LOCAL_VARIABLE (_tmp27_) ? ((ValaLocalVariable*) _tmp27_) : NULL);
	local = _tmp28_;
	_tmp30_ = local;
	if (_tmp30_ != NULL) {
...
static void vala_flow_analyzer_real_visit_expression_statement (ValaCodeVisitor* base, ValaExpressionStatement* stmt) {
	...
	if (VALA_IS_METHOD_CALL (_tmp8_)) {
		...
		_tmp11_ = _tmp10_;
		_tmp12_ = _vala_code_node_ref0 (VALA_METHOD_CALL (_tmp11_));
		expr = _tmp12_;
		_tmp13_ = expr;
	...
	if (_tmp2_) {
		...
		last_block = _tmp4_;
		{
			...
			while (TRUE) {
				...
				_tmp17_ = _vala_code_node_ref0 (VALA_IS_ERROR_TYPE (_tmp16_) ? ((ValaErrorType*) _tmp16_) : NULL);
				error_type = _tmp17_;
				_tmp18_ = error_data_type;
				_tmp19_ = vala_data_type_get_data_type (_tmp18_);
				_tmp20_ = _tmp19_;
				_tmp21_ = _vala_code_node_ref0 (VALA_IS_CLASS (_tmp20_) ? ((ValaClass*) _tmp20_) : NULL);
				error_class = _tmp21_;
				_tmp22_ = last_block;
				_tmp23_ = _vala_basic_block_ref0 (_tmp22_);
				_vala_basic_block_unref0 (self->priv->current_block);
				...
				self->priv->unreachable_reported = TRUE;
				{
					...
					i = _tmp26_ - 1;
					{
						...
						while (TRUE) {
							...
							jump_target = (ValaFlowAnalyzerJumpTarget*) _tmp33_;
							_tmp34_ = jump_target;
							_tmp35_ = vala_flow_analyzer_jump_target_get_is_exit_target (_tmp34_);
							_tmp36_ = _tmp35_;
							if (_tmp36_) {
								ValaBasicBlock* _tmp37_;
								...
								_tmp38_ = jump_target;
								_tmp39_ = vala_flow_analyzer_jump_target_get_basic_block (_tmp38_);
								_tmp40_ = _tmp39_;
								vala_basic_block_connect (_tmp37_, _tmp40_);
								vala_flow_analyzer_mark_unreachable (self);
								_vala_flow_analyzer_jump_target_unref0 (jump_target);
								break;
							} else {
								...
								gboolean _tmp43_;
								_tmp41_ = jump_target;
								_tmp42_ = vala_flow_analyzer_jump_target_get_is_error_target (_tmp41_);
								_tmp43_ = _tmp42_;
								if (_tmp43_) {
									...
									if (_tmp46_ == VALA_PROFILE_GOBJECT) {
										...
										gboolean _tmp70_;
										_tmp48_ = jump_target;
										_tmp49_ = vala_flow_analyzer_jump_target_get_error_domain (_tmp48_);
										_tmp50_ = _tmp49_;
										if (_tmp50_ == NULL) {
											_tmp47_ = TRUE;
										} else {
											...
											gboolean _tmp69_;
											_tmp52_ = jump_target;
											_tmp53_ = vala_flow_analyzer_jump_target_get_error_domain (_tmp52_);
											_tmp54_ = _tmp53_;
											_tmp55_ = error_type;
											_tmp56_ = vala_error_type_get_error_domain (_tmp55_);
											_tmp57_ = _tmp56_;
											if (_tmp54_ == _tmp57_) {
												...
												if (_tmp61_ == NULL) {
													...
													ValaErrorCode* _tmp66_;
													ValaErrorCode* _tmp67_;
													_tmp62_ = jump_target;
													_tmp63_ = vala_flow_analyzer_jump_target_get_error_code (_tmp62_);
													_tmp64_ = _tmp63_;
													_tmp65_ = error_type;
													_tmp66_ = vala_error_type_get_error_code (_tmp65_);
													_tmp67_ = _tmp66_;
													_tmp58_ = _tmp64_ == _tmp67_;
												}
												_tmp68_ = _tmp58_;
												_tmp51_ = _tmp68_;
											} else {
										...
										if (_tmp70_) {
											...
											_tmp71_ = self->priv->current_block;
											_tmp72_ = jump_target;
											_tmp73_ = vala_flow_analyzer_jump_target_get_basic_block (_tmp72_);
											_tmp74_ = _tmp73_;
											vala_basic_block_connect (_tmp71_, _tmp74_);
											vala_flow_analyzer_mark_unreachable (self);
											_vala_flow_analyzer_jump_target_unref0 (jump_target);
											break;
										} else {
											...
											gboolean _tmp98_;
											_tmp76_ = error_type;
											_tmp77_ = vala_error_type_get_error_domain (_tmp76_);
											_tmp78_ = _tmp77_;
											if (_tmp78_ == NULL) {
												_tmp75_ = TRUE;
											} else {
												...
												ValaErrorDomain* _tmp81_;
												ValaErrorDomain* _tmp82_;
												ValaFlowAnalyzerJumpTarget* _tmp83_;
												ValaErrorDomain* _tmp84_;
												ValaErrorDomain* _tmp85_;
												gboolean _tmp97_;
												_tmp80_ = error_type;
												_tmp81_ = vala_error_type_get_error_domain (_tmp80_);
												_tmp82_ = _tmp81_;
												_tmp83_ = jump_target;
												_tmp84_ = vala_flow_analyzer_jump_target_get_error_domain (_tmp83_);
												_tmp85_ = _tmp84_;
												if (_tmp82_ == _tmp85_) {
													...
													gboolean _tmp96_;
													_tmp87_ = error_type;
													_tmp88_ = vala_error_type_get_error_code (_tmp87_);
													_tmp89_ = _tmp88_;
													if (_tmp89_ == NULL) {
														_tmp86_ = TRUE;
													} else {
														ValaErrorType* _tmp90_;
														ValaErrorCode* _tmp91_;
														ValaErrorCode* _tmp92_;
														ValaFlowAnalyzerJumpTarget* _tmp93_;
														ValaErrorCode* _tmp94_;
														ValaErrorCode* _tmp95_;
														_tmp90_ = error_type;
														_tmp91_ = vala_error_type_get_error_code (_tmp90_);
														_tmp92_ = _tmp91_;
														_tmp93_ = jump_target;
														_tmp94_ = vala_flow_analyzer_jump_target_get_error_code (_tmp93_);
														_tmp95_ = _tmp94_;
														_tmp86_ = _tmp92_ == _tmp95_;
													}
													_tmp96_ = _tmp86_;
													_tmp79_ = _tmp96_;
												} else {
										...
										if (_tmp106_ == NULL) {
											...
											_tmp108_ = vala_flow_analyzer_jump_target_get_error_class (_tmp107_);
											_tmp109_ = _tmp108_;
											_tmp110_ = error_class;
											_tmp103_ = _tmp109_ == _tmp110_;
										}
										_tmp111_ = _tmp103_;
										if (_tmp111_) {
											...
											_tmp112_ = self->priv->current_block;
											_tmp113_ = jump_target;
											_tmp114_ = vala_flow_analyzer_jump_target_get_basic_block (_tmp113_);
											_tmp115_ = _tmp114_;
											vala_basic_block_connect (_tmp112_, _tmp115_);
											vala_flow_analyzer_mark_unreachable (self);
											_vala_flow_analyzer_jump_target_unref0 (jump_target);
											break;
										} else {
											...
											_tmp117_ = vala_flow_analyzer_jump_target_get_error_class (_tmp116_);
											_tmp118_ = _tmp117_;
											_tmp119_ = error_class;
											_tmp120_ = vala_typesymbol_is_subtype_of ((ValaTypeSymbol*) _tmp118_, (ValaTypeSymbol*) _tmp119_);
											if (_tmp120_) {
												ValaBasicBlock* _tmp121_;
												ValaFlowAnalyzerJumpTarget* _tmp122_;
												ValaBasicBlock* _tmp123_;
												ValaBasicBlock* _tmp124_;
												_tmp121_ = self->priv->current_block;
												_tmp122_ = jump_target;
												_tmp123_ = vala_flow_analyzer_jump_target_get_basic_block (_tmp122_);
												_tmp124_ = _tmp123_;
												vala_basic_block_connect (_tmp121_, _tmp124_);
											}
										}
									}
								} else {
									...
									_tmp126_ = vala_flow_analyzer_jump_target_get_is_finally_clause (_tmp125_);
									_tmp127_ = _tmp126_;
									if (_tmp127_) {
										ValaBasicBlock* _tmp128_;
										ValaFlowAnalyzerJumpTarget* _tmp129_;
										ValaBasicBlock* _tmp130_;
										ValaBasicBlock* _tmp131_;
										ValaFlowAnalyzerJumpTarget* _tmp132_;
										ValaBasicBlock* _tmp133_;
										ValaBasicBlock* _tmp134_;
										ValaBasicBlock* _tmp135_;
										_tmp128_ = self->priv->current_block;
										_tmp129_ = jump_target;
										_tmp130_ = vala_flow_analyzer_jump_target_get_basic_block (_tmp129_);
										_tmp131_ = _tmp130_;
										vala_basic_block_connect (_tmp128_, _tmp131_);
										_tmp132_ = jump_target;
										_tmp133_ = vala_flow_analyzer_jump_target_get_last_block (_tmp132_);
										_tmp134_ = _tmp133_;
										_tmp135_ = _vala_basic_block_ref0 (_tmp134_);
										_vala_basic_block_unref0 (self->priv->current_block);
										self->priv->current_block = _tmp135_;
									}
								}
							}
							_vala_flow_analyzer_jump_target_unref0 (jump_target);
		...
		_tmp136_ = always_fail;
		if (!_tmp136_) {
			ValaBasicBlock* _tmp137_;
			ValaBasicBlock* _tmp138_;
			ValaBasicBlock* _tmp139_;
			_tmp137_ = vala_basic_block_new ();
			_vala_basic_block_unref0 (self->priv->current_block);
			self->priv->current_block = _tmp137_;
			_tmp138_ = last_block;
			_tmp139_ = self->priv->current_block;
			vala_basic_block_connect (_tmp138_, _tmp139_);
		}
		_vala_basic_block_unref0 (last_block);
	}
}
...
static void vala_flow_analyzer_real_visit_try_statement (ValaCodeVisitor* base, ValaTryStatement* stmt) {
			...
			while (TRUE) {
				...
				if (_tmp55_ != NULL) {
					...
					if (_tmp58_ == VALA_PROFILE_GOBJECT) {
						...
						_tmp61_ = _tmp60_;
						_tmp62_ = _vala_code_node_ref0 (VALA_IS_ERROR_TYPE (_tmp61_) ? ((ValaErrorType*) _tmp61_) : NULL);
						error_type = _tmp62_;
						_tmp63_ = self->priv->jump_stack;
						_tmp64_ = vala_basic_block_new ();
						_tmp65_ = _tmp64_;
						...
						_tmp76_ = _tmp75_;
						vala_collection_add ((ValaCollection*) _tmp63_, _tmp76_);
						_vala_flow_analyzer_jump_target_unref0 (_tmp76_);
						_vala_basic_block_unref0 (_tmp65_);
						_vala_code_node_unref0 (error_type);
					} else {
	...
	_tmp98_ = stmt;
	_tmp99_ = vala_try_statement_get_body (_tmp98_);
	_tmp100_ = _tmp99_;
	vala_code_node_accept ((ValaCodeNode*) _tmp100_, (ValaCodeVisitor*) self);
	...
	if (_tmp101_ != NULL) {
		...
		if (_tmp102_ != NULL) {
			...
			vala_basic_block_connect (_tmp103_, _tmp104_);
		...
		_tmp108_ = after_try_block;
		vala_basic_block_connect (_tmp107_, _tmp108_);
	}
	_tmp109_ = g_direct_equal;
	_tmp110_ = vala_array_list_new (VALA_FLOW_ANALYZER_TYPE_JUMP_TARGET, (GBoxedCopyFunc) vala_flow_analyzer_jump_target_ref, vala_flow_analyzer_jump_target_unref, _tmp109_);
	catch_stack = (ValaList*) _tmp110_;
	{
		ValaList* _tmp111_;
		gint _tmp112_;
		gint _tmp113_;
		gint i;
		_tmp111_ = self->priv->jump_stack;
		...
		i = _tmp113_ - 1;
		{
			...
			while (TRUE) {
				...
				_tmp114_ = FALSE;
				_tmp117_ = i;
				_tmp118_ = finally_jump_stack_size;
				if (!(_tmp117_ >= _tmp118_)) {
					break;
				}
				_tmp119_ = self->priv->jump_stack;
				_tmp120_ = i;
				_tmp121_ = vala_list_get (_tmp119_, _tmp120_);
				jump_target = (ValaFlowAnalyzerJumpTarget*) _tmp121_;
				_tmp122_ = catch_stack;
				_tmp123_ = jump_target;
				vala_collection_add ((ValaCollection*) _tmp122_, _tmp123_);
				_tmp124_ = self->priv->jump_stack;
				_tmp125_ = i;
				vala_list_remove_at (_tmp124_, _tmp125_);
				_vala_flow_analyzer_jump_target_unref0 (jump_target);
			}
		}
	}
	{
		...
		_jump_target_list = _tmp127_;
		_tmp128_ = _jump_target_list;
		_tmp129_ = vala_collection_get_size ((ValaCollection*) _tmp128_);
		_tmp130_ = _tmp129_;
		_jump_target_size = _tmp130_;
		...
		while (TRUE) {
			...
			_jump_target_index = _tmp131_ + 1;
			_tmp132_ = _jump_target_index;
			_tmp133_ = _jump_target_size;
			if (!(_tmp132_ < _tmp133_)) {
				break;
			}
			_tmp134_ = _jump_target_list;
			_tmp135_ = _jump_target_index;
			_tmp136_ = vala_list_get (_tmp134_, _tmp135_);
			jump_target = (ValaFlowAnalyzerJumpTarget*) _tmp136_;
			{
				ValaList* _tmp137_;
				ValaList* _tmp138_;
				...
				_tmp137_ = catch_stack;
				_tmp138_ = _vala_iterable_ref0 (_tmp137_);
				_prev_target_list = _tmp138_;
				_tmp139_ = _prev_target_list;
				_tmp140_ = vala_collection_get_size ((ValaCollection*) _tmp139_);
				_tmp141_ = _tmp140_;
				_prev_target_size = _tmp141_;
				...
				while (TRUE) {
					...
					ValaProfile _tmp151_;
					ValaProfile _tmp152_;
					_tmp142_ = _prev_target_index;
					_prev_target_index = _tmp142_ + 1;
					_tmp143_ = _prev_target_index;
					_tmp144_ = _prev_target_size;
					if (!(_tmp143_ < _tmp144_)) {
						break;
					}
					_tmp145_ = _prev_target_list;
					_tmp146_ = _prev_target_index;
					_tmp147_ = vala_list_get (_tmp145_, _tmp146_);
					prev_target = (ValaFlowAnalyzerJumpTarget*) _tmp147_;
					...
					_tmp151_ = vala_code_context_get_profile (_tmp150_);
					_tmp152_ = _tmp151_;
					if (_tmp152_ == VALA_PROFILE_GOBJECT) {
						gboolean _tmp153_ = FALSE;
						ValaFlowAnalyzerJumpTarget* _tmp154_;
						ValaErrorDomain* _tmp155_;
						ValaErrorDomain* _tmp156_;
						ValaFlowAnalyzerJumpTarget* _tmp157_;
						ValaErrorDomain* _tmp158_;
						ValaErrorDomain* _tmp159_;
						gboolean _tmp166_;
						_tmp154_ = prev_target;
						_tmp155_ = vala_flow_analyzer_jump_target_get_error_domain (_tmp154_);
						_tmp156_ = _tmp155_;
						_tmp157_ = jump_target;
						_tmp158_ = vala_flow_analyzer_jump_target_get_error_domain (_tmp157_);
						_tmp159_ = _tmp158_;
						if (_tmp156_ == _tmp159_) {
							ValaFlowAnalyzerJumpTarget* _tmp160_;
							ValaErrorCode* _tmp161_;
							ValaErrorCode* _tmp162_;
							ValaFlowAnalyzerJumpTarget* _tmp163_;
							ValaErrorCode* _tmp164_;
							ValaErrorCode* _tmp165_;
							_tmp160_ = prev_target;
							_tmp161_ = vala_flow_analyzer_jump_target_get_error_code (_tmp160_);
							_tmp162_ = _tmp161_;
							_tmp163_ = jump_target;
							_tmp164_ = vala_flow_analyzer_jump_target_get_error_code (_tmp163_);
							_tmp165_ = _tmp164_;
							_tmp153_ = _tmp162_ == _tmp165_;
						} else {
							_tmp153_ = FALSE;
						}
						_tmp166_ = _tmp153_;
						if (_tmp166_) {
							ValaTryStatement* _tmp167_;
							ValaSourceReference* _tmp168_;
							ValaSourceReference* _tmp169_;
							ValaTryStatement* _tmp170_;
							_tmp167_ = stmt;
							_tmp168_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp167_);
							_tmp169_ = _tmp168_;
							vala_report_error (_tmp169_, "double catch clause of same error detected");
							_tmp170_ = stmt;
							vala_code_node_set_error ((ValaCodeNode*) _tmp170_, TRUE);
							_vala_flow_analyzer_jump_target_unref0 (prev_target);
						...
						ValaClass* _tmp172_;
						ValaClass* _tmp173_;
						ValaFlowAnalyzerJumpTarget* _tmp174_;
						ValaClass* _tmp175_;
						ValaClass* _tmp176_;
						_tmp171_ = prev_target;
						_tmp172_ = vala_flow_analyzer_jump_target_get_error_class (_tmp171_);
						_tmp173_ = _tmp172_;
						_tmp174_ = jump_target;
						_tmp175_ = vala_flow_analyzer_jump_target_get_error_class (_tmp174_);
						_tmp176_ = _tmp175_;
						if (_tmp173_ == _tmp176_) {
							ValaTryStatement* _tmp177_;
							ValaSourceReference* _tmp178_;
							ValaSourceReference* _tmp179_;
							ValaTryStatement* _tmp180_;
							_tmp177_ = stmt;
							_tmp178_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp177_);
							_tmp179_ = _tmp178_;
							vala_report_error (_tmp179_, "double catch clause of same error detected");
							_tmp180_ = stmt;
							vala_code_node_set_error ((ValaCodeNode*) _tmp180_, TRUE);
							_vala_flow_analyzer_jump_target_unref0 (prev_target);
							_vala_iterable_unref0 (_prev_target_list);
							_vala_flow_analyzer_jump_target_unref0 (jump_target);
							_vala_iterable_unref0 (_jump_target_list);
			...
			_tmp182_ = vala_flow_analyzer_jump_target_get_basic_block (_tmp181_);
			_tmp183_ = _tmp182_;
			_tmp184_ = vala_basic_block_get_predecessors (_tmp183_);
			_tmp185_ = _tmp184_;
			...
			if (_tmp188_) {
				...
				ValaCatchClause* _tmp190_;
				ValaCatchClause* _tmp191_;
				ValaSourceReference* _tmp192_;
				ValaSourceReference* _tmp193_;
				_tmp189_ = jump_target;
				_tmp190_ = vala_flow_analyzer_jump_target_get_catch_clause (_tmp189_);
				_tmp191_ = _tmp190_;
				_tmp192_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp191_);
				_tmp193_ = _tmp192_;
				vala_report_warning (_tmp193_, "unreachable catch clause detected");
			} else {
				...
				ValaCatchClause* _tmp200_;
				ValaCatchClause* _tmp201_;
				ValaFlowAnalyzerJumpTarget* _tmp202_;
				ValaCatchClause* _tmp203_;
				ValaCatchClause* _tmp204_;
				ValaBlock* _tmp205_;
				ValaBlock* _tmp206_;
				ValaBasicBlock* _tmp207_;
				_tmp194_ = jump_target;
				_tmp195_ = vala_flow_analyzer_jump_target_get_basic_block (_tmp194_);
				_tmp196_ = _tmp195_;
				_tmp197_ = _vala_basic_block_ref0 (_tmp196_);
				_vala_basic_block_unref0 (self->priv->current_block);
				self->priv->current_block = _tmp197_;
				_tmp198_ = self->priv->current_block;
				_tmp199_ = jump_target;
				_tmp200_ = vala_flow_analyzer_jump_target_get_catch_clause (_tmp199_);
				_tmp201_ = _tmp200_;
				vala_basic_block_add_node (_tmp198_, (ValaCodeNode*) _tmp201_);
				_tmp202_ = jump_target;
				_tmp203_ = vala_flow_analyzer_jump_target_get_catch_clause (_tmp202_);
				_tmp204_ = _tmp203_;
				_tmp205_ = vala_catch_clause_get_body (_tmp204_);
				_tmp206_ = _tmp205_;
				vala_code_node_accept ((ValaCodeNode*) _tmp206_, (ValaCodeVisitor*) self);
				_tmp207_ = self->priv->current_block;
				if (_tmp207_ != NULL) {
					ValaBasicBlock* _tmp208_;
					ValaBasicBlock* _tmp213_;
					ValaBasicBlock* _tmp214_;
					_tmp208_ = finally_block;
					if (_tmp208_ != NULL) {
						ValaBasicBlock* _tmp209_;
						ValaBasicBlock* _tmp210_;
						ValaBasicBlock* _tmp211_;
						ValaBasicBlock* _tmp212_;
						_tmp209_ = self->priv->current_block;
						_tmp210_ = finally_block;
						vala_basic_block_connect (_tmp209_, _tmp210_);
						_tmp211_ = finally_block;
						_tmp212_ = _vala_basic_block_ref0 (_tmp211_);
						_vala_basic_block_unref0 (self->priv->current_block);
						self->priv->current_block = _tmp212_;
					}
					_tmp213_ = self->priv->current_block;
					_tmp214_ = after_try_block;
					vala_basic_block_connect (_tmp213_, _tmp214_);
				}
			}
			_vala_flow_analyzer_jump_target_unref0 (jump_target);
		}
	...
	_tmp215_ = finally_block;
	if (_tmp215_ != NULL) {
		ValaList* _tmp216_;
		ValaList* _tmp217_;
		gint _tmp218_;
		gint _tmp219_;
		_tmp216_ = self->priv->jump_stack;
		_tmp217_ = self->priv->jump_stack;
		_tmp218_ = vala_collection_get_size ((ValaCollection*) _tmp217_);
		_tmp219_ = _tmp218_;
		vala_list_remove_at (_tmp216_, _tmp219_ - 1);
	}
	_tmp220_ = after_try_block;
	_tmp221_ = vala_basic_block_get_predecessors (_tmp220_);
	_tmp222_ = _tmp221_;
	...
	if (_tmp225_) {
		ValaBasicBlock* _tmp226_;
		ValaBasicBlock* _tmp227_;
		_tmp226_ = after_try_block;
		_tmp227_ = _vala_basic_block_ref0 (_tmp226_);
		_vala_basic_block_unref0 (self->priv->current_block);
		self->priv->current_block = _tmp227_;
	} else {
		ValaTryStatement* _tmp228_;
		_tmp228_ = stmt;
		vala_try_statement_set_after_try_block_reachable (_tmp228_, FALSE);
		vala_flow_analyzer_mark_unreachable (self);
	}
	_vala_iterable_unref0 (catch_stack);
	_vala_iterable_unref0 (catch_clauses);
...
static void vala_flow_analyzer_real_visit_expression (ValaCodeVisitor* base, ValaExpression* expr) {
	...
	_tmp0_ = expr;
	if (!VALA_IS_LAMBDA_EXPRESSION (_tmp0_)) {
		ValaExpression* _tmp1_;
		_tmp1_ = expr;

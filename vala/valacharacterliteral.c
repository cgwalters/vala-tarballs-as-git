...
static gboolean vala_character_literal_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	if (_tmp6_ == VALA_PROFILE_DOVA) {
		...
		_tmp9_ = _tmp8_;
		_tmp10_ = _tmp9_->root_symbol;
		_tmp11_ = vala_symbol_get_scope (_tmp10_);
		_tmp12_ = _tmp11_;
		_tmp13_ = vala_scope_lookup (_tmp12_, "char");
		_tmp14_ = VALA_STRUCT (_tmp13_);
		_tmp15_ = vala_character_literal_get_char (self);
		_tmp16_ = g_unichar_to_string (_tmp15_);
		_tmp17_ = _tmp16_;
		_tmp18_ = vala_integer_type_new (_tmp14_, _tmp17_, "int");
		_tmp19_ = _tmp18_;
		...
		gunichar _tmp20_ = 0U;
		_tmp20_ = vala_character_literal_get_char (self);
		if (_tmp20_ < ((gunichar) 128)) {
			...
			_tmp33_ = _tmp32_;
			_tmp34_ = _tmp33_->root_symbol;
			_tmp35_ = vala_symbol_get_scope (_tmp34_);
			_tmp36_ = _tmp35_;
			_tmp37_ = vala_scope_lookup (_tmp36_, "unichar");
			_tmp38_ = VALA_STRUCT (_tmp37_);
	...
	_tmp41_ = vala_code_node_get_error ((ValaCodeNode*) self);
	_tmp42_ = _tmp41_;
	result = !_tmp42_;
	return result;
}

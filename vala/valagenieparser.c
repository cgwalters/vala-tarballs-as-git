...
static inline void vala_genie_parser_prev (ValaGenieParser* self) {
	...
	self->priv->size = _tmp1_ + 1;
	_tmp2_ = self->priv->size;
	g_assert (_tmp2_ <= VALA_GENIE_PARSER_BUFFER_SIZE);
}
...
static void vala_genie_parser_skip_type (ValaGenieParser* self, GError** error) {
	...
	GError * _inner_error_ = NULL;
	g_return_if_fail (self != NULL);
	_tmp0_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_VOID);
	if (_tmp0_) {
		while (TRUE) {
			gboolean _tmp1_ = FALSE;
			_tmp1_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_STAR);
			if (!_tmp1_) {
				break;
			}
		}
	...
	_tmp4_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_ARRAY);
	if (_tmp4_) {
		_tmp3_ = TRUE;
	} else {
		gboolean _tmp5_ = FALSE;
		_tmp5_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_LIST);
		_tmp3_ = _tmp5_;
	}
	_tmp6_ = _tmp3_;
	if (_tmp6_) {
		...
		_tmp7_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_DICT);
		_tmp2_ = _tmp7_;
	}
	_tmp8_ = _tmp2_;
	if (_tmp8_) {
	...
	while (TRUE) {
		...
		_tmp9_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_OPEN_BRACKET);
		if (!_tmp9_) {
			break;
		}
		{
			...
			while (TRUE) {
				...
				if (_tmp14_ != VALA_GENIE_TOKEN_TYPE_COMMA) {
					ValaGenieTokenType _tmp15_ = 0;
					_tmp15_ = vala_genie_parser_current (self);
					_tmp13_ = _tmp15_ != VALA_GENIE_TOKEN_TYPE_CLOSE_BRACKET;
				} else {
					_tmp13_ = FALSE;
				}
				_tmp16_ = _tmp13_;
...
static ValaDataType* vala_genie_parser_parse_type (ValaGenieParser* self, gboolean owned_by_default, GError** error) {
	...
	vala_genie_parser_get_location (self, &_tmp0_);
	begin = _tmp0_;
	_tmp1_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_VOID);
	if (_tmp1_) {
		ValaVoidType* _tmp2_;
		ValaDataType* type;
		...
		while (TRUE) {
			...
			_tmp3_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_STAR);
			if (!_tmp3_) {
				break;
			}
			_tmp4_ = type;
			_tmp5_ = vala_pointer_type_new (_tmp4_, NULL);
	...
	type_arg_list = NULL;
	sym = NULL;
	_tmp6_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_DYNAMIC);
	is_dynamic = _tmp6_;
	_tmp7_ = owned_by_default;
	value_owned = _tmp7_;
	_tmp8_ = owned_by_default;
	if (_tmp8_) {
		gboolean _tmp9_ = FALSE;
		gboolean _tmp10_ = FALSE;
		gboolean _tmp12_;
		_tmp10_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_UNOWNED);
		if (_tmp10_) {
			_tmp9_ = TRUE;
		} else {
			gboolean _tmp11_ = FALSE;
			_tmp11_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_WEAK);
			_tmp9_ = _tmp11_;
		}
		_tmp12_ = _tmp9_;
		if (_tmp12_) {
		...
		gboolean _tmp13_ = FALSE;
		_tmp13_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_OWNED);
		value_owned = _tmp13_;
	}
	is_array = FALSE;
	_tmp14_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_ARRAY);
	if (_tmp14_) {
	...
	is_list = FALSE;
	_tmp15_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_LIST);
	if (_tmp15_) {
		vala_genie_parser_expect (self, VALA_GENIE_TOKEN_TYPE_OF, &_inner_error_);
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
	...
	is_dict = FALSE;
	_tmp16_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_DICT);
	if (_tmp16_) {
		vala_genie_parser_expect (self, VALA_GENIE_TOKEN_TYPE_OF, &_inner_error_);
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
	...
	if (_tmp17_) {
		...
		_tmp20_ = _tmp19_;
		_tmp21_ = vala_unresolved_symbol_new (NULL, "Gee", _tmp20_);
		_tmp22_ = _tmp21_;
		...
		_tmp26_ = _tmp25_;
		_tmp27_ = vala_unresolved_symbol_new (_tmp23_, "ArrayList", _tmp26_);
		_vala_code_node_unref0 (sym);
		sym = _tmp27_;
		...
		if (_tmp28_) {
			...
			_tmp37_ = _tmp36_;
			_tmp38_ = vala_unresolved_symbol_new (_tmp34_, "HashMap", _tmp37_);
			_vala_code_node_unref0 (sym);
			sym = _tmp38_;
	...
	_tmp41_ = vala_genie_parser_parse_type_argument_list (self, FALSE, &_inner_error_);
	_tmp42_ = _tmp41_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == VALA_PARSE_ERROR) {
			g_propagate_error (error, _inner_error_);
	...
	_vala_iterable_unref0 (type_arg_list);
	type_arg_list = _tmp42_;
	_tmp43_ = sym;
	_tmp44_ = begin;
	_tmp45_ = vala_genie_parser_get_src (self, &_tmp44_);
	_tmp46_ = _tmp45_;
	_tmp47_ = vala_unresolved_type_new_from_symbol (_tmp43_, _tmp46_);
	_tmp48_ = (ValaDataType*) _tmp47_;
	...
	while (TRUE) {
		...
		ValaPointerType* _tmp68_;
		_tmp63_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_STAR);
		if (!_tmp63_) {
			break;
		}
		_tmp64_ = type;
		...
		_tmp67_ = _tmp66_;
		_tmp68_ = vala_pointer_type_new (_tmp64_, _tmp67_);
		_vala_code_node_unref0 (type);
		type = (ValaDataType*) _tmp68_;
		_vala_source_reference_unref0 (_tmp67_);
	}
	_tmp69_ = type;
	if (!VALA_IS_POINTER_TYPE (_tmp69_)) {
		ValaDataType* _tmp70_;
		gboolean _tmp71_ = FALSE;
		_tmp70_ = type;
		_tmp71_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_INTERR);
		vala_data_type_set_nullable (_tmp70_, _tmp71_);
	}
	_tmp72_ = is_array;
	if (_tmp72_) {
		gboolean _tmp73_ = FALSE;
		_tmp73_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_OPEN_BRACKET);
		if (!_tmp73_) {
			...
			_tmp78_ = _tmp77_;
			_tmp79_ = vala_array_type_new (_tmp75_, 1, _tmp78_);
			_vala_code_node_unref0 (type);
			type = (ValaDataType*) _tmp79_;
			_vala_source_reference_unref0 (_tmp78_);
			_tmp80_ = type;
			_tmp81_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_INTERR);
			vala_data_type_set_nullable (_tmp80_, _tmp81_);
		} else {
			vala_genie_parser_prev (self);
			while (TRUE) {
				...
				_tmp82_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_OPEN_BRACKET);
				if (!_tmp82_) {
					break;
				}
				invalid_array = FALSE;
				array_rank = 0;
				{
					...
					while (TRUE) {
						...
						ValaGenieTokenType _tmp88_ = 0;
						gboolean _tmp90_;
						_tmp84_ = _tmp83_;
						if (!_tmp84_) {
							gboolean _tmp85_ = FALSE;
							_tmp85_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_COMMA);
							if (!_tmp85_) {
								break;
							}
						}
						_tmp83_ = FALSE;
						_tmp86_ = array_rank;
						array_rank = _tmp86_ + 1;
						_tmp88_ = vala_genie_parser_current (self);
						if (_tmp88_ != VALA_GENIE_TOKEN_TYPE_COMMA) {
							ValaGenieTokenType _tmp89_ = 0;
							_tmp89_ = vala_genie_parser_current (self);
							_tmp87_ = _tmp89_ != VALA_GENIE_TOKEN_TYPE_CLOSE_BRACKET;
						} else {
							_tmp87_ = FALSE;
						}
						_tmp90_ = _tmp87_;
						if (_tmp90_) {
							...
							_tmp91_ = vala_genie_parser_parse_expression (self, &_inner_error_);
							_tmp92_ = _tmp91_;
				...
				_tmp95_ = array_rank;
				_tmp96_ = begin;
				_tmp97_ = vala_genie_parser_get_src (self, &_tmp96_);
				_tmp98_ = _tmp97_;
				_tmp99_ = vala_array_type_new (_tmp94_, _tmp95_, _tmp98_);
				_tmp100_ = _tmp99_;
				_vala_source_reference_unref0 (_tmp98_);
				array_type = _tmp100_;
				_tmp101_ = array_type;
				_tmp102_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_INTERR);
				vala_data_type_set_nullable ((ValaDataType*) _tmp101_, _tmp102_);
				_tmp103_ = array_type;
				_tmp104_ = invalid_array;
				vala_array_type_set_invalid_syntax (_tmp103_, _tmp104_);
				_tmp105_ = array_type;
				_tmp106_ = _vala_code_node_ref0 ((ValaDataType*) _tmp105_);
				_vala_code_node_unref0 (type);
				type = _tmp106_;
	...
	_tmp107_ = owned_by_default;
	if (!_tmp107_) {
		gboolean _tmp108_ = FALSE;
		_tmp108_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_HASH);
		value_owned = _tmp108_;
	}
	_tmp109_ = type;
	_tmp110_ = is_dynamic;
	vala_data_type_set_is_dynamic (_tmp109_, _tmp110_);
	_tmp111_ = type;
	_tmp112_ = value_owned;
			...
			while (TRUE) {
				...
				if (_tmp8_ == 0) {
					...
					if (_tmp10_ != NULL) {
						ValaExpression* _tmp11_;
						_tmp11_ = p_expr;
						if (VALA_IS_STRING_LITERAL (_tmp11_)) {
							ValaExpression* _tmp12_;
							...
							gint _tmp19_;
							_tmp12_ = p_expr;
							_tmp13_ = _vala_code_node_ref0 (VALA_STRING_LITERAL (_tmp12_));
							s_exp = _tmp13_;
							_tmp14_ = s_exp;
...
static ValaExpression* vala_genie_parser_parse_object_or_array_creation_expression (ValaGenieParser* self, GError** error) {
	...
	if (_tmp11_) {
		...
		_tmp12_ = vala_genie_parser_parse_type (self, TRUE, &_inner_error_);
		mtype1 = _tmp12_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
...
static ValaExpression* vala_genie_parser_parse_yield_expression (ValaGenieParser* self, GError** error) {
	...
	base_expr = NULL;
	_tmp1_ = vala_genie_parser_current (self);
	if (_tmp1_ == VALA_GENIE_TOKEN_TYPE_SUPER) {
		ValaExpression* _tmp2_ = NULL;
		ValaExpression* _tmp3_;
		_tmp2_ = vala_genie_parser_parse_base_access (self, &_inner_error_);
		_tmp3_ = _tmp2_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
	...
	_tmp4_ = base_expr;
	_tmp5_ = vala_genie_parser_parse_member_name (self, _tmp4_, &_inner_error_);
	member = _tmp5_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == VALA_PARSE_ERROR) {
			g_propagate_error (error, _inner_error_);
	...
	_tmp6_ = begin;
	_tmp7_ = member;
	_tmp8_ = vala_genie_parser_parse_method_call (self, &_tmp6_, (ValaExpression*) _tmp7_, &_inner_error_);
	_tmp9_ = _tmp8_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == VALA_PARSE_ERROR) {
			g_propagate_error (error, _inner_error_);
	...
	call = VALA_METHOD_CALL (_tmp9_);
	_tmp10_ = call;
	vala_method_call_set_is_yield_expression (_tmp10_, TRUE);
...
static ValaExpression* vala_genie_parser_parse_unary_expression (ValaGenieParser* self, GError** error) {
	...
	switch (_tmp12_) {
		case VALA_GENIE_TOKEN_TYPE_HASH:
		{
			...
			ValaSourceReference* _tmp16_ = NULL;
			ValaSourceReference* _tmp17_;
			ValaReferenceTransferExpression* _tmp18_;
			ValaExpression* _tmp19_;
			vala_genie_parser_next (self);
			_tmp13_ = vala_genie_parser_parse_unary_expression (self, &_inner_error_);
			op = _tmp13_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
			...
			_tmp16_ = vala_genie_parser_get_src (self, &_tmp15_);
			_tmp17_ = _tmp16_;
			_tmp18_ = vala_reference_transfer_expression_new (_tmp14_, _tmp17_);
		...
		case VALA_GENIE_TOKEN_TYPE_OPEN_PARENS:
		{
			ValaGenieTokenType _tmp20_ = 0;
			ValaSourceLocation _tmp48_;
			vala_genie_parser_next (self);
			_tmp20_ = vala_genie_parser_current (self);
			switch (_tmp20_) {
				case VALA_GENIE_TOKEN_TYPE_OWNED:
				{
					gboolean _tmp21_ = FALSE;
					vala_genie_parser_next (self);
					_tmp21_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_CLOSE_PARENS);
					if (_tmp21_) {
						ValaExpression* _tmp22_ = NULL;
						ValaExpression* op;
						ValaExpression* _tmp23_;
						...
						ValaExpression* _tmp28_;
						_tmp22_ = vala_genie_parser_parse_unary_expression (self, &_inner_error_);
						op = _tmp22_;
						if (_inner_error_ != NULL) {
							if (_inner_error_->domain == VALA_PARSE_ERROR) {
								g_propagate_error (error, _inner_error_);
				...
				case VALA_GENIE_TOKEN_TYPE_DICT:
				{
					...
					_tmp29_ = vala_genie_parser_parse_type (self, TRUE, &_inner_error_);
					type = _tmp29_;
					if (_inner_error_ != NULL) {
						if (_inner_error_->domain == VALA_PARSE_ERROR) {
							g_propagate_error (error, _inner_error_);
					...
					_tmp30_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_CLOSE_PARENS);
					if (_tmp30_) {
						ValaGenieTokenType _tmp31_ = 0;
						_tmp31_ = vala_genie_parser_current (self);
						switch (_tmp31_) {
							...
							case VALA_GENIE_TOKEN_TYPE_PARAMS:
							{
								...
								ValaSourceReference* _tmp36_ = NULL;
								ValaSourceReference* _tmp37_;
								ValaCastExpression* _tmp38_;
								ValaExpression* _tmp39_;
								_tmp32_ = vala_genie_parser_parse_unary_expression (self, &_inner_error_);
								inner = _tmp32_;
								if (_inner_error_ != NULL) {
									if (_inner_error_->domain == VALA_PARSE_ERROR) {
										g_propagate_error (error, _inner_error_);
								...
								_tmp36_ = vala_genie_parser_get_src (self, &_tmp35_);
								_tmp37_ = _tmp36_;
								_tmp38_ = vala_cast_expression_new (_tmp33_, _tmp34_, _tmp37_, FALSE);
								_tmp39_ = (ValaExpression*) _tmp38_;
								_vala_source_reference_unref0 (_tmp37_);
								result = _tmp39_;
								_vala_code_node_unref0 (inner);
				...
				case VALA_GENIE_TOKEN_TYPE_OP_NEG:
				{
					...
					vala_genie_parser_next (self);
					_tmp40_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_CLOSE_PARENS);
					if (_tmp40_) {
						...
						ValaCastExpression* _tmp46_;
						ValaExpression* _tmp47_;
						_tmp41_ = vala_genie_parser_parse_unary_expression (self, &_inner_error_);
						inner = _tmp41_;
						if (_inner_error_ != NULL) {
							if (_inner_error_->domain == VALA_PARSE_ERROR) {
								g_propagate_error (error, _inner_error_);
						...
						_tmp45_ = _tmp44_;
						_tmp46_ = vala_cast_expression_new_non_null (_tmp42_, _tmp45_);
			...
			_tmp48_ = begin;
			vala_genie_parser_rollback (self, &_tmp48_);
			break;
		}
		case VALA_GENIE_TOKEN_TYPE_STAR:
		{
			...
			ValaPointerIndirection* _tmp54_;
			ValaExpression* _tmp55_;
			vala_genie_parser_next (self);
			_tmp49_ = vala_genie_parser_parse_unary_expression (self, &_inner_error_);
			op = _tmp49_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
			...
			_tmp53_ = _tmp52_;
			_tmp54_ = vala_pointer_indirection_new (_tmp50_, _tmp53_);
		...
		case VALA_GENIE_TOKEN_TYPE_BITWISE_AND:
		{
			...
			ValaExpression* _tmp62_;
			vala_genie_parser_next (self);
			_tmp56_ = vala_genie_parser_parse_unary_expression (self, &_inner_error_);
			op = _tmp56_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
	...
	_tmp63_ = vala_genie_parser_parse_primary_expression (self, &_inner_error_);
	expr = _tmp63_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == VALA_PARSE_ERROR) {
			g_propagate_error (error, _inner_error_);
			...
			default:
			{
				...
				switch (_tmp26_) {
					case VALA_GENIE_TOKEN_TYPE_ISA:
					{
						...
						vala_genie_parser_next (self);
						_tmp27_ = vala_genie_parser_parse_type (self, TRUE, &_inner_error_);
						type = _tmp27_;
						if (_inner_error_ != NULL) {
							if (_inner_error_->domain == VALA_PARSE_ERROR) {
								g_propagate_error (error, _inner_error_);
					...
					case VALA_GENIE_TOKEN_TYPE_AS:
					{
						...
						vala_genie_parser_next (self);
						_tmp34_ = vala_genie_parser_parse_type (self, TRUE, &_inner_error_);
						type = _tmp34_;
						if (_inner_error_ != NULL) {
							if (_inner_error_->domain == VALA_PARSE_ERROR) {
								g_propagate_error (error, _inner_error_);
...
static ValaExpression* vala_genie_parser_parse_lambda_expression (ValaGenieParser* self, GError** error) {
	...
	if (_tmp3_) {
		...
		if (_tmp4_ != VALA_GENIE_TOKEN_TYPE_CLOSE_PARENS) {
			{
				...
				while (TRUE) {
					...
					_tmp10_ = _tmp9_;
					vala_genie_parser_get_location (self, &_tmp11_);
					_tmp12_ = vala_genie_parser_get_src (self, &_tmp11_);
					_tmp13_ = _tmp12_;
					_tmp14_ = vala_parameter_new (_tmp10_, NULL, _tmp13_);
					_tmp15_ = _tmp14_;
					_vala_source_reference_unref0 (_tmp13_);
					_g_free0 (_tmp10_);
					param = _tmp15_;
		...
		_tmp20_ = _tmp19_;
		vala_genie_parser_get_location (self, &_tmp21_);
		_tmp22_ = vala_genie_parser_get_src (self, &_tmp21_);
		_tmp23_ = _tmp22_;
		_tmp24_ = vala_parameter_new (_tmp20_, NULL, _tmp23_);
		_tmp25_ = _tmp24_;
		_vala_source_reference_unref0 (_tmp23_);
		_g_free0 (_tmp20_);
		param = _tmp25_;
	...
	_tmp28_ = vala_genie_parser_accept_block (self);
	if (_tmp28_) {
		...
		_tmp33_ = _tmp32_;
		_tmp34_ = vala_lambda_expression_new_with_statement_body (_tmp30_, _tmp33_);
		_vala_code_node_unref0 (lambda);
		lambda = _tmp34_;
		...
		_tmp38_ = vala_genie_parser_get_src (self, &_tmp37_);
		_tmp39_ = _tmp38_;
		_tmp40_ = vala_lambda_expression_new (_tmp36_, _tmp39_);
		_vala_code_node_unref0 (lambda);
		lambda = _tmp40_;
		_vala_source_reference_unref0 (_tmp39_);
	...
	}
	{
		...
		while (TRUE) {
			...
			_tmp52_ = lambda;
			_tmp53_ = param;
			vala_lambda_expression_add_parameter (_tmp52_, _tmp53_);
			_vala_code_node_unref0 (param);
		}
...
static ValaStatement* vala_genie_parser_parse_embedded_statement_without_block (ValaGenieParser* self, GError** error) {
	...
	switch (_tmp0_) {
		...
		default:
		{
			ValaStatement* _tmp29_ = NULL;
			ValaStatement* _tmp30_;
			_tmp29_ = vala_genie_parser_parse_expression_statement (self, &_inner_error_);
			_tmp30_ = _tmp29_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
...
static ValaBlock* vala_genie_parser_parse_block (ValaGenieParser* self, GError** error) {
	...
	_tmp23_ = _tmp22_;
	_tmp24_ = vala_genie_parser_get_current_src (self);
	_tmp25_ = _tmp24_;
...
static void vala_genie_parser_parse_local_variable_declarations (ValaGenieParser* self, ValaBlock* block, GError** error) {
	...
	_tmp21_ = vala_genie_parser_parse_type (self, TRUE, &_inner_error_);
	_tmp22_ = _tmp21_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == VALA_PARSE_ERROR) {
			g_propagate_error (error, _inner_error_);
...
static ValaStatement* vala_genie_parser_parse_for_statement (ValaGenieParser* self, GError** error) {
	...
	if (_tmp4_) {
		...
		if (_tmp15_) {
			...
			_tmp20_ = vala_genie_parser_parse_type (self, TRUE, &_inner_error_);
			_tmp21_ = _tmp20_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
...
static ValaSymbol* vala_genie_parser_parse_declaration (ValaGenieParser* self, gboolean is_root, GError** error) {
	...
	ValaSourceLocation begin;
	ValaGenieTokenType _tmp4_ = 0;
	ValaGenieTokenType _tmp68_ = 0;
	ValaGenieTokenType cur;
	ValaGenieParserTokenInfo* _tmp69_;
	gint _tmp69__length1;
	gint _tmp70_;
	ValaGenieParserTokenInfo _tmp71_;
	ValaGenieTokenType _tmp72_;
	ValaGenieTokenType pre;
	ValaGenieTokenType _tmp73_;
	const gchar* _tmp74_ = NULL;
	ValaGenieTokenType _tmp75_;
	...
	switch (_tmp4_) {
		...
		case VALA_GENIE_TOKEN_TYPE_INIT:
		{
			...
			if (_tmp20_ == VALA_PROFILE_GOBJECT) {
				...
				_tmp21_ = begin;
				vala_genie_parser_rollback (self, &_tmp21_);
				_tmp22_ = attrs;
		...
		case VALA_GENIE_TOKEN_TYPE_DELEGATE:
		{
			...
			ValaSymbol* _tmp27_;
			_tmp25_ = attrs;
			_tmp26_ = vala_genie_parser_parse_delegate_declaration (self, _tmp25_, &_inner_error_);
			_tmp27_ = _tmp26_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		case VALA_GENIE_TOKEN_TYPE_DEF:
		{
			...
			ValaMethod* _tmp30_;
			_tmp28_ = attrs;
			_tmp29_ = vala_genie_parser_parse_method_declaration (self, _tmp28_, &_inner_error_);
			_tmp30_ = _tmp29_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		case VALA_GENIE_TOKEN_TYPE_ENUM:
		{
			...
			ValaSymbol* _tmp33_;
			_tmp31_ = attrs;
			_tmp32_ = vala_genie_parser_parse_enum_declaration (self, _tmp31_, &_inner_error_);
			_tmp33_ = _tmp32_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		case VALA_GENIE_TOKEN_TYPE_ERRORDOMAIN:
		{
			...
			ValaSymbol* _tmp36_;
			_tmp34_ = attrs;
			_tmp35_ = vala_genie_parser_parse_errordomain_declaration (self, _tmp34_, &_inner_error_);
			_tmp36_ = _tmp35_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		case VALA_GENIE_TOKEN_TYPE_FINAL:
		{
			...
			_tmp37_ = attrs;
			_tmp38_ = vala_genie_parser_parse_destructor_declaration (self, _tmp37_, &_inner_error_);
			_tmp39_ = _tmp38_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		case VALA_GENIE_TOKEN_TYPE_INTERFACE:
		{
			...
			ValaSymbol* _tmp42_;
			_tmp40_ = attrs;
			_tmp41_ = vala_genie_parser_parse_interface_declaration (self, _tmp40_, &_inner_error_);
			_tmp42_ = _tmp41_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		case VALA_GENIE_TOKEN_TYPE_NAMESPACE:
		{
			...
			_tmp43_ = attrs;
			_tmp44_ = vala_genie_parser_parse_namespace_declaration (self, _tmp43_, &_inner_error_);
			_tmp45_ = _tmp44_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		case VALA_GENIE_TOKEN_TYPE_PROP:
		{
			...
			_tmp46_ = attrs;
			_tmp47_ = vala_genie_parser_parse_property_declaration (self, _tmp46_, &_inner_error_);
			_tmp48_ = _tmp47_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		case VALA_GENIE_TOKEN_TYPE_EVENT:
		{
			...
			ValaSignal* _tmp51_;
			_tmp49_ = attrs;
			_tmp50_ = vala_genie_parser_parse_signal_declaration (self, _tmp49_, &_inner_error_);
			_tmp51_ = _tmp50_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		case VALA_GENIE_TOKEN_TYPE_STRUCT:
		{
			...
			ValaSymbol* _tmp54_;
			_tmp52_ = attrs;
			_tmp53_ = vala_genie_parser_parse_struct_declaration (self, _tmp52_, &_inner_error_);
			_tmp54_ = _tmp53_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		default:
		{
			...
			while (TRUE) {
				...
				if (_tmp57_ != VALA_GENIE_TOKEN_TYPE_EOL) {
					ValaGenieTokenType _tmp58_ = 0;
					_tmp58_ = vala_genie_parser_current (self);
					_tmp56_ = _tmp58_ != VALA_GENIE_TOKEN_TYPE_SEMICOLON;
				} else {
					_tmp56_ = FALSE;
				}
				_tmp59_ = _tmp56_;
				if (_tmp59_) {
					ValaGenieTokenType _tmp60_ = 0;
					_tmp60_ = vala_genie_parser_current (self);
					_tmp55_ = _tmp60_ != VALA_GENIE_TOKEN_TYPE_EOF;
				} else {
					_tmp55_ = FALSE;
				}
				_tmp61_ = _tmp55_;
				...
				_tmp62_ = vala_genie_parser_current (self);
				if (_tmp62_ == VALA_GENIE_TOKEN_TYPE_COLON) {
					ValaSourceLocation _tmp63_;
					ValaList* _tmp64_;
					ValaField* _tmp65_ = NULL;
					ValaField* _tmp66_;
					_tmp63_ = begin;
					vala_genie_parser_rollback (self, &_tmp63_);
					_tmp64_ = attrs;
					_tmp65_ = vala_genie_parser_parse_field_declaration (self, _tmp64_, &_inner_error_);
					_tmp66_ = _tmp65_;
					if (_inner_error_ != NULL) {
						if (_inner_error_->domain == VALA_PARSE_ERROR) {
							g_propagate_error (error, _inner_error_);
	...
	_tmp68_ = vala_genie_parser_current (self);
	cur = _tmp68_;
	_tmp69_ = self->priv->tokens;
	_tmp69__length1 = self->priv->tokens_length1;
	_tmp70_ = self->priv->index;
	_tmp71_ = _tmp69_[_tmp70_ - 1];
	_tmp72_ = _tmp71_.type;
	pre = _tmp72_;
	_tmp73_ = cur;
	_tmp74_ = vala_genie_token_type_to_string (_tmp73_);
	_tmp75_ = pre;
	_tmp76_ = vala_genie_token_type_to_string (_tmp75_);
	_tmp77_ = g_strdup_printf ("expected declaration  but got %s with previous %s", _tmp74_, _tmp76_);
	_tmp78_ = _tmp77_;
	_tmp79_ = vala_genie_parser_get_error (self, _tmp78_);
	_tmp80_ = _tmp79_;
	_tmp81_ = g_error_new_literal (VALA_PARSE_ERROR, VALA_PARSE_ERROR_SYNTAX, _tmp80_);
	_tmp82_ = _tmp81_;
	_g_free0 (_tmp80_);
	_g_free0 (_tmp78_);
...
static void vala_genie_parser_parse_declarations (ValaGenieParser* self, ValaSymbol* parent, gboolean root, GError** error) {
	...
	while (TRUE) {
		...
		}
		{
			ValaSymbol* _tmp5_;
			_tmp5_ = parent;
			if (VALA_IS_NAMESPACE (_tmp5_)) {
				ValaSymbol* _tmp6_;
				_tmp6_ = parent;
				vala_genie_parser_parse_namespace_member (self, VALA_NAMESPACE (_tmp6_), &_inner_error_);
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == VALA_PARSE_ERROR) {
				...
				ValaSymbol* _tmp7_;
				_tmp7_ = parent;
				if (VALA_IS_CLASS (_tmp7_)) {
					ValaSymbol* _tmp8_;
					_tmp8_ = parent;
					vala_genie_parser_parse_class_member (self, VALA_CLASS (_tmp8_), &_inner_error_);
					if (_inner_error_ != NULL) {
						if (_inner_error_->domain == VALA_PARSE_ERROR) {
							goto __catch8_vala_parse_error;
						}
					...
					if (VALA_IS_STRUCT (_tmp9_)) {
						ValaSymbol* _tmp10_;
						_tmp10_ = parent;
						vala_genie_parser_parse_struct_member (self, VALA_STRUCT (_tmp10_), &_inner_error_);
						if (_inner_error_ != NULL) {
							if (_inner_error_->domain == VALA_PARSE_ERROR) {
								goto __catch8_vala_parse_error;
							}
						...
						if (VALA_IS_INTERFACE (_tmp11_)) {
							ValaSymbol* _tmp12_;
							_tmp12_ = parent;
							vala_genie_parser_parse_interface_member (self, VALA_INTERFACE (_tmp12_), &_inner_error_);
							if (_inner_error_ != NULL) {
								if (_inner_error_->domain == VALA_PARSE_ERROR) {
									goto __catch8_vala_parse_error;
								}
...
static ValaNamespace* vala_genie_parser_parse_namespace_declaration (ValaGenieParser* self, ValaList* attrs, GError** error) {
	...
	while (TRUE) {
		...
		_tmp32_ = ns;
		_tmp33_ = _result_;
		vala_symbol_add_namespace ((ValaSymbol*) _tmp32_, VALA_NAMESPACE (_tmp33_));
		_tmp34_ = ns;
...
static void vala_genie_parser_parse_namespace_member (ValaGenieParser* self, ValaNamespace* ns, GError** error) {
	...
	if (VALA_IS_NAMESPACE (sym)) {
		...
		_tmp5_ = ns;
		vala_symbol_add_namespace ((ValaSymbol*) _tmp5_, VALA_NAMESPACE (sym));
	} else {
		if (VALA_IS_CLASS (sym)) {
			ValaNamespace* _tmp6_;
			_tmp6_ = ns;
			vala_symbol_add_class ((ValaSymbol*) _tmp6_, VALA_CLASS (sym));
		} else {
			if (VALA_IS_INTERFACE (sym)) {
				ValaNamespace* _tmp7_;
				_tmp7_ = ns;
				vala_symbol_add_interface ((ValaSymbol*) _tmp7_, VALA_INTERFACE (sym));
			} else {
				if (VALA_IS_STRUCT (sym)) {
					ValaNamespace* _tmp8_;
					_tmp8_ = ns;
					vala_symbol_add_struct ((ValaSymbol*) _tmp8_, VALA_STRUCT (sym));
				} else {
					if (VALA_IS_ENUM (sym)) {
						ValaNamespace* _tmp9_;
						_tmp9_ = ns;
						vala_symbol_add_enum ((ValaSymbol*) _tmp9_, VALA_ENUM (sym));
					} else {
						if (VALA_IS_ERROR_DOMAIN (sym)) {
							ValaNamespace* _tmp10_;
							_tmp10_ = ns;
							vala_symbol_add_error_domain ((ValaSymbol*) _tmp10_, VALA_ERROR_DOMAIN (sym));
						} else {
							if (VALA_IS_DELEGATE (sym)) {
								ValaNamespace* _tmp11_;
								_tmp11_ = ns;
								vala_symbol_add_delegate ((ValaSymbol*) _tmp11_, VALA_DELEGATE (sym));
							} else {
								if (VALA_IS_METHOD (sym)) {
									...
									ValaNamespace* _tmp17_;
									ValaMethod* _tmp18_;
									_tmp12_ = _vala_code_node_ref0 (VALA_METHOD (sym));
									method = _tmp12_;
									_tmp13_ = method;
									...
									if (VALA_IS_FIELD (sym)) {
										...
										ValaField* _tmp25_;
										_tmp19_ = _vala_code_node_ref0 (VALA_FIELD (sym));
										field = _tmp19_;
										_tmp20_ = field;
										...
										if (VALA_IS_CONSTANT (sym)) {
											...
											_tmp26_ = ns;
											vala_symbol_add_constant ((ValaSymbol*) _tmp26_, VALA_CONSTANT (sym));
										} else {
...
static ValaSymbol* vala_genie_parser_parse_class_declaration (ValaGenieParser* self, ValaList* attrs, GError** error) {
		...
		if (_tmp10_) {
			{
				...
				while (TRUE) {
					...
					_tmp11_ = FALSE;
					_tmp14_ = vala_genie_parser_parse_type (self, TRUE, &_inner_error_);
					type2 = _tmp14_;
					if (_inner_error_ != NULL) {
						if (_inner_error_->domain == VALA_PARSE_ERROR) {
							g_propagate_error (error, _inner_error_);
	...
	while (TRUE) {
		...
		ns = _tmp110_;
		_tmp111_ = _result_;
		if (VALA_IS_NAMESPACE (_tmp111_)) {
			ValaNamespace* _tmp112_;
			ValaSymbol* _tmp113_;
			_tmp112_ = ns;
			_tmp113_ = _result_;
			vala_symbol_add_namespace ((ValaSymbol*) _tmp112_, VALA_NAMESPACE (_tmp113_));
		} else {
			ValaNamespace* _tmp114_;
			ValaSymbol* _tmp115_;
			_tmp114_ = ns;
			_tmp115_ = _result_;
			vala_symbol_add_class ((ValaSymbol*) _tmp114_, VALA_CLASS (_tmp115_));
		}
		_tmp116_ = ns;
...
static void vala_genie_parser_parse_class_member (ValaGenieParser* self, ValaClass* cl, GError** error) {
	...
	if (VALA_IS_CLASS (sym)) {
		ValaClass* _tmp1_;
		_tmp1_ = cl;
		vala_symbol_add_class ((ValaSymbol*) _tmp1_, VALA_CLASS (sym));
	} else {
		if (VALA_IS_STRUCT (sym)) {
			ValaClass* _tmp2_;
			_tmp2_ = cl;
			vala_symbol_add_struct ((ValaSymbol*) _tmp2_, VALA_STRUCT (sym));
		} else {
			if (VALA_IS_ENUM (sym)) {
				ValaClass* _tmp3_;
				_tmp3_ = cl;
				vala_symbol_add_enum ((ValaSymbol*) _tmp3_, VALA_ENUM (sym));
			} else {
				if (VALA_IS_DELEGATE (sym)) {
					ValaClass* _tmp4_;
					_tmp4_ = cl;
					vala_symbol_add_delegate ((ValaSymbol*) _tmp4_, VALA_DELEGATE (sym));
				} else {
					if (VALA_IS_METHOD (sym)) {
						ValaClass* _tmp5_;
						_tmp5_ = cl;
						vala_symbol_add_method ((ValaSymbol*) _tmp5_, VALA_METHOD (sym));
					} else {
						if (VALA_IS_SIGNAL (sym)) {
							ValaClass* _tmp6_;
							_tmp6_ = cl;
							vala_symbol_add_signal ((ValaSymbol*) _tmp6_, VALA_SIGNAL (sym));
						} else {
							if (VALA_IS_FIELD (sym)) {
								ValaClass* _tmp7_;
								_tmp7_ = cl;
								vala_symbol_add_field ((ValaSymbol*) _tmp7_, VALA_FIELD (sym));
							} else {
								if (VALA_IS_CONSTANT (sym)) {
									ValaClass* _tmp8_;
									_tmp8_ = cl;
									vala_symbol_add_constant ((ValaSymbol*) _tmp8_, VALA_CONSTANT (sym));
								} else {
									if (VALA_IS_PROPERTY (sym)) {
										ValaClass* _tmp9_;
										_tmp9_ = cl;
										vala_symbol_add_property ((ValaSymbol*) _tmp9_, VALA_PROPERTY (sym));
									} else {
										if (VALA_IS_CONSTRUCTOR (sym)) {
											...
											_tmp10_ = _vala_code_node_ref0 (VALA_CONSTRUCTOR (sym));
											c = _tmp10_;
											_tmp11_ = c;
											...
											if (VALA_IS_DESTRUCTOR (sym)) {
												...
												_tmp41_ = _vala_code_node_ref0 (VALA_DESTRUCTOR (sym));
												d = _tmp41_;
												_tmp42_ = d;
												...
												if (_tmp44_ == VALA_MEMBER_BINDING_STATIC) {
													...
													_tmp51_ = cl;
													_tmp52_ = d;
													vala_class_set_static_destructor (_tmp51_, VALA_DESTRUCTOR (_tmp52_));
												} else {
													...
													if (_tmp55_ == VALA_MEMBER_BINDING_CLASS) {
														...
														_tmp62_ = cl;
														_tmp63_ = d;
														vala_class_set_class_destructor (_tmp62_, VALA_DESTRUCTOR (_tmp63_));
													} else {
														ValaClass* _tmp64_;
														...
														_tmp70_ = cl;
														_tmp71_ = d;
														vala_class_set_destructor (_tmp70_, VALA_DESTRUCTOR (_tmp71_));
													}
												}
	...
	if (_tmp58_) {
		{
			...
			while (TRUE) {
				...
				_tmp59_ = FALSE;
				_tmp62_ = vala_genie_parser_parse_type (self, TRUE, &_inner_error_);
				_tmp63_ = _tmp62_;
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == VALA_PARSE_ERROR) {
						g_propagate_error (error, _inner_error_);
...
static ValaProperty* vala_genie_parser_parse_property_declaration (ValaGenieParser* self, ValaList* attrs, GError** error) {
	...
	_tmp4_ = vala_genie_parser_parse_type (self, FALSE, &_inner_error_);
	type = _tmp4_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == VALA_PARSE_ERROR) {
			g_propagate_error (error, _inner_error_);
	...
	if (_tmp50_) {
		...
		while (TRUE) {
			...
			if (_tmp58_) {
				...
				if (_tmp85_) {
					...
					_tmp94_ = _tmp93_;
					if (_tmp94_ == VALA_PROFILE_GOBJECT) {
						gboolean _tmp95_ = FALSE;
						_tmp95_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_CONSTRUCT);
						_tmp91_ = _tmp95_;
					} else {
						_tmp91_ = FALSE;
					}
					...
					_tmp99_ = vala_code_context_get_profile (_tmp98_);
					_tmp100_ = _tmp99_;
					if (_tmp100_ == VALA_PROFILE_GOBJECT) {
						gboolean _tmp101_ = FALSE;
						_tmp101_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_CONSTRUCT);
						_tmp97_ = _tmp101_;
					} else {
						_tmp97_ = FALSE;
					}
					...
					if (_tmp102_) {
						...
						_tmp103_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_EOL);
						if (!_tmp103_) {
							gchar* _tmp104_ = NULL;
							gchar* _tmp105_;
							GError* _tmp106_;
							GError* _tmp107_;
							_tmp104_ = vala_genie_parser_get_error (self, "expected get, set, or construct");
							_tmp105_ = _tmp104_;
							_tmp106_ = g_error_new_literal (VALA_PARSE_ERROR, VALA_PARSE_ERROR_SYNTAX, _tmp105_);
							_tmp107_ = _tmp106_;
							_g_free0 (_tmp105_);
				...
				_tmp108_ = prop;
				_tmp109_ = vala_property_get_set_accessor (_tmp108_);
				_tmp110_ = _tmp109_;
				if (_tmp110_ != NULL) {
					gchar* _tmp111_ = NULL;
					gchar* _tmp112_;
					GError* _tmp113_;
					GError* _tmp114_;
					_tmp111_ = vala_genie_parser_get_error (self, "property set accessor already defined");
					_tmp112_ = _tmp111_;
					_tmp113_ = g_error_new_literal (VALA_PARSE_ERROR, VALA_PARSE_ERROR_SYNTAX, _tmp112_);
					_tmp114_ = _tmp113_;
					_g_free0 (_tmp112_);
				...
				block = NULL;
				_tmp115_ = vala_genie_parser_accept_block (self);
				if (_tmp115_) {
					ValaBlock* _tmp116_ = NULL;
					ValaBlock* _tmp117_;
					ValaProperty* _tmp118_;
					_tmp116_ = vala_genie_parser_parse_block (self, &_inner_error_);
					_tmp117_ = _tmp116_;
					if (_inner_error_ != NULL) {
						if (_inner_error_->domain == VALA_PARSE_ERROR) {
							g_propagate_error (error, _inner_error_);
				...
				_tmp122_ = value_type;
				_tmp123_ = block;
				_tmp124_ = accessor_begin;
				_tmp125_ = vala_genie_parser_get_src (self, &_tmp124_);
				_tmp126_ = _tmp125_;
				_tmp127_ = vala_property_accessor_new (FALSE, !_tmp120_, _tmp121_, _tmp122_, _tmp123_, _tmp126_, NULL);
				_tmp128_ = _tmp127_;
				vala_property_set_set_accessor (_tmp119_, _tmp128_);
				...
				_tmp131_ = _tmp130_;
				_tmp132_ = attribs;
				vala_genie_parser_set_attributes (self, (ValaCodeNode*) _tmp131_, _tmp132_);
				_tmp133_ = prop;
				_tmp134_ = vala_property_get_set_accessor (_tmp133_);
				_tmp135_ = _tmp134_;
				vala_symbol_set_access ((ValaSymbol*) _tmp135_, VALA_SYMBOL_ACCESSIBILITY_PUBLIC);
				_vala_code_node_unref0 (block);
			}
			_vala_code_node_unref0 (value_type);
			_vala_iterable_unref0 (attribs);
		...
		value_type = _tmp137_;
		_tmp138_ = value_type;
		vala_data_type_set_value_owned (_tmp138_, FALSE);
		_tmp139_ = prop;
		_tmp140_ = value_type;
		_tmp141_ = begin;
		_tmp142_ = vala_genie_parser_get_src (self, &_tmp141_);
		_tmp143_ = _tmp142_;
		_tmp144_ = vala_property_accessor_new (TRUE, FALSE, FALSE, _tmp140_, NULL, _tmp143_, NULL);
		_tmp145_ = _tmp144_;
		vala_property_set_get_accessor (_tmp139_, _tmp145_);
		_vala_code_node_unref0 (_tmp145_);
		_vala_source_reference_unref0 (_tmp143_);
		_tmp146_ = prop;
		_tmp147_ = vala_property_get_get_accessor (_tmp146_);
		_tmp148_ = _tmp147_;
		vala_symbol_set_access ((ValaSymbol*) _tmp148_, VALA_SYMBOL_ACCESSIBILITY_PUBLIC);
		_tmp149_ = readonly;
		if (!_tmp149_) {
			...
			_tmp154_ = value_type;
			_tmp155_ = begin;
			_tmp156_ = vala_genie_parser_get_src (self, &_tmp155_);
			_tmp157_ = _tmp156_;
			_tmp158_ = vala_property_accessor_new (FALSE, TRUE, FALSE, _tmp154_, NULL, _tmp157_, NULL);
			_tmp159_ = _tmp158_;
			vala_property_set_set_accessor (_tmp153_, _tmp159_);
			_vala_code_node_unref0 (_tmp159_);
			_vala_source_reference_unref0 (_tmp157_);
			_tmp160_ = prop;
			_tmp161_ = vala_property_get_set_accessor (_tmp160_);
			_tmp162_ = _tmp161_;
	...
	_tmp166_ = _tmp165_;
	if (!_tmp166_) {
		ValaGenieScanner* _tmp167_;
		ValaSourceFile* _tmp168_;
		ValaSourceFile* _tmp169_;
		ValaSourceFileType _tmp170_;
		ValaSourceFileType _tmp171_;
		_tmp167_ = self->priv->scanner;
		_tmp168_ = vala_genie_scanner_get_source_file (_tmp167_);
		_tmp169_ = _tmp168_;
		_tmp170_ = vala_source_file_get_file_type (_tmp169_);
		_tmp171_ = _tmp170_;
		_tmp163_ = _tmp171_ == VALA_SOURCE_FILE_TYPE_SOURCE;
	} else {
		_tmp163_ = FALSE;
	}
	_tmp172_ = _tmp163_;
	if (_tmp172_) {
		...
		if (_tmp209_) {
			...
			ValaMemberBinding _tmp237_;
			_tmp210_ = prop;
			_tmp211_ = vala_property_get_property_type (_tmp210_);
			_tmp212_ = _tmp211_;
			_tmp213_ = vala_data_type_copy (_tmp212_);
			variable_type = _tmp213_;
			_tmp214_ = prop;
			_tmp215_ = prop;
			_tmp216_ = vala_symbol_get_name ((ValaSymbol*) _tmp215_);
			_tmp217_ = _tmp216_;
			_tmp218_ = g_strdup_printf ("_%s", _tmp217_);
			_tmp219_ = _tmp218_;
			_tmp220_ = variable_type;
			_tmp221_ = prop;
			_tmp222_ = vala_property_get_initializer (_tmp221_);
			_tmp223_ = _tmp222_;
			_tmp224_ = prop;
			_tmp225_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp224_);
			_tmp226_ = _tmp225_;
			_tmp227_ = vala_field_new (_tmp219_, _tmp220_, _tmp223_, _tmp226_, NULL);
			_tmp228_ = _tmp227_;
			vala_property_set_field (_tmp214_, _tmp228_);
			_vala_code_node_unref0 (_tmp228_);
			_g_free0 (_tmp219_);
			_tmp229_ = prop;
			_tmp230_ = vala_property_get_field (_tmp229_);
			_tmp231_ = _tmp230_;
			vala_symbol_set_access ((ValaSymbol*) _tmp231_, VALA_SYMBOL_ACCESSIBILITY_PRIVATE);
			_tmp232_ = prop;
			_tmp233_ = vala_property_get_field (_tmp232_);
			_tmp234_ = _tmp233_;
			_tmp235_ = prop;
			_tmp236_ = vala_property_get_binding (_tmp235_);
			_tmp237_ = _tmp236_;
			vala_field_set_binding (_tmp234_, _tmp237_);
			_vala_code_node_unref0 (variable_type);
		}
	}
	result = prop;
...
static ValaSymbol* vala_genie_parser_parse_struct_declaration (ValaGenieParser* self, ValaList* attrs, GError** error) {
	...
	while (TRUE) {
		...
		if (VALA_IS_NAMESPACE (_tmp58_)) {
			...
			_tmp59_ = ns;
			_tmp60_ = _result_;
			vala_symbol_add_namespace ((ValaSymbol*) _tmp59_, VALA_NAMESPACE (_tmp60_));
		} else {
...
static void vala_genie_parser_parse_struct_member (ValaGenieParser* self, ValaStruct* st, GError** error) {
	...
	if (VALA_IS_METHOD (sym)) {
		ValaStruct* _tmp1_;
		_tmp1_ = st;
		vala_symbol_add_method ((ValaSymbol*) _tmp1_, VALA_METHOD (sym));
	} else {
		if (VALA_IS_FIELD (sym)) {
			ValaStruct* _tmp2_;
			_tmp2_ = st;
			vala_symbol_add_field ((ValaSymbol*) _tmp2_, VALA_FIELD (sym));
		} else {
			if (VALA_IS_CONSTANT (sym)) {
				ValaStruct* _tmp3_;
				_tmp3_ = st;
				vala_symbol_add_constant ((ValaSymbol*) _tmp3_, VALA_CONSTANT (sym));
			} else {
				ValaSourceReference* _tmp4_;
				ValaSourceReference* _tmp5_;
				_tmp4_ = vala_code_node_get_source_reference ((ValaCodeNode*) sym);
				_tmp5_ = _tmp4_;
				vala_report_error (_tmp5_, "unexpected declaration in struct");
			}
		}
	}
	_vala_code_node_unref0 (sym);
...
static ValaSymbol* vala_genie_parser_parse_interface_declaration (ValaGenieParser* self, ValaList* attrs, GError** error) {
	...
	while (TRUE) {
		...
		if (VALA_IS_NAMESPACE (_tmp83_)) {
			...
			_tmp84_ = ns;
			_tmp85_ = _result_;
			vala_symbol_add_namespace ((ValaSymbol*) _tmp84_, VALA_NAMESPACE (_tmp85_));
		} else {
			ValaNamespace* _tmp86_;
			ValaSymbol* _tmp87_;
			_tmp86_ = ns;
			_tmp87_ = _result_;
			vala_symbol_add_interface ((ValaSymbol*) _tmp86_, VALA_INTERFACE (_tmp87_));
		}
		_tmp88_ = ns;
...
static ValaSymbol* vala_genie_parser_parse_enum_declaration (ValaGenieParser* self, ValaList* attrs, GError** error) {
	...
	while (TRUE) {
		...
		_tmp31_ = vala_genie_parser_parse_attributes (self, FALSE, &_inner_error_);
		value_attrs = _tmp31_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
		...
		vala_genie_parser_get_location (self, &_tmp32_);
		value_begin = _tmp32_;
		_tmp33_ = vala_genie_parser_parse_identifier (self, &_inner_error_);
		id = _tmp33_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
		...
		_tmp34_ = self->priv->scanner;
		_tmp35_ = vala_genie_scanner_pop_comment (_tmp34_);
		_vala_comment_unref0 (self->priv->comment);
		self->priv->comment = _tmp35_;
		value = NULL;
		_tmp36_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_ASSIGN);
		if (_tmp36_) {
			ValaExpression* _tmp37_ = NULL;
			ValaExpression* _tmp38_;
			_tmp37_ = vala_genie_parser_parse_expression (self, &_inner_error_);
			_tmp38_ = _tmp37_;
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == VALA_PARSE_ERROR) {
					g_propagate_error (error, _inner_error_);
		...
		_tmp45_ = vala_enum_value_new (_tmp39_, _tmp40_, _tmp43_, _tmp44_);
		_tmp46_ = _tmp45_;
		_vala_source_reference_unref0 (_tmp43_);
		ev = _tmp46_;
		_tmp47_ = ev;
		vala_symbol_set_access ((ValaSymbol*) _tmp47_, VALA_SYMBOL_ACCESSIBILITY_PUBLIC);
		_tmp48_ = ev;
		_tmp49_ = value_attrs;
		vala_genie_parser_set_attributes (self, (ValaCodeNode*) _tmp48_, _tmp49_);
		_tmp50_ = en;
		_tmp51_ = ev;
		vala_enum_add_value (_tmp50_, _tmp51_);
		vala_genie_parser_expect (self, VALA_GENIE_TOKEN_TYPE_EOL, &_inner_error_);
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
	...
	while (TRUE) {
		...
		if (VALA_IS_NAMESPACE (_tmp68_)) {
			...
			_tmp69_ = ns;
			_tmp70_ = _result_;
			vala_symbol_add_namespace ((ValaSymbol*) _tmp69_, VALA_NAMESPACE (_tmp70_));
		} else {
			ValaNamespace* _tmp71_;
			ValaSymbol* _tmp72_;
			_tmp71_ = ns;
			_tmp72_ = _result_;
			vala_symbol_add_enum ((ValaSymbol*) _tmp71_, VALA_ENUM (_tmp72_));
		}
		_tmp73_ = ns;
...
static ValaSymbol* vala_genie_parser_parse_errordomain_declaration (ValaGenieParser* self, ValaList* attrs, GError** error) {
	...
	while (TRUE) {
		...
		_tmp21_ = vala_genie_parser_current (self);
		if (_tmp21_ == VALA_GENIE_TOKEN_TYPE_DEDENT) {
			break;
		}
		_tmp22_ = vala_genie_parser_parse_attributes (self, FALSE, &_inner_error_);
		code_attrs = _tmp22_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
		...
		vala_genie_parser_get_location (self, &_tmp23_);
		code_begin = _tmp23_;
		_tmp24_ = vala_genie_parser_parse_identifier (self, &_inner_error_);
		id = _tmp24_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
		...
		_tmp25_ = self->priv->scanner;
		_tmp26_ = vala_genie_scanner_pop_comment (_tmp25_);
		_vala_comment_unref0 (self->priv->comment);
		self->priv->comment = _tmp26_;
		_tmp27_ = id;
		_tmp28_ = code_begin;
		_tmp29_ = vala_genie_parser_get_src (self, &_tmp28_);
		_tmp30_ = _tmp29_;
		_tmp31_ = self->priv->comment;
		_tmp32_ = vala_error_code_new (_tmp27_, _tmp30_, _tmp31_);
		_tmp33_ = _tmp32_;
		_vala_source_reference_unref0 (_tmp30_);
		ec = _tmp33_;
		_tmp34_ = ec;
		_tmp35_ = code_attrs;
		vala_genie_parser_set_attributes (self, (ValaCodeNode*) _tmp34_, _tmp35_);
		_tmp36_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_ASSIGN);
		if (_tmp36_) {
			ValaExpression* _tmp37_ = NULL;
			ValaExpression* _tmp38_;
			...
			_tmp39_ = ec;
			_tmp40_ = _tmp38_;
			vala_error_code_set_value (_tmp39_, _tmp40_);
	...
	while (TRUE) {
		...
		if (VALA_IS_NAMESPACE (_tmp59_)) {
			...
			_tmp60_ = ns;
			_tmp61_ = _result_;
			vala_symbol_add_namespace ((ValaSymbol*) _tmp60_, VALA_NAMESPACE (_tmp61_));
		} else {
			ValaNamespace* _tmp62_;
			ValaSymbol* _tmp63_;
			_tmp62_ = ns;
			_tmp63_ = _result_;
			vala_symbol_add_error_domain ((ValaSymbol*) _tmp62_, VALA_ERROR_DOMAIN (_tmp63_));
		}
		_tmp64_ = ns;
...
static ValaParameter* vala_genie_parser_parse_parameter (ValaGenieParser* self, GError** error) {
	...
	if (_tmp12_ == VALA_PARAMETER_DIRECTION_IN) {
		ValaDataType* _tmp13_ = NULL;
		ValaDataType* _tmp14_;
		_tmp13_ = vala_genie_parser_parse_type (self, FALSE, &_inner_error_);
		_tmp14_ = _tmp13_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
		...
		ValaDataType* _tmp16_;
		_tmp15_ = vala_genie_parser_parse_type (self, TRUE, &_inner_error_);
		_tmp16_ = _tmp15_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
	...
	_tmp26_ = param;
	_tmp27_ = direction;
	vala_parameter_set_direction (_tmp26_, _tmp27_);
	_tmp28_ = param;
	_tmp29_ = params_array;
	vala_parameter_set_params_array (_tmp28_, _tmp29_);
	_tmp30_ = vala_genie_parser_accept (self, VALA_GENIE_TOKEN_TYPE_ASSIGN);
	if (_tmp30_) {
		ValaExpression* _tmp31_ = NULL;
		ValaExpression* _tmp32_;
		ValaParameter* _tmp33_;
		ValaExpression* _tmp34_;
		_tmp31_ = vala_genie_parser_parse_expression (self, &_inner_error_);
		_tmp32_ = _tmp31_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
		...
		_tmp33_ = param;
		_tmp34_ = _tmp32_;
		vala_variable_set_initializer ((ValaVariable*) _tmp33_, _tmp34_);
		_vala_code_node_unref0 (_tmp34_);
	}
	result = param;
	_vala_code_node_unref0 (type);
	...
	if (_tmp53_) {
		{
			...
			while (TRUE) {
				...
				_tmp54_ = FALSE;
				_tmp57_ = vala_genie_parser_parse_type (self, TRUE, &_inner_error_);
				_tmp58_ = _tmp57_;
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == VALA_PARSE_ERROR) {
						g_propagate_error (error, _inner_error_);
...
static ValaSymbol* vala_genie_parser_parse_delegate_declaration (ValaGenieParser* self, ValaList* attrs, GError** error) {
	...
	if (_tmp18_) {
		...
		_tmp19_ = vala_genie_parser_parse_type (self, TRUE, &_inner_error_);
		_tmp20_ = _tmp19_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_PARSE_ERROR) {
				g_propagate_error (error, _inner_error_);
	...
	if (_tmp32_) {
		{
			...
			while (TRUE) {
				...
				_tmp33_ = FALSE;
				_tmp36_ = vala_genie_parser_parse_type (self, TRUE, &_inner_error_);
				_tmp37_ = _tmp36_;
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == VALA_PARSE_ERROR) {
						g_propagate_error (error, _inner_error_);
	...
	while (TRUE) {
		...
		if (VALA_IS_NAMESPACE (_tmp102_)) {
			...
			_tmp103_ = ns;
			_tmp104_ = _result_;
			vala_symbol_add_namespace ((ValaSymbol*) _tmp103_, VALA_NAMESPACE (_tmp104_));
		} else {
			ValaNamespace* _tmp105_;
			ValaSymbol* _tmp106_;
			_tmp105_ = ns;
			_tmp106_ = _result_;
			vala_symbol_add_delegate ((ValaSymbol*) _tmp105_, VALA_DELEGATE (_tmp106_));
		}
		_tmp107_ = ns;

...
static gboolean vala_pointer_indirection_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	_tmp17_ = _tmp16_;
	if (VALA_IS_POINTER_TYPE (_tmp17_)) {
		...
		_tmp21_ = _tmp20_;
		_tmp22_ = _vala_code_node_ref0 (VALA_POINTER_TYPE (_tmp21_));
		pointer_type = _tmp22_;
		_tmp24_ = pointer_type;
		_tmp25_ = vala_pointer_type_get_base_type (_tmp24_);
		_tmp26_ = _tmp25_;
		if (VALA_IS_REFERENCE_TYPE (_tmp26_)) {
			_tmp23_ = TRUE;
		} else {
			...
			_tmp29_ = _tmp28_;
			_tmp23_ = VALA_IS_VOID_TYPE (_tmp29_);
		}
		_tmp30_ = _tmp23_;
		if (_tmp30_) {

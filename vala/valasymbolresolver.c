...
static void vala_symbol_resolver_real_visit_class (ValaCodeVisitor* base, ValaClass* cl) {
	...
	vala_class_set_base_class (_tmp5_, NULL);
	{
		...
		while (TRUE) {
			...
			if (VALA_IS_CLASS (_tmp19_)) {
				...
				_tmp45_ = _tmp44_;
				vala_class_set_base_class (_tmp42_, VALA_CLASS (_tmp45_));
				_tmp46_ = cl;
	...
	_tmp66_ = vala_code_context_get_profile (_tmp65_);
	_tmp67_ = _tmp66_;
	if (_tmp67_ == VALA_PROFILE_DOVA) {
		...
		if (_tmp70_ == NULL) {
			...
			ValaClass* _tmp75_;
			ValaClass* _tmp76_;
			_tmp71_ = self->priv->root_symbol;
			_tmp72_ = vala_symbol_get_scope (_tmp71_);
			_tmp73_ = _tmp72_;
			_tmp74_ = vala_scope_lookup (_tmp73_, "any");
			any_class = VALA_CLASS (_tmp74_);
			_tmp75_ = cl;
			_tmp76_ = any_class;
			if (_tmp75_ != _tmp76_) {
				ValaSymbol* _tmp77_;
				...
				ValaClass* _tmp90_;
				ValaClass* _tmp91_;
				_tmp77_ = self->priv->root_symbol;
				_tmp78_ = vala_symbol_get_scope (_tmp77_);
				_tmp79_ = _tmp78_;
				_tmp80_ = vala_scope_lookup (_tmp79_, "Dova");
				_tmp81_ = _tmp80_;
				_tmp82_ = vala_symbol_get_scope (_tmp81_);
				_tmp83_ = _tmp82_;
				_tmp84_ = vala_scope_lookup (_tmp83_, "Object");
				_tmp85_ = VALA_CLASS (_tmp84_);
				_vala_code_node_unref0 (_tmp81_);
				object_class = _tmp85_;
				_tmp86_ = cl;
				_tmp87_ = object_class;
				_tmp88_ = vala_object_type_new ((ValaObjectTypeSymbol*) _tmp87_);
				_tmp89_ = _tmp88_;
				vala_class_add_base_type (_tmp86_, (ValaDataType*) _tmp89_);
				_vala_code_node_unref0 (_tmp89_);
				_tmp90_ = cl;
				_tmp91_ = object_class;
				vala_class_set_base_class (_tmp90_, _tmp91_);
				_vala_code_node_unref0 (object_class);
			}
			_vala_code_node_unref0 (any_class);
		}
	}
	_tmp92_ = self->priv->current_scope;
	_tmp93_ = vala_scope_get_parent_scope (_tmp92_);
	_tmp94_ = _tmp93_;
	_tmp95_ = _vala_scope_ref0 (_tmp94_);
	_vala_scope_unref0 (self->priv->current_scope);
	self->priv->current_scope = _tmp95_;
}
...
static void vala_symbol_resolver_real_visit_interface (ValaCodeVisitor* base, ValaInterface* iface) {
	...
	if (_tmp42_ == VALA_PROFILE_DOVA) {
		...
		gboolean _tmp48_;
		_tmp43_ = iface;
		_tmp44_ = vala_interface_get_prerequisites (_tmp43_);
		_tmp45_ = _tmp44_;
		...
		if (_tmp48_) {
			...
			_tmp49_ = self->priv->root_symbol;
			_tmp50_ = vala_symbol_get_scope (_tmp49_);
			_tmp51_ = _tmp50_;
			_tmp52_ = vala_scope_lookup (_tmp51_, "Dova");
			_tmp53_ = _tmp52_;
			_tmp54_ = vala_symbol_get_scope (_tmp53_);
			_tmp55_ = _tmp54_;
			_tmp56_ = vala_scope_lookup (_tmp55_, "Object");
			_tmp57_ = VALA_CLASS (_tmp56_);
			_vala_code_node_unref0 (_tmp53_);
			object_class = _tmp57_;
			_tmp58_ = iface;
			_tmp59_ = object_class;
			_tmp60_ = vala_object_type_new ((ValaObjectTypeSymbol*) _tmp59_);
			_tmp61_ = _tmp60_;
			vala_interface_add_prerequisite (_tmp58_, (ValaDataType*) _tmp61_);
...
static void vala_symbol_resolver_real_visit_using_directive (ValaCodeVisitor* base, ValaUsingDirective* ns) {
	...
	_tmp2_ = _tmp1_;
	_tmp3_ = _vala_code_node_ref0 (VALA_IS_UNRESOLVED_SYMBOL (_tmp2_) ? ((ValaUnresolvedSymbol*) _tmp2_) : NULL);
	...
	if (_tmp2_) {
		...
		if (_tmp12_ == NULL) {
			...
			while (TRUE) {
				...
				sym = _tmp23_;
				_tmp26_ = sym;
				if (VALA_IS_NAMESPACE (_tmp26_)) {
					_tmp25_ = TRUE;
				} else {
					ValaSymbol* _tmp27_;
					_tmp27_ = sym;
					_tmp25_ = VALA_IS_TYPESYMBOL (_tmp27_);
				}
				_tmp28_ = _tmp25_;
				if (_tmp28_) {
					_tmp24_ = TRUE;
					...
					ValaSymbol* _tmp29_;
					_tmp29_ = sym;
					_tmp24_ = VALA_IS_TYPEPARAMETER (_tmp29_);
				}
				_tmp30_ = _tmp24_;
				if (!_tmp30_) {
					_vala_code_node_unref0 (sym);
			...
			if (_tmp40_) {
				{
					...
					while (TRUE) {
						...
						if (_tmp59_) {
							...
							_tmp62_ = _tmp61_;
							_tmp56_ = VALA_IS_UNRESOLVED_SYMBOL (_tmp62_);
						}
						_tmp63_ = _tmp56_;
						if (_tmp63_) {
						...
						local_sym = _tmp72_;
						_tmp75_ = local_sym;
						if (VALA_IS_NAMESPACE (_tmp75_)) {
							_tmp74_ = TRUE;
						} else {
							ValaSymbol* _tmp76_;
							_tmp76_ = local_sym;
							_tmp74_ = VALA_IS_TYPESYMBOL (_tmp76_);
						}
						_tmp77_ = _tmp74_;
						if (_tmp77_) {
							_tmp73_ = TRUE;
							...
							ValaSymbol* _tmp78_;
							_tmp78_ = sym;
							_tmp73_ = VALA_IS_TYPEPARAMETER (_tmp78_);
						}
						_tmp79_ = _tmp73_;
						if (!_tmp79_) {
...
static ValaDataType* vala_symbol_resolver_resolve_type (ValaSymbolResolver* self, ValaUnresolvedType* unresolved_type) {
	...
	_tmp27_ = sym;
	if (VALA_IS_TYPEPARAMETER (_tmp27_)) {
		ValaSymbol* _tmp28_;
		ValaGenericType* _tmp29_;
		_tmp28_ = sym;
		_tmp29_ = vala_generic_type_new (VALA_TYPEPARAMETER (_tmp28_));
		_vala_code_node_unref0 (type);
		type = (ValaDataType*) _tmp29_;
	} else {
		ValaSymbol* _tmp30_;
		_tmp30_ = sym;
		if (VALA_IS_TYPESYMBOL (_tmp30_)) {
			ValaSymbol* _tmp31_;
			_tmp31_ = sym;
			if (VALA_IS_DELEGATE (_tmp31_)) {
				ValaSymbol* _tmp32_;
				ValaDelegateType* _tmp33_;
				_tmp32_ = sym;
				_tmp33_ = vala_delegate_type_new (VALA_DELEGATE (_tmp32_));
				_vala_code_node_unref0 (type);
				...
				if (VALA_IS_CLASS (_tmp34_)) {
					...
					gboolean _tmp39_;
					_tmp35_ = sym;
					_tmp36_ = _vala_code_node_ref0 (VALA_CLASS (_tmp35_));
					cl = _tmp36_;
					_tmp37_ = cl;
					...
					if (VALA_IS_INTERFACE (_tmp46_)) {
						...
						_tmp47_ = sym;
						_tmp48_ = vala_object_type_new ((ValaObjectTypeSymbol*) VALA_INTERFACE (_tmp47_));
						_vala_code_node_unref0 (type);
						...
						if (VALA_IS_STRUCT (_tmp49_)) {
							...
							_tmp50_ = sym;
							_tmp51_ = sym;
							_tmp52_ = vala_symbol_resolver_get_type_for_struct (self, VALA_STRUCT (_tmp50_), VALA_STRUCT (_tmp51_));
							_vala_code_node_unref0 (type);
							type = _tmp52_;
						} else {
							ValaSymbol* _tmp53_;
							_tmp53_ = sym;
							if (VALA_IS_ENUM (_tmp53_)) {
								ValaSymbol* _tmp54_;
								ValaEnumValueType* _tmp55_;
								_tmp54_ = sym;
								_tmp55_ = vala_enum_value_type_new (VALA_ENUM (_tmp54_));
								_vala_code_node_unref0 (type);
								...
								if (VALA_IS_ERROR_DOMAIN (_tmp56_)) {
									...
									_tmp60_ = _tmp59_;
									_tmp61_ = vala_error_type_new (VALA_ERROR_DOMAIN (_tmp57_), NULL, _tmp60_);
									_vala_code_node_unref0 (type);
									type = (ValaDataType*) _tmp61_;
								} else {
									ValaSymbol* _tmp62_;
									_tmp62_ = sym;
									if (VALA_IS_ERROR_CODE (_tmp62_)) {
										ValaSymbol* _tmp63_;
										ValaSymbol* _tmp64_;
										ValaSymbol* _tmp65_;
										ValaSymbol* _tmp66_;
										...
										_tmp69_ = _tmp68_;
										_tmp70_ = vala_error_type_new (VALA_ERROR_DOMAIN (_tmp65_), VALA_ERROR_CODE (_tmp66_), _tmp69_);
										_vala_code_node_unref0 (type);
	...
	_tmp98_ = type;
	if (VALA_IS_GENERIC_TYPE (_tmp98_)) {
...
static void vala_symbol_resolver_real_visit_data_type (ValaCodeVisitor* base, ValaDataType* data_type) {
	...
	_tmp2_ = data_type;
	_tmp3_ = _vala_code_node_ref0 (VALA_UNRESOLVED_TYPE (_tmp2_));
...
static void vala_symbol_resolver_real_visit_local_variable (ValaCodeVisitor* base, ValaLocalVariable* local) {
	...
	if (!_tmp3_) {
		...
		_tmp6_ = _tmp5_;
		if (VALA_IS_REFERENCE_TYPE (_tmp6_)) {

...
static void vala_postfix_expression_real_get_defined_variables (ValaCodeNode* base, ValaCollection* collection) {
	...
	_tmp11_ = _tmp10_;
	_tmp12_ = _vala_code_node_ref0 (VALA_IS_PARAMETER (_tmp11_) ? ((ValaParameter*) _tmp11_) : NULL);
	param = _tmp12_;
	_tmp13_ = local;
	if (_tmp13_ != NULL) {
...
static gboolean vala_postfix_expression_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	_tmp15_ = _tmp14_;
	if (!VALA_IS_INTEGER_TYPE (_tmp15_)) {
		...
		_tmp19_ = _tmp18_;
		_tmp11_ = !VALA_IS_FLOATING_TYPE (_tmp19_);
	} else {
		_tmp11_ = FALSE;
	}
	_tmp20_ = _tmp11_;
	if (_tmp20_) {
		...
		_tmp24_ = _tmp23_;
		_tmp10_ = !VALA_IS_POINTER_TYPE (_tmp24_);
	} else {
		_tmp10_ = FALSE;
	}
	_tmp25_ = _tmp10_;
	...
	_tmp29_ = _tmp28_;
	if (VALA_IS_MEMBER_ACCESS (_tmp29_)) {
		...
		_tmp31_ = _tmp30_;
		_tmp32_ = _vala_code_node_ref0 (VALA_MEMBER_ACCESS (_tmp31_));
		ma = _tmp32_;
		_tmp33_ = ma;
		...
		_tmp54_ = _tmp53_;
		if (VALA_IS_ELEMENT_ACCESS (_tmp54_)) {
			...
			_tmp56_ = _tmp55_;
			_tmp57_ = _vala_code_node_ref0 (VALA_ELEMENT_ACCESS (_tmp56_));
			ea = _tmp57_;
			_tmp58_ = ea;
	...
	_tmp68_ = _tmp67_;
	if (VALA_IS_MEMBER_ACCESS (_tmp68_)) {
		...
		_tmp70_ = _tmp69_;
		_tmp71_ = _vala_code_node_ref0 (VALA_MEMBER_ACCESS (_tmp70_));
		ma = _tmp71_;
		_tmp72_ = ma;
		_tmp73_ = vala_expression_get_symbol_reference ((ValaExpression*) _tmp72_);
		_tmp74_ = _tmp73_;
		if (VALA_IS_PROPERTY (_tmp74_)) {
			...
			_tmp77_ = _tmp76_;
			_tmp78_ = _vala_code_node_ref0 (VALA_PROPERTY (_tmp77_));
			prop = _tmp78_;
			_tmp80_ = prop;

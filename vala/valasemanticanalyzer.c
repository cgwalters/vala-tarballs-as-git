...
void vala_semantic_analyzer_analyze (ValaSemanticAnalyzer* self, ValaCodeContext* context) {
	...
	_tmp31_ = _tmp30_;
	if (_tmp31_ != VALA_PROFILE_DOVA) {
		ValaSymbol* _tmp32_;
		ValaScope* _tmp33_;
		ValaScope* _tmp34_;
		ValaSymbol* _tmp35_ = NULL;
		ValaStruct* _tmp36_;
		ValaIntegerType* _tmp37_;
		ValaSymbol* _tmp38_;
		ValaScope* _tmp39_;
		ValaScope* _tmp40_;
		...
		ValaStruct* _tmp48_;
		ValaIntegerType* _tmp49_;
		ValaSymbol* _tmp50_;
		ValaScope* _tmp51_;
		ValaScope* _tmp52_;
		ValaSymbol* _tmp53_ = NULL;
		ValaStruct* _tmp54_;
		ValaIntegerType* _tmp55_;
		ValaSymbol* _tmp56_;
		ValaScope* _tmp57_;
		ValaScope* _tmp58_;
		...
		ValaStruct* _tmp66_;
		ValaIntegerType* _tmp67_;
		ValaSymbol* _tmp68_;
		ValaScope* _tmp69_;
		ValaScope* _tmp70_;
		ValaSymbol* _tmp71_ = NULL;
		ValaStruct* _tmp72_;
		ValaIntegerType* _tmp73_;
		ValaSymbol* _tmp74_;
		ValaScope* _tmp75_;
		ValaScope* _tmp76_;
		ValaSymbol* _tmp77_ = NULL;
		ValaStruct* _tmp78_;
		ValaIntegerType* _tmp79_;
		ValaSymbol* _tmp80_;
		ValaScope* _tmp81_;
		ValaScope* _tmp82_;
		ValaSymbol* _tmp83_ = NULL;
		ValaStruct* _tmp84_;
		ValaFloatingType* _tmp85_;
		_tmp32_ = self->root_symbol;
		_tmp33_ = vala_symbol_get_scope (_tmp32_);
		_tmp34_ = _tmp33_;
		_tmp35_ = vala_scope_lookup (_tmp34_, "uchar");
		_tmp36_ = VALA_STRUCT (_tmp35_);
		_tmp37_ = vala_integer_type_new (_tmp36_, NULL, NULL);
		_vala_code_node_unref0 (self->uchar_type);
		self->uchar_type = (ValaDataType*) _tmp37_;
		_vala_code_node_unref0 (_tmp36_);
		_tmp38_ = self->root_symbol;
		_tmp39_ = vala_symbol_get_scope (_tmp38_);
		_tmp40_ = _tmp39_;
		_tmp41_ = vala_scope_lookup (_tmp40_, "int8");
		_tmp42_ = VALA_STRUCT (_tmp41_);
		_tmp43_ = vala_integer_type_new (_tmp42_, NULL, NULL);
		_vala_code_node_unref0 (self->int8_type);
		self->int8_type = (ValaDataType*) _tmp43_;
		_vala_code_node_unref0 (_tmp42_);
		_tmp44_ = self->root_symbol;
		_tmp45_ = vala_symbol_get_scope (_tmp44_);
		_tmp46_ = _tmp45_;
		_tmp47_ = vala_scope_lookup (_tmp46_, "short");
		_tmp48_ = VALA_STRUCT (_tmp47_);
		_tmp49_ = vala_integer_type_new (_tmp48_, NULL, NULL);
		_vala_code_node_unref0 (self->short_type);
		self->short_type = (ValaDataType*) _tmp49_;
		_vala_code_node_unref0 (_tmp48_);
		_tmp50_ = self->root_symbol;
		_tmp51_ = vala_symbol_get_scope (_tmp50_);
		_tmp52_ = _tmp51_;
		_tmp53_ = vala_scope_lookup (_tmp52_, "ushort");
		_tmp54_ = VALA_STRUCT (_tmp53_);
		_tmp55_ = vala_integer_type_new (_tmp54_, NULL, NULL);
		_vala_code_node_unref0 (self->ushort_type);
		self->ushort_type = (ValaDataType*) _tmp55_;
		_vala_code_node_unref0 (_tmp54_);
		_tmp56_ = self->root_symbol;
		_tmp57_ = vala_symbol_get_scope (_tmp56_);
		_tmp58_ = _tmp57_;
		_tmp59_ = vala_scope_lookup (_tmp58_, "long");
		_tmp60_ = VALA_STRUCT (_tmp59_);
		_tmp61_ = vala_integer_type_new (_tmp60_, NULL, NULL);
		_vala_code_node_unref0 (self->long_type);
		self->long_type = (ValaDataType*) _tmp61_;
		_vala_code_node_unref0 (_tmp60_);
		_tmp62_ = self->root_symbol;
		_tmp63_ = vala_symbol_get_scope (_tmp62_);
		_tmp64_ = _tmp63_;
		_tmp65_ = vala_scope_lookup (_tmp64_, "ulong");
		_tmp66_ = VALA_STRUCT (_tmp65_);
		_tmp67_ = vala_integer_type_new (_tmp66_, NULL, NULL);
		_vala_code_node_unref0 (self->ulong_type);
		self->ulong_type = (ValaDataType*) _tmp67_;
		_vala_code_node_unref0 (_tmp66_);
		_tmp68_ = self->root_symbol;
		_tmp69_ = vala_symbol_get_scope (_tmp68_);
		_tmp70_ = _tmp69_;
		_tmp71_ = vala_scope_lookup (_tmp70_, "size_t");
		_tmp72_ = VALA_STRUCT (_tmp71_);
		_tmp73_ = vala_integer_type_new (_tmp72_, NULL, NULL);
		_vala_code_node_unref0 (self->size_t_type);
		self->size_t_type = (ValaDataType*) _tmp73_;
		_vala_code_node_unref0 (_tmp72_);
		_tmp74_ = self->root_symbol;
		_tmp75_ = vala_symbol_get_scope (_tmp74_);
		_tmp76_ = _tmp75_;
		_tmp77_ = vala_scope_lookup (_tmp76_, "ssize_t");
		_tmp78_ = VALA_STRUCT (_tmp77_);
		_tmp79_ = vala_integer_type_new (_tmp78_, NULL, NULL);
		_vala_code_node_unref0 (self->ssize_t_type);
		self->ssize_t_type = (ValaDataType*) _tmp79_;
		_vala_code_node_unref0 (_tmp78_);
		_tmp80_ = self->root_symbol;
		_tmp81_ = vala_symbol_get_scope (_tmp80_);
		_tmp82_ = _tmp81_;
		_tmp83_ = vala_scope_lookup (_tmp82_, "double");
		_tmp84_ = VALA_STRUCT (_tmp83_);
		_tmp85_ = vala_floating_type_new (_tmp84_);
		_vala_code_node_unref0 (self->double_type);
		self->double_type = (ValaDataType*) _tmp85_;
		...
		_tmp86_ = self->int_type;
		_tmp87_ = _vala_code_node_ref0 (_tmp86_);
		_vala_code_node_unref0 (self->long_type);
		self->long_type = _tmp87_;
		_tmp88_ = self->uint_type;
		_tmp89_ = _vala_code_node_ref0 (_tmp88_);
		_vala_code_node_unref0 (self->ulong_type);
		self->ulong_type = _tmp89_;
		_tmp90_ = self->uint_type;
		_tmp91_ = _vala_code_node_ref0 (_tmp90_);
		_vala_code_node_unref0 (self->size_t_type);
		self->size_t_type = _tmp91_;
		_tmp92_ = self->int_type;
		_tmp93_ = _vala_code_node_ref0 (_tmp92_);
		_vala_code_node_unref0 (self->ssize_t_type);
		self->ssize_t_type = _tmp93_;
	}
	_tmp94_ = self->root_symbol;
	_tmp95_ = vala_symbol_get_scope (_tmp94_);
	_tmp96_ = _tmp95_;
	_tmp97_ = vala_scope_lookup (_tmp96_, "unichar");
	unichar_struct = VALA_STRUCT (_tmp97_);
	_tmp98_ = unichar_struct;
	if (_tmp98_ != NULL) {
		ValaStruct* _tmp99_;
		ValaIntegerType* _tmp100_;
		_tmp99_ = unichar_struct;
		_tmp100_ = vala_integer_type_new (_tmp99_, NULL, NULL);
		_vala_code_node_unref0 (self->unichar_type);
		self->unichar_type = (ValaDataType*) _tmp100_;
	}
	_tmp101_ = context;
	_tmp102_ = vala_code_context_get_profile (_tmp101_);
	_tmp103_ = _tmp102_;
	if (_tmp103_ == VALA_PROFILE_GOBJECT) {
		ValaSymbol* _tmp104_;
		ValaScope* _tmp105_;
		ValaScope* _tmp106_;
		...
		ValaClass* _tmp128_;
		ValaObjectType* _tmp129_;
		ValaSymbol* _tmp130_;
		ValaScope* _tmp131_;
		ValaScope* _tmp132_;
		ValaSymbol* _tmp133_ = NULL;
		ValaClass* _tmp134_;
		ValaObjectType* _tmp135_;
		ValaSymbol* _tmp136_;
		ValaScope* _tmp137_;
		ValaScope* _tmp138_;
		...
		_tmp104_ = self->root_symbol;
		_tmp105_ = vala_symbol_get_scope (_tmp104_);
		_tmp106_ = _tmp105_;
		_tmp107_ = vala_scope_lookup (_tmp106_, "GLib");
		glib_ns = _tmp107_;
		_tmp108_ = glib_ns;
		_tmp109_ = vala_symbol_get_scope (_tmp108_);
		_tmp110_ = _tmp109_;
		_tmp111_ = vala_scope_lookup (_tmp110_, "Object");
		_vala_code_node_unref0 (self->object_type);
		self->object_type = VALA_CLASS (_tmp111_);
		_tmp112_ = glib_ns;
		_tmp113_ = vala_symbol_get_scope (_tmp112_);
		_tmp114_ = _tmp113_;
		_tmp115_ = vala_scope_lookup (_tmp114_, "Type");
		_tmp116_ = VALA_STRUCT (_tmp115_);
		_tmp117_ = vala_integer_type_new (_tmp116_, NULL, NULL);
		_vala_code_node_unref0 (self->type_type);
		self->type_type = (ValaDataType*) _tmp117_;
		_vala_code_node_unref0 (_tmp116_);
		_tmp118_ = glib_ns;
		_tmp119_ = vala_symbol_get_scope (_tmp118_);
		_tmp120_ = _tmp119_;
		_tmp121_ = vala_scope_lookup (_tmp120_, "Value");
		_tmp122_ = VALA_STRUCT (_tmp121_);
		_tmp123_ = vala_struct_value_type_new (_tmp122_);
		_vala_code_node_unref0 (self->gvalue_type);
		self->gvalue_type = _tmp123_;
		_vala_code_node_unref0 (_tmp122_);
		_tmp124_ = glib_ns;
		_tmp125_ = vala_symbol_get_scope (_tmp124_);
		_tmp126_ = _tmp125_;
		_tmp127_ = vala_scope_lookup (_tmp126_, "Variant");
		_tmp128_ = VALA_CLASS (_tmp127_);
		_tmp129_ = vala_object_type_new ((ValaObjectTypeSymbol*) _tmp128_);
		_vala_code_node_unref0 (self->gvariant_type);
		self->gvariant_type = _tmp129_;
		_vala_code_node_unref0 (_tmp128_);
		_tmp130_ = glib_ns;
		_tmp131_ = vala_symbol_get_scope (_tmp130_);
		_tmp132_ = _tmp131_;
		_tmp133_ = vala_scope_lookup (_tmp132_, "List");
		_tmp134_ = VALA_CLASS (_tmp133_);
		_tmp135_ = vala_object_type_new ((ValaObjectTypeSymbol*) _tmp134_);
		_vala_code_node_unref0 (self->glist_type);
		self->glist_type = (ValaDataType*) _tmp135_;
		_vala_code_node_unref0 (_tmp134_);
		_tmp136_ = glib_ns;
		_tmp137_ = vala_symbol_get_scope (_tmp136_);
		_tmp138_ = _tmp137_;
		_tmp139_ = vala_scope_lookup (_tmp138_, "SList");
		_tmp140_ = VALA_CLASS (_tmp139_);
		_tmp141_ = vala_object_type_new ((ValaObjectTypeSymbol*) _tmp140_);
		_vala_code_node_unref0 (self->gslist_type);
		self->gslist_type = (ValaDataType*) _tmp141_;
		_vala_code_node_unref0 (_tmp140_);
		_tmp142_ = glib_ns;
		_tmp143_ = vala_symbol_get_scope (_tmp142_);
		_tmp144_ = _tmp143_;
		_tmp145_ = vala_scope_lookup (_tmp144_, "Array");
		_tmp146_ = VALA_CLASS (_tmp145_);
		_tmp147_ = vala_object_type_new ((ValaObjectTypeSymbol*) _tmp146_);
		_vala_code_node_unref0 (self->garray_type);
		self->garray_type = (ValaDataType*) _tmp147_;
		_vala_code_node_unref0 (_tmp146_);
		_tmp148_ = glib_ns;
		_tmp149_ = vala_symbol_get_scope (_tmp148_);
		_tmp150_ = _tmp149_;
		_tmp151_ = vala_scope_lookup (_tmp150_, "ValueArray");
		_tmp152_ = VALA_CLASS (_tmp151_);
		_tmp153_ = vala_object_type_new ((ValaObjectTypeSymbol*) _tmp152_);
		_vala_code_node_unref0 (self->gvaluearray_type);
		self->gvaluearray_type = (ValaDataType*) _tmp153_;
		_vala_code_node_unref0 (_tmp152_);
		_tmp154_ = glib_ns;
		_tmp155_ = vala_symbol_get_scope (_tmp154_);
		_tmp156_ = _tmp155_;
		_tmp157_ = vala_scope_lookup (_tmp156_, "Error");
		_vala_code_node_unref0 (self->gerror_type);
		self->gerror_type = VALA_CLASS (_tmp157_);
		_tmp158_ = self->root_symbol;
		_tmp159_ = vala_symbol_get_scope (_tmp158_);
		_tmp160_ = _tmp159_;
		_tmp161_ = vala_scope_lookup (_tmp160_, "GLib");
		_tmp162_ = _tmp161_;
		_tmp163_ = vala_symbol_get_scope (_tmp162_);
		_tmp164_ = _tmp163_;
		_tmp165_ = vala_scope_lookup (_tmp164_, "Regex");
		_tmp166_ = VALA_CLASS (_tmp165_);
		_tmp167_ = vala_object_type_new ((ValaObjectTypeSymbol*) _tmp166_);
		_vala_code_node_unref0 (self->regex_type);
		self->regex_type = (ValaDataType*) _tmp167_;
		...
		if (_tmp170_ == VALA_PROFILE_DOVA) {
			...
			_tmp171_ = self->root_symbol;
			_tmp172_ = vala_symbol_get_scope (_tmp171_);
			_tmp173_ = _tmp172_;
			_tmp174_ = vala_scope_lookup (_tmp173_, "Dova");
			dova_ns = _tmp174_;
			_tmp175_ = dova_ns;
			_tmp176_ = vala_symbol_get_scope (_tmp175_);
			_tmp177_ = _tmp176_;
			_tmp178_ = vala_scope_lookup (_tmp177_, "Object");
			_vala_code_node_unref0 (self->object_type);
			self->object_type = VALA_CLASS (_tmp178_);
			_tmp179_ = dova_ns;
			_tmp180_ = vala_symbol_get_scope (_tmp179_);
			_tmp181_ = _tmp180_;
			_tmp182_ = vala_scope_lookup (_tmp181_, "Type");
			_tmp183_ = VALA_CLASS (_tmp182_);
			_tmp184_ = vala_object_type_new ((ValaObjectTypeSymbol*) _tmp183_);
			_vala_code_node_unref0 (self->type_type);
			self->type_type = (ValaDataType*) _tmp184_;
			_vala_code_node_unref0 (_tmp183_);
			_tmp185_ = dova_ns;
			_tmp186_ = vala_symbol_get_scope (_tmp185_);
			_tmp187_ = _tmp186_;
			_tmp188_ = vala_scope_lookup (_tmp187_, "List");
			_tmp189_ = VALA_CLASS (_tmp188_);
			_tmp190_ = vala_object_type_new ((ValaObjectTypeSymbol*) _tmp189_);
			_vala_code_node_unref0 (self->list_type);
			self->list_type = (ValaDataType*) _tmp190_;
			_vala_code_node_unref0 (_tmp189_);
			_tmp191_ = dova_ns;
			_tmp192_ = vala_symbol_get_scope (_tmp191_);
			_tmp193_ = _tmp192_;
			_tmp194_ = vala_scope_lookup (_tmp193_, "Tuple");
			_tmp195_ = VALA_CLASS (_tmp194_);
			_tmp196_ = vala_object_type_new ((ValaObjectTypeSymbol*) _tmp195_);
			_vala_code_node_unref0 (self->tuple_type);
			self->tuple_type = (ValaDataType*) _tmp196_;
			_vala_code_node_unref0 (_tmp195_);
			_tmp197_ = dova_ns;
			_tmp198_ = vala_symbol_get_scope (_tmp197_);
			_tmp199_ = _tmp198_;
			_tmp200_ = vala_scope_lookup (_tmp199_, "Error");
			_tmp201_ = VALA_CLASS (_tmp200_);
			_tmp202_ = vala_object_type_new ((ValaObjectTypeSymbol*) _tmp201_);
			_vala_code_node_unref0 (self->error_type);
			self->error_type = (ValaDataType*) _tmp202_;
			_vala_code_node_unref0 (_tmp201_);
			_vala_code_node_unref0 (dova_ns);
		}
	}
	_tmp203_ = self->root_symbol;
	vala_semantic_analyzer_set_current_symbol (self, _tmp203_);
	_tmp204_ = context;
	_tmp205_ = vala_code_context_get_root (_tmp204_);
	_tmp206_ = _tmp205_;
	_tmp207_ = context;
	vala_code_node_check ((ValaCodeNode*) _tmp206_, _tmp207_);
	_tmp208_ = context;
	vala_code_context_accept (_tmp208_, (ValaCodeVisitor*) self);
...
ValaDataType* vala_semantic_analyzer_get_value_type_for_symbol (ValaSemanticAnalyzer* self, ValaSymbol* sym, gboolean lvalue) {
	...
	if (VALA_IS_FIELD (_tmp0_)) {
		...
		gboolean _tmp7_;
		_tmp1_ = sym;
		_tmp2_ = _vala_code_node_ref0 (VALA_FIELD (_tmp1_));
		f = _tmp2_;
		_tmp3_ = f;
		...
		if (VALA_IS_ENUM_VALUE (_tmp9_)) {
			...
			_tmp12_ = _tmp11_;
			_tmp13_ = vala_enum_value_type_new (VALA_ENUM (_tmp12_));
			result = (ValaDataType*) _tmp13_;
			return result;
		} else {
			ValaSymbol* _tmp14_;
			_tmp14_ = sym;
			if (VALA_IS_CONSTANT (_tmp14_)) {
				ValaSymbol* _tmp15_;
				...
				_tmp15_ = sym;
				_tmp16_ = _vala_code_node_ref0 (VALA_CONSTANT (_tmp15_));
				c = _tmp16_;
				_tmp17_ = c;
				...
				ValaSymbol* _tmp21_;
				_tmp21_ = sym;
				if (VALA_IS_PROPERTY (_tmp21_)) {
					ValaSymbol* _tmp22_;
					ValaProperty* _tmp23_;
					ValaProperty* prop;
					gboolean _tmp24_;
					_tmp22_ = sym;
					_tmp23_ = _vala_code_node_ref0 (VALA_PROPERTY (_tmp22_));
					prop = _tmp23_;
					_tmp24_ = lvalue;
					if (_tmp24_) {
					...
					if (VALA_IS_PARAMETER (_tmp57_)) {
						...
						gboolean _tmp64_;
						_tmp58_ = sym;
						_tmp59_ = _vala_code_node_ref0 (VALA_PARAMETER (_tmp58_));
						p = _tmp59_;
						_tmp60_ = p;
						...
						ValaSymbol* _tmp66_;
						_tmp66_ = sym;
						if (VALA_IS_LOCAL_VARIABLE (_tmp66_)) {
							ValaSymbol* _tmp67_;
							...
							gboolean _tmp78_;
							_tmp67_ = sym;
							_tmp68_ = _vala_code_node_ref0 (VALA_LOCAL_VARIABLE (_tmp67_));
							local = _tmp68_;
							_tmp69_ = local;
							...
							if (VALA_IS_METHOD (_tmp80_)) {
								...
								_tmp81_ = sym;
								_tmp82_ = vala_method_type_new (VALA_METHOD (_tmp81_));
								result = (ValaDataType*) _tmp82_;
								return result;
							} else {
								ValaSymbol* _tmp83_;
								_tmp83_ = sym;
								if (VALA_IS_SIGNAL (_tmp83_)) {
									ValaSymbol* _tmp84_;
									ValaSignalType* _tmp85_;
									_tmp84_ = sym;
									_tmp85_ = vala_signal_type_new (VALA_SIGNAL (_tmp84_));
...
ValaSymbol* vala_semantic_analyzer_symbol_lookup_inherited (ValaSymbol* sym, const gchar* name) {
	...
	if (VALA_IS_CLASS (_tmp6_)) {
		...
		ValaClass* _tmp33_;
		_tmp7_ = sym;
		_tmp8_ = _vala_code_node_ref0 (VALA_CLASS (_tmp7_));
		cl = _tmp8_;
		{
			ValaClass* _tmp9_;
		...
		if (VALA_IS_STRUCT (_tmp39_)) {
			...
			_tmp40_ = sym;
			_tmp41_ = _vala_code_node_ref0 (VALA_STRUCT (_tmp40_));
			st = _tmp41_;
			_tmp42_ = st;
			...
			if (VALA_IS_INTERFACE (_tmp53_)) {
				...
				ValaInterface* iface;
				_tmp54_ = sym;
				_tmp55_ = _vala_code_node_ref0 (VALA_INTERFACE (_tmp54_));
				iface = _tmp55_;
				{
...
ValaDataType* vala_semantic_analyzer_get_data_type_for_symbol (ValaTypeSymbol* sym) {
	...
	if (VALA_IS_OBJECT_TYPE_SYMBOL (_tmp0_)) {
		...
		_tmp1_ = sym;
		_tmp2_ = vala_object_type_new (VALA_OBJECT_TYPE_SYMBOL (_tmp1_));
		_vala_code_node_unref0 (type);
		type = (ValaDataType*) _tmp2_;
		_tmp3_ = sym;
		_tmp4_ = vala_object_type_symbol_get_type_parameters (VALA_OBJECT_TYPE_SYMBOL (_tmp3_));
		...
		if (VALA_IS_STRUCT (_tmp5_)) {
			...
			ValaTypeSymbol* _tmp24_;
			_tmp24_ = sym;
			if (VALA_IS_ENUM (_tmp24_)) {
				ValaTypeSymbol* _tmp25_;
				ValaEnumValueType* _tmp26_;
				_tmp25_ = sym;
				_tmp26_ = vala_enum_value_type_new (VALA_ENUM (_tmp25_));
				_vala_code_node_unref0 (type);
				type = (ValaDataType*) _tmp26_;
			} else {
				ValaTypeSymbol* _tmp27_;
				_tmp27_ = sym;
				if (VALA_IS_ERROR_DOMAIN (_tmp27_)) {
					ValaTypeSymbol* _tmp28_;
					ValaErrorType* _tmp29_;
					_tmp28_ = sym;
					_tmp29_ = vala_error_type_new (VALA_ERROR_DOMAIN (_tmp28_), NULL, NULL);
					_vala_code_node_unref0 (type);
					type = (ValaDataType*) _tmp29_;
				} else {
					ValaTypeSymbol* _tmp30_;
					_tmp30_ = sym;
					if (VALA_IS_ERROR_CODE (_tmp30_)) {
						...
						_tmp33_ = _tmp32_;
						_tmp34_ = sym;
						_tmp35_ = vala_error_type_new (VALA_ERROR_DOMAIN (_tmp33_), VALA_ERROR_CODE (_tmp34_), NULL);
						_vala_code_node_unref0 (type);
...
gboolean vala_semantic_analyzer_check_arguments (ValaSemanticAnalyzer* self, ValaExpression* expr, ValaDataType* mtype, ValaList* params, ValaList* args) {
	...
	if (VALA_IS_METHOD_TYPE (_tmp3_)) {
		...
		_tmp4_ = mtype;
		_tmp5_ = vala_method_type_get_method_symbol (VALA_METHOD_TYPE (_tmp4_));
		_tmp6_ = _tmp5_;
		...
		while (TRUE) {
			...
			if (_tmp46_) {
				...
				if (_tmp49_ == NULL) {
					...
					_tmp51_ = mtype;
					_tmp52_ = _vala_code_node_ref0 (VALA_IS_METHOD_TYPE (_tmp51_) ? ((ValaMethodType*) _tmp51_) : NULL);
					m = _tmp52_;
					_tmp53_ = m;
					if (_tmp53_ != NULL) {
					...
					_tmp81_ = expr;
					_tmp82_ = _vala_code_node_ref0 (VALA_IS_METHOD_CALL (_tmp81_) ? ((ValaMethodCall*) _tmp81_) : NULL);
					invocation_expr = _tmp82_;
					_tmp83_ = expr;
					_tmp84_ = _vala_code_node_ref0 (VALA_IS_OBJECT_CREATION_EXPRESSION (_tmp83_) ? ((ValaObjectCreationExpression*) _tmp83_) : NULL);
	...
	if (_tmp107_) {
		while (TRUE) {
			...
			if (_tmp117_) {
				...
				_tmp121_ = _tmp120_;
				if (VALA_IS_SIGNAL_TYPE (_tmp121_)) {
		...
		if (_tmp176_) {
			...
			_tmp178_ = mtype;
			_tmp179_ = _vala_code_node_ref0 (VALA_IS_METHOD_TYPE (_tmp178_) ? ((ValaMethodType*) _tmp178_) : NULL);
			m = _tmp179_;
			_tmp180_ = m;
			if (_tmp180_ != NULL) {
	...
	if (_tmp211_) {
		...
		_tmp212_ = prev_arg;
		_tmp213_ = _vala_code_node_ref0 (VALA_IS_STRING_LITERAL (_tmp212_) ? ((ValaStringLiteral*) _tmp212_) : NULL);
		format_arg = _tmp213_;
		_tmp214_ = format_arg;
		if (_tmp214_ != NULL) {
			...
			_tmp227_ = _tmp226_;
			_tmp228_ = vala_source_reference_get_first_line (_tmp227_);
			_tmp229_ = _tmp228_;
			_tmp230_ = format_arg;
			_tmp231_ = vala_string_literal_get_value (_tmp230_);
			_tmp232_ = _tmp231_;
			_tmp233_ = string_substring (_tmp232_, (glong) 1, (glong) (-1));
			_tmp234_ = _tmp233_;
			_tmp235_ = g_strdup_printf ("\"%s:%d: %s", _tmp224_, _tmp229_, _tmp234_);
			_tmp236_ = _tmp235_;
			vala_string_literal_set_value (_tmp215_, _tmp236_);
			_g_free0 (_tmp236_);
			_g_free0 (_tmp234_);
			_g_free0 (_tmp224_);
		}
...
static gboolean vala_semantic_analyzer_check_argument (ValaSemanticAnalyzer* self, ValaExpression* arg, gint i, ValaParameterDirection direction) {
	...
	if (_tmp2_) {
		...
		_tmp3_ = arg;
		if (VALA_IS_NAMED_ARGUMENT (_tmp3_)) {
			...
			if (_tmp9_ == NULL) {
				...
				_tmp13_ = _tmp12_;
				if (!VALA_IS_DELEGATE_TYPE (_tmp13_)) {
					_tmp10_ = TRUE;
				} else {
					...
					_tmp16_ = _tmp15_;
					_tmp10_ = !VALA_IS_METHOD (_tmp16_);
				}
				_tmp17_ = _tmp10_;
				if (_tmp17_) {
				...
				if (_tmp41_) {
					...
					if (_tmp76_) {
						...
						_tmp77_ = arg;
						_tmp58_ = !VALA_IS_NULL_LITERAL (_tmp77_);
					} else {
						_tmp58_ = FALSE;
					}
					_tmp78_ = _tmp58_;
					if (_tmp78_) {
						...
						_tmp97_ = _tmp96_;
						if (VALA_IS_NULL_TYPE (_tmp97_)) {
							arg_type = 0;
						} else {
							ValaExpression* _tmp98_;
							_tmp98_ = arg;
							if (VALA_IS_UNARY_EXPRESSION (_tmp98_)) {
								...
								_tmp99_ = arg;
								_tmp100_ = _vala_code_node_ref0 (VALA_UNARY_EXPRESSION (_tmp99_));
								unary = _tmp100_;
								_tmp101_ = unary;
							...
							if (_tmp129_ == 1) {
								...
								if (_tmp137_ == 2) {
									...
									if (_tmp148_) {
										...
										_tmp152_ = _tmp151_;
										if (!VALA_IS_POINTER_TYPE (_tmp152_)) {
...
"eter", _tmp177_ + 1);
									...
									if (_tmp180_ == 3) {
										...
										if (_tmp191_) {
											...
											_tmp195_ = _tmp194_;
											if (!VALA_IS_POINTER_TYPE (_tmp195_)) {
	...
	_tmp205_ = arg;
	_tmp206_ = _vala_code_node_ref0 (VALA_IS_MEMBER_ACCESS (_tmp205_) ? ((ValaMemberAccess*) _tmp205_) : NULL);
	ma = _tmp206_;
	_tmp208_ = ma;
	if (_tmp208_ != NULL) {
	...
	if (_tmp212_) {
		...
		_tmp215_ = _tmp214_;
		_tmp216_ = _vala_code_node_ref0 (VALA_IS_DELEGATE_TYPE (_tmp215_) ? ((ValaDelegateType*) _tmp215_) : NULL);
		deleg_type = _tmp216_;
		_tmp218_ = deleg_type;
		if (_tmp218_ == NULL) {
			_tmp217_ = TRUE;
...
static ValaDataType* vala_semantic_analyzer_get_instance_base_type (ValaDataType* instance_type, ValaDataType* base_type, ValaCodeNode* node_reference) {
	...
	if (VALA_IS_CLASS (_tmp2_)) {
		...
		_tmp5_ = _tmp4_;
		_tmp6_ = vala_object_type_new ((ValaObjectTypeSymbol*) VALA_CLASS (_tmp5_));
		...
		_tmp9_ = _tmp8_;
		_tmp10_ = vala_object_type_new ((ValaObjectTypeSymbol*) VALA_INTERFACE (_tmp9_));
		_vala_code_node_unref0 (instance_base_type);
...
static ValaDataType* vala_semantic_analyzer_get_instance_base_type_for_member (ValaDataType* derived_instance_type, ValaTypeSymbol* type_symbol, ValaCodeNode* node_reference) {
	...
	while (TRUE) {
		...
		if (!VALA_IS_POINTER_TYPE (_tmp2_)) {
			break;
		}
		_tmp3_ = instance_type;
		_tmp4_ = _vala_code_node_ref0 (VALA_POINTER_TYPE (_tmp3_));
	...
	_tmp12_ = _tmp11_;
	_tmp13_ = _tmp12_ == VALA_PROFILE_DOVA;
	...
	if (_tmp13_) {
		while (TRUE) {
			...
			_tmp16_ = _vala_code_node_ref0 (VALA_ARRAY_TYPE (_tmp15_));
			instance_array_type = _tmp16_;
			...
			_tmp22_ = _tmp21_;
			_tmp23_ = vala_scope_lookup (_tmp22_, "Dova");
			_tmp24_ = _tmp23_;
			_tmp25_ = vala_symbol_get_scope (_tmp24_);
			_tmp26_ = _tmp25_;
			_tmp27_ = vala_scope_lookup (_tmp26_, "Array");
			_tmp28_ = VALA_CLASS (_tmp27_);
			_tmp29_ = vala_object_type_new ((ValaObjectTypeSymbol*) _tmp28_);
			_vala_code_node_unref0 (instance_type);
			instance_type = (ValaDataType*) _tmp29_;
			_vala_code_node_unref0 (_tmp28_);
			_vala_code_node_unref0 (_tmp24_);
			_vala_code_context_unref0 (_tmp18_);
			_tmp30_ = instance_type;
			_tmp31_ = instance_array_type;
			_tmp32_ = vala_array_type_get_element_type (_tmp31_);
			_tmp33_ = _tmp32_;
			vala_data_type_add_type_argument (_tmp30_, _tmp33_);
	...
	if (VALA_IS_DELEGATE_TYPE (_tmp35_)) {
		...
		_tmp36_ = instance_type;
		_tmp37_ = vala_delegate_type_get_delegate_symbol (VALA_DELEGATE_TYPE (_tmp36_));
		_tmp38_ = _tmp37_;
		_tmp39_ = type_symbol;
		_tmp34_ = VALA_TYPESYMBOL (_tmp38_) == _tmp39_;
	} else {
		_tmp34_ = FALSE;
	}
	_tmp40_ = _tmp34_;
	...
	if (VALA_IS_CLASS (_tmp47_)) {
		...
		_tmp48_ = instance_type;
		_tmp49_ = vala_data_type_get_data_type (_tmp48_);
		_tmp50_ = _tmp49_;
		_tmp51_ = _vala_code_node_ref0 (VALA_CLASS (_tmp50_));
		cl = _tmp51_;
		{
			ValaClass* _tmp52_;
			...
			gint _base_type_index;
			_tmp52_ = cl;
			_tmp53_ = vala_class_get_base_types (_tmp52_);
			...
			while (TRUE) {
				...
				if (VALA_IS_INTERFACE (_tmp65_)) {
					...
					_tmp67_ = base_type;
					_tmp68_ = node_reference;
					_tmp69_ = vala_semantic_analyzer_get_instance_base_type (_tmp66_, _tmp67_, _tmp68_);
					_tmp70_ = _tmp69_;
					_tmp71_ = type_symbol;
					_tmp72_ = node_reference;
					_tmp73_ = vala_semantic_analyzer_get_instance_base_type_for_member (_tmp70_, _tmp71_, _tmp72_);
					_vala_code_node_unref0 (instance_base_type);
		...
		if (_tmp75_ == NULL) {
			{
				...
				gint _base_type_index;
				_tmp76_ = cl;
				_tmp77_ = vala_class_get_base_types (_tmp76_);
				_base_type_list = _tmp77_;
				_tmp78_ = _base_type_list;
				_tmp79_ = vala_collection_get_size ((ValaCollection*) _tmp78_);
				_tmp80_ = _tmp79_;
				...
				while (TRUE) {
					...
					ValaTypeSymbol* _tmp88_;
					ValaTypeSymbol* _tmp89_;
					_tmp81_ = _base_type_index;
					_base_type_index = _tmp81_ + 1;
					_tmp82_ = _base_type_index;
					_tmp83_ = _base_type_size;
					if (!(_tmp82_ < _tmp83_)) {
						break;
					}
					_tmp84_ = _base_type_list;
					_tmp85_ = _base_type_index;
					_tmp86_ = vala_list_get (_tmp84_, _tmp85_);
					base_type = (ValaDataType*) _tmp86_;
					_tmp87_ = base_type;
					_tmp88_ = vala_data_type_get_data_type (_tmp87_);
					_tmp89_ = _tmp88_;
					if (VALA_IS_CLASS (_tmp89_)) {
						...
						_tmp90_ = instance_type;
						_tmp91_ = base_type;
						_tmp92_ = node_reference;
						_tmp93_ = vala_semantic_analyzer_get_instance_base_type (_tmp90_, _tmp91_, _tmp92_);
						_tmp94_ = _tmp93_;
						_tmp95_ = type_symbol;
						_tmp96_ = node_reference;
						_tmp97_ = vala_semantic_analyzer_get_instance_base_type_for_member (_tmp94_, _tmp95_, _tmp96_);
						_vala_code_node_unref0 (instance_base_type);
		...
		_tmp99_ = instance_type;
		_tmp100_ = vala_data_type_get_data_type (_tmp99_);
		_tmp101_ = _tmp100_;
		if (VALA_IS_STRUCT (_tmp101_)) {
			...
			_tmp102_ = instance_type;
			_tmp103_ = vala_data_type_get_data_type (_tmp102_);
			_tmp104_ = _tmp103_;
			_tmp105_ = _vala_code_node_ref0 (VALA_STRUCT (_tmp104_));
			st = _tmp105_;
			_tmp106_ = st;
			_tmp107_ = vala_struct_get_base_type (_tmp106_);
			_tmp108_ = _tmp107_;
			if (_tmp108_ != NULL) {
				...
				ValaDataType* _tmp119_;
				_tmp109_ = instance_type;
				_tmp110_ = st;
				_tmp111_ = vala_struct_get_base_type (_tmp110_);
				_tmp112_ = _tmp111_;
				_tmp113_ = node_reference;
				_tmp114_ = vala_semantic_analyzer_get_instance_base_type (_tmp109_, _tmp112_, _tmp113_);
				_tmp115_ = _tmp114_;
				_tmp116_ = type_symbol;
				_tmp117_ = node_reference;
				_tmp118_ = vala_semantic_analyzer_get_instance_base_type_for_member (_tmp115_, _tmp116_, _tmp117_);
				_vala_code_node_unref0 (instance_base_type);
				instance_base_type = _tmp118_;
				_vala_code_node_unref0 (_tmp115_);
				_tmp119_ = instance_base_type;
				if (_tmp119_ != NULL) {
					result = instance_base_type;
					_vala_code_node_unref0 (st);
					_vala_code_node_unref0 (instance_type);
			...
			_tmp120_ = instance_type;
			_tmp121_ = vala_data_type_get_data_type (_tmp120_);
			_tmp122_ = _tmp121_;
			if (VALA_IS_INTERFACE (_tmp122_)) {
				...
				_tmp123_ = instance_type;
				_tmp124_ = vala_data_type_get_data_type (_tmp123_);
				_tmp125_ = _tmp124_;
				_tmp126_ = _vala_code_node_ref0 (VALA_INTERFACE (_tmp125_));
				iface = _tmp126_;
				{
					...
					gint _prerequisite_index;
					_tmp127_ = iface;
					_tmp128_ = vala_interface_get_prerequisites (_tmp127_);
					_prerequisite_list = _tmp128_;
					_tmp129_ = _prerequisite_list;
					_tmp130_ = vala_collection_get_size ((ValaCollection*) _tmp129_);
					_tmp131_ = _tmp130_;
					_prerequisite_size = _tmp131_;
					_prerequisite_index = -1;
					while (TRUE) {
						gint _tmp132_;
						gint _tmp133_;
						...
						_prerequisite_index = _tmp132_ + 1;
						_tmp133_ = _prerequisite_index;
						_tmp134_ = _prerequisite_size;
						if (!(_tmp133_ < _tmp134_)) {
							break;
						}
						_tmp135_ = _prerequisite_list;
						_tmp136_ = _prerequisite_index;
						_tmp137_ = vala_list_get (_tmp135_, _tmp136_);
						prerequisite = (ValaDataType*) _tmp137_;
						_tmp138_ = prerequisite;
						...
						if (VALA_IS_INTERFACE (_tmp140_)) {
							...
							_tmp141_ = instance_type;
							_tmp142_ = prerequisite;
							_tmp143_ = node_reference;
							_tmp144_ = vala_semantic_analyzer_get_instance_base_type (_tmp141_, _tmp142_, _tmp143_);
							_tmp145_ = _tmp144_;
							_tmp146_ = type_symbol;
							_tmp147_ = node_reference;
							_tmp148_ = vala_semantic_analyzer_get_instance_base_type_for_member (_tmp145_, _tmp146_, _tmp147_);
							_vala_code_node_unref0 (instance_base_type);
							instance_base_type = _tmp148_;
							_vala_code_node_unref0 (_tmp145_);
							_tmp149_ = instance_base_type;
							if (_tmp149_ != NULL) {
								result = instance_base_type;
								_vala_code_node_unref0 (prerequisite);
								_vala_iterable_unref0 (_prerequisite_list);
				...
				if (_tmp150_ == NULL) {
					{
						...
						gint _prerequisite_index;
						_tmp151_ = iface;
						_tmp152_ = vala_interface_get_prerequisites (_tmp151_);
						_prerequisite_list = _tmp152_;
						_tmp153_ = _prerequisite_list;
						_tmp154_ = vala_collection_get_size ((ValaCollection*) _tmp153_);
						_tmp155_ = _tmp154_;
						_prerequisite_size = _tmp155_;
						_prerequisite_index = -1;
						while (TRUE) {
							gint _tmp156_;
							gint _tmp157_;
							...
							_tmp156_ = _prerequisite_index;
							_prerequisite_index = _tmp156_ + 1;
							_tmp157_ = _prerequisite_index;
							_tmp158_ = _prerequisite_size;
							if (!(_tmp157_ < _tmp158_)) {
								break;
							}
							_tmp159_ = _prerequisite_list;
							_tmp160_ = _prerequisite_index;
							_tmp161_ = vala_list_get (_tmp159_, _tmp160_);
							prerequisite = (ValaDataType*) _tmp161_;
							_tmp162_ = prerequisite;
							_tmp163_ = vala_data_type_get_data_type (_tmp162_);
							_tmp164_ = _tmp163_;
							if (VALA_IS_CLASS (_tmp164_)) {
								ValaDataType* _tmp165_;
								ValaDataType* _tmp166_;
								ValaCodeNode* _tmp167_;
								...
								_tmp165_ = instance_type;
								_tmp166_ = prerequisite;
								_tmp167_ = node_reference;
								_tmp168_ = vala_semantic_analyzer_get_instance_base_type (_tmp165_, _tmp166_, _tmp167_);
								_tmp169_ = _tmp168_;
								_tmp170_ = type_symbol;
								_tmp171_ = node_reference;
								_tmp172_ = vala_semantic_analyzer_get_instance_base_type_for_member (_tmp169_, _tmp170_, _tmp171_);
								_vala_code_node_unref0 (instance_base_type);
								instance_base_type = _tmp172_;
								_vala_code_node_unref0 (_tmp169_);
								_tmp173_ = instance_base_type;
								if (_tmp173_ != NULL) {
									result = instance_base_type;
									_vala_code_node_unref0 (prerequisite);
									_vala_iterable_unref0 (_prerequisite_list);
...
ValaDataType* vala_semantic_analyzer_get_actual_type (ValaDataType* derived_instance_type, ValaMemberAccess* method_access, ValaGenericType* generic_type, ValaCodeNode* node_reference) {
	...
	if (VALA_IS_TYPESYMBOL (_tmp4_)) {
		...
		if (_tmp5_ != NULL) {
			...
			_tmp13_ = vala_semantic_analyzer_get_instance_base_type_for_member (_tmp6_, VALA_TYPESYMBOL (_tmp11_), _tmp12_);
			...
			if (VALA_IS_DELEGATE_TYPE (_tmp15_)) {
				...
				_tmp17_ = vala_delegate_type_get_delegate_symbol (VALA_DELEGATE_TYPE (_tmp16_));
				_tmp18_ = _tmp17_;
			...
			if (_tmp52_) {
				...
				_vala_code_node_unref0 (actual_type);
				actual_type = VALA_DATA_TYPE ((ValaDataType*) _tmp57_);
		...
		_tmp62_ = _tmp61_;
		_tmp63_ = _vala_code_node_ref0 (VALA_METHOD (_tmp62_));
		m = _tmp63_;
		...
		if (_tmp92_) {
			...
			_vala_code_node_unref0 (actual_type);
			actual_type = VALA_DATA_TYPE ((ValaDataType*) _tmp97_);
	...
	while (TRUE) {
		...
		if (VALA_IS_CREATION_METHOD (_tmp3_)) {
			...
			if (VALA_IS_METHOD (_tmp4_)) {
				...
				_tmp5_ = sym;
				_tmp6_ = _vala_code_node_ref0 (VALA_METHOD (_tmp5_));
				m = _tmp6_;
				_tmp7_ = m;
				...
				if (VALA_IS_CONSTRUCTOR (_tmp10_)) {
					...
					_tmp11_ = sym;
					_tmp12_ = _vala_code_node_ref0 (VALA_CONSTRUCTOR (_tmp11_));
					c = _tmp12_;
					_tmp13_ = c;
					...
					if (VALA_IS_DESTRUCTOR (_tmp16_)) {
						...
						_tmp17_ = sym;
						_tmp18_ = _vala_code_node_ref0 (VALA_DESTRUCTOR (_tmp17_));
						d = _tmp18_;
						_tmp19_ = d;
...
void vala_semantic_analyzer_visit_member_initializer (ValaSemanticAnalyzer* self, ValaMemberInitializer* init, ValaDataType* type) {
	...
	if (VALA_IS_FIELD (_tmp12_)) {
		...
		_tmp15_ = _tmp14_;
		_tmp9_ = VALA_IS_PROPERTY (_tmp15_);
	}
	_tmp16_ = _tmp9_;
	if (!_tmp16_) {
	...
	if (VALA_IS_FIELD (_tmp49_)) {
		...
		_tmp52_ = _tmp51_;
		_tmp53_ = _vala_code_node_ref0 (VALA_FIELD (_tmp52_));
		f = _tmp53_;
		_tmp54_ = f;
...
static ValaStruct* vala_semantic_analyzer_get_arithmetic_struct (ValaSemanticAnalyzer* self, ValaDataType* type) {
	...
	if (_tmp5_ == NULL) {
		ValaDataType* _tmp6_;
		_tmp6_ = type;
		_tmp4_ = VALA_IS_ENUM_VALUE_TYPE (_tmp6_);
	} else {
		_tmp4_ = FALSE;
	}
	_tmp7_ = _tmp4_;
...
ValaMethod* vala_semantic_analyzer_get_current_async_method (ValaSemanticAnalyzer* self) {
	...
	while (TRUE) {
		...
		_tmp5_ = sym;
		_tmp6_ = _vala_code_node_ref0 (VALA_IS_METHOD (_tmp5_) ? ((ValaMethod*) _tmp5_) : NULL);
		m = _tmp6_;
		_tmp8_ = m;
		if (_tmp8_ != NULL) {
			ValaMethod* _tmp9_;
	...
	_tmp16_ = sym;
	result = VALA_IS_METHOD (_tmp16_) ? ((ValaMethod*) _tmp16_) : NULL;
	return result;
}

...
static ValaLocalVariable* vala_code_generator_real_create_local (ValaCodeGenerator* self, ValaDataType* type);
ValaTargetValue* vala_code_generator_load_local (ValaCodeGenerator* self, ValaLocalVariable* local);
static ValaTargetValue* vala_code_generator_real_load_local (ValaCodeGenerator* self, ValaLocalVariable* local);
...
static void vala_code_generator_real_store_local (ValaCodeGenerator* self, ValaLocalVariable* local, ValaTargetValue* value, gboolean initializer);
ValaTargetValue* vala_code_generator_load_parameter (ValaCodeGenerator* self, ValaParameter* param);
static ValaTargetValue* vala_code_generator_real_load_parameter (ValaCodeGenerator* self, ValaParameter* param);
void vala_code_generator_store_parameter (ValaCodeGenerator* self, ValaParameter* param, ValaTargetValue* value);
static void vala_code_generator_real_store_parameter (ValaCodeGenerator* self, ValaParameter* param, ValaTargetValue* value);
ValaTargetValue* vala_code_generator_load_field (ValaCodeGenerator* self, ValaField* field, ValaTargetValue* instance);
static ValaTargetValue* vala_code_generator_real_load_field (ValaCodeGenerator* self, ValaField* field, ValaTargetValue* instance);
...
static void vala_code_generator_real_store_field (ValaCodeGenerator* self, ValaField* field, ValaTargetValue* instance, ValaTargetValue* value);
...
static ValaLocalVariable* vala_code_generator_real_create_local (ValaCodeGenerator* self, ValaDataType* type) {
	g_critical ("Type `%s' does not implement abstract method `vala_code_generator_create_local'", g_type_name (G_TYPE_FROM_INSTANCE (self)));
	return NULL;
}
...
ValaLocalVariable* vala_code_generator_create_local (ValaCodeGenerator* self, ValaDataType* type) {
	...
	return VALA_CODE_GENERATOR_GET_CLASS (self)->create_local (self, type);
}
...
void vala_code_generator_store_local (ValaCodeGenerator* self, ValaLocalVariable* local, ValaTargetValue* value, gboolean initializer) {
	g_return_if_fail (self != NULL);
	VALA_CODE_GENERATOR_GET_CLASS (self)->store_local (self, local, value, initializer);
}
...
void vala_code_generator_store_parameter (ValaCodeGenerator* self, ValaParameter* param, ValaTargetValue* value) {
	g_return_if_fail (self != NULL);
	VALA_CODE_GENERATOR_GET_CLASS (self)->store_parameter (self, param, value);
}
...
void vala_code_generator_store_field (ValaCodeGenerator* self, ValaField* field, ValaTargetValue* instance, ValaTargetValue* value) {
	g_return_if_fail (self != NULL);
	VALA_CODE_GENERATOR_GET_CLASS (self)->store_field (self, field, instance, value);
}

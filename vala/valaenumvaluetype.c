...
static ValaDataType* vala_enum_value_type_real_copy (ValaDataType* base) {
	...
	_tmp1_ = _tmp0_;
	_tmp2_ = vala_enum_value_type_new (VALA_ENUM (_tmp1_));
	_result_ = _tmp2_;
...
static ValaSymbol* vala_enum_value_type_real_get_member (ValaDataType* base, const gchar* member_name) {
	...
	_tmp0_ = member_name;
	_tmp1_ = VALA_DATA_TYPE_CLASS (vala_enum_value_type_parent_class)->get_member ((ValaDataType*) VALA_VALUE_TYPE (self), _tmp0_);
	_result_ = _tmp1_;
	_tmp3_ = _result_;
	if (_tmp3_ == NULL) {
		const gchar* _tmp4_;

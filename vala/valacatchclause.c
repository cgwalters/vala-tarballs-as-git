...
static gboolean vala_catch_clause_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	if (_tmp5_ != NULL) {
		...
		_tmp29_ = _tmp28_;
		if (_tmp29_ == VALA_PROFILE_GOBJECT) {
			ValaSourceReference* _tmp30_;
			ValaSourceReference* _tmp31_;
			ValaErrorType* _tmp32_;
			ValaErrorType* _tmp33_;
			_tmp30_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
			_tmp31_ = _tmp30_;
			_tmp32_ = vala_error_type_new (NULL, NULL, _tmp31_);
			_tmp33_ = _tmp32_;
			vala_catch_clause_set_error_type (self, (ValaDataType*) _tmp33_);
			...
			_tmp36_ = _tmp35_;
			_tmp37_ = _tmp36_->error_type;
			vala_catch_clause_set_error_type (self, _tmp37_);
		}
	}
	_tmp38_ = vala_catch_clause_get_error_type (self);
	_tmp39_ = _tmp38_;
	_tmp40_ = context;
	vala_code_node_check ((ValaCodeNode*) _tmp39_, _tmp40_);
	_tmp41_ = vala_catch_clause_get_body (self);
	_tmp42_ = _tmp41_;
	_tmp43_ = context;

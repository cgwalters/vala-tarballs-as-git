	...
	if (!_tmp46_) {
		...
		if (_tmp48_ == NULL) {
			...
			if (_tmp83_ != NULL) {
				...
				_tmp88_ = _tmp87_;
				_tmp89_ = _vala_code_node_ref0 (VALA_IS_METHOD_TYPE (_tmp88_) ? ((ValaMethodType*) _tmp88_) : NULL);
				method_type = _tmp89_;
				_tmp91_ = method_type;
				if (_tmp91_ != NULL) {
				...
				if (_tmp97_) {
					...
					_tmp102_ = VALA_IS_STRING_LITERAL ((ValaExpression*) _tmp101_) ? ((ValaStringLiteral*) ((ValaExpression*) _tmp101_)) : NULL;

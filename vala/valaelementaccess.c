...
static gboolean vala_element_access_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	_tmp16_ = vala_element_access_get_container (self);
	_tmp17_ = _tmp16_;
	...
	container_type = _tmp22_;
	_tmp24_ = vala_element_access_get_container (self);
	_tmp25_ = _tmp24_;
	if (VALA_IS_MEMBER_ACCESS (_tmp25_)) {
		...
		ValaSymbol* _tmp28_;
		ValaSymbol* _tmp29_;
		_tmp26_ = vala_element_access_get_container (self);
		_tmp27_ = _tmp26_;
		_tmp28_ = vala_expression_get_symbol_reference (_tmp27_);
		_tmp29_ = _tmp28_;
		_tmp23_ = VALA_IS_SIGNAL (_tmp29_);
	} else {
		_tmp23_ = FALSE;
	}
	_tmp30_ = _tmp23_;
	if (_tmp30_) {
		...
		if (_tmp35_) {
			...
			_tmp37_ = _tmp36_;
			vala_report_error (_tmp37_, "Element access with more than one dimension is not supported for signa" \
"ls");
			result = FALSE;
			_vala_code_node_unref0 (container_type);
			return result;
		}
		_tmp38_ = vala_element_access_get_indices (self);
		_tmp39_ = _tmp38_;
		...
		_tmp44_ = _tmp43_;
		_tmp45_ = _tmp44_->string_type;
		_tmp46_ = vala_data_type_copy (_tmp45_);
		_tmp47_ = _tmp46_;
		vala_expression_set_target_type (_tmp41_, _tmp47_);
	...
	_tmp63_ = _tmp62_;
	_tmp64_ = _vala_code_node_ref0 (VALA_IS_POINTER_TYPE (_tmp63_) ? ((ValaPointerType*) _tmp63_) : NULL);
	pointer_type = _tmp64_;
	_tmp65_ = vala_element_access_get_container (self);
	_tmp66_ = _tmp65_;
	_tmp67_ = vala_expression_get_value_type (_tmp66_);
	_tmp68_ = _tmp67_;
	if (VALA_IS_ARRAY_TYPE (_tmp68_)) {
		...
		gint _tmp145_;
		gboolean _tmp146_;
		_tmp69_ = vala_element_access_get_container (self);
		_tmp70_ = _tmp69_;
		...
		array_type = _tmp73_;
		_tmp74_ = array_type;
		_tmp75_ = vala_array_type_get_element_type (_tmp74_);
		_tmp76_ = _tmp75_;
		...
		_tmp79_ = vala_expression_get_lvalue ((ValaExpression*) self);
		_tmp80_ = _tmp79_;
		if (!_tmp80_) {
			ValaDataType* _tmp81_;
			ValaDataType* _tmp82_;
			_tmp81_ = vala_expression_get_value_type ((ValaExpression*) self);
			_tmp82_ = _tmp81_;
			...
			gboolean _tmp92_;
			gboolean _tmp96_;
			_tmp83_ = vala_element_access_get_container (self);
			_tmp84_ = _tmp83_;
			_tmp85_ = _vala_code_node_ref0 (VALA_IS_MEMBER_ACCESS (_tmp84_) ? ((ValaMemberAccess*) _tmp84_) : NULL);
			ma = _tmp85_;
			_tmp88_ = context;
			_tmp89_ = vala_code_context_get_profile (_tmp88_);
			_tmp90_ = _tmp89_;
			if (_tmp90_ == VALA_PROFILE_GOBJECT) {
			...
			if (_tmp92_) {
				...
				ValaSymbol* _tmp95_;
				_tmp93_ = ma;
				_tmp94_ = vala_expression_get_symbol_reference ((ValaExpression*) _tmp93_);
				_tmp95_ = _tmp94_;
				_tmp86_ = VALA_IS_ARRAY_LENGTH_FIELD (_tmp95_);
			} else {
				_tmp86_ = FALSE;
			}
			_tmp96_ = _tmp86_;
			if (_tmp96_) {
				...
				_tmp99_ = _tmp98_;
				vala_expression_set_lvalue (_tmp99_, TRUE);
				_tmp100_ = ma;
				_tmp101_ = vala_member_access_get_inner (_tmp100_);
				_tmp102_ = _tmp101_;
				vala_member_access_check_lvalue_access (VALA_MEMBER_ACCESS (_tmp102_));
			} else {
				...
				if (_tmp108_ != NULL) {
					...
					ValaSymbol* _tmp111_;
					_tmp109_ = ma;
					_tmp110_ = vala_expression_get_symbol_reference ((ValaExpression*) _tmp109_);
					_tmp111_ = _tmp110_;
					_tmp107_ = VALA_IS_FIELD (_tmp111_);
				} else {
					_tmp107_ = FALSE;
				}
				_tmp112_ = _tmp107_;
				...
				if (_tmp116_) {
					...
					_tmp121_ = _tmp120_;
					_tmp105_ = VALA_IS_VARIABLE (_tmp121_);
				} else {
					_tmp105_ = FALSE;
				}
				_tmp122_ = _tmp105_;
				if (_tmp122_) {
					...
					_tmp127_ = _tmp126_;
					_tmp104_ = VALA_IS_STRUCT_VALUE_TYPE (_tmp127_);
				} else {
					_tmp104_ = FALSE;
				}
				_tmp128_ = _tmp104_;
				...
				if (_tmp136_) {
					...
					_tmp137_ = ma;
					vala_expression_set_lvalue ((ValaExpression*) _tmp137_, TRUE);
					_tmp138_ = ma;
					vala_member_access_check_lvalue_access (_tmp138_);
				}
			}
		...
		if (_tmp146_) {
			...
			_tmp155_ = _tmp154_;
			_tmp156_ = g_strdup_printf ("%d extra indices for element access", _tmp152_ - _tmp155_);
			_tmp157_ = _tmp156_;
			...
			_tmp160_ = _tmp159_;
			_tmp161_ = vala_element_access_get_indices (self);
			_tmp162_ = _tmp161_;
			_tmp163_ = vala_collection_get_size ((ValaCollection*) _tmp162_);
			_tmp164_ = _tmp163_;
			_tmp165_ = _tmp160_ > _tmp164_;
			...
			if (_tmp165_) {
				...
				_tmp170_ = _tmp169_;
				_tmp171_ = vala_element_access_get_indices (self);
				_tmp172_ = _tmp171_;
				_tmp173_ = vala_collection_get_size ((ValaCollection*) _tmp172_);
				_tmp174_ = _tmp173_;
				_tmp175_ = g_strdup_printf ("%d missing indices for element access", _tmp170_ - _tmp174_);
				_tmp176_ = _tmp175_;
				vala_report_error (_tmp167_, _tmp176_);
				_g_free0 (_tmp176_);
		...
		ValaPointerType* _tmp178_;
		gboolean _tmp183_;
		_tmp178_ = pointer_type;
		if (_tmp178_ != NULL) {
			ValaPointerType* _tmp179_;
			ValaDataType* _tmp180_;
			ValaDataType* _tmp181_;
			gboolean _tmp182_ = FALSE;
			_tmp179_ = pointer_type;
			_tmp180_ = vala_pointer_type_get_base_type (_tmp179_);
			_tmp181_ = _tmp180_;
			_tmp182_ = vala_data_type_is_reference_type_or_type_parameter (_tmp181_);
			_tmp177_ = !_tmp182_;
		} else {
			_tmp177_ = FALSE;
		}
		...
		if (_tmp183_) {
			...
			_tmp184_ = pointer_type;
			_tmp185_ = vala_pointer_type_get_base_type (_tmp184_);
			_tmp186_ = _tmp185_;
			_tmp187_ = vala_data_type_copy (_tmp186_);
			_tmp188_ = _tmp187_;
			vala_expression_set_value_type ((ValaExpression*) self, _tmp188_);
			...
			if (_tmp200_) {
				...
				if (_tmp205_) {
					...
					_tmp207_ = _tmp206_;
					vala_report_error (_tmp207_, "Element access with more than one dimension is not supported for tuple" \
"s");
					result = FALSE;
				...
				_tmp208_ = vala_element_access_get_indices (self);
				_tmp209_ = _tmp208_;
				_tmp210_ = vala_list_get (_tmp209_, 0);
				_tmp211_ = VALA_IS_INTEGER_LITERAL ((ValaExpression*) _tmp210_) ? ((ValaIntegerLiteral*) ((ValaExpression*) _tmp210_)) : NULL;
				...
				if (_tmp212_ == NULL) {
					...
					_tmp214_ = _tmp213_;
					vala_report_error (_tmp214_, "Element access with non-literal index is not supported for tuples");
					result = FALSE;
					_vala_code_node_unref0 (index);
					_vala_code_node_unref0 (pointer_type);
					_vala_code_node_unref0 (container_type);
				...
				_tmp215_ = index;
				_tmp216_ = vala_integer_literal_get_value (_tmp215_);
				_tmp217_ = _tmp216_;
				_tmp218_ = atoi (_tmp217_);
				i = _tmp218_;
				_tmp219_ = vala_element_access_get_container (self);
				_tmp220_ = _tmp219_;
				_tmp221_ = vala_expression_get_value_type (_tmp220_);
				_tmp222_ = _tmp221_;
				_tmp223_ = vala_data_type_get_type_arguments (_tmp222_);
				_tmp224_ = _tmp223_;
				...
				if (_tmp227_) {
					...
					_tmp229_ = _tmp228_;
					vala_report_error (_tmp229_, "Element access is not supported for untyped tuples");
					result = FALSE;
					_vala_code_node_unref0 (index);
					_vala_code_node_unref0 (pointer_type);
					_vala_code_node_unref0 (container_type);
				...
				if (_tmp231_ < 0) {
					...
					gint _tmp240_;
					_tmp232_ = i;
					_tmp233_ = vala_element_access_get_container (self);
					_tmp234_ = _tmp233_;
					_tmp235_ = vala_expression_get_value_type (_tmp234_);
					_tmp236_ = _tmp235_;
					_tmp237_ = vala_data_type_get_type_arguments (_tmp236_);
					_tmp238_ = _tmp237_;
					_tmp239_ = vala_collection_get_size ((ValaCollection*) _tmp238_);
					_tmp240_ = _tmp239_;
					_tmp230_ = _tmp232_ >= _tmp240_;
				...
				if (_tmp241_) {
					...
					_tmp243_ = _tmp242_;
					vala_report_error (_tmp243_, "Index out of range");
					result = FALSE;
					_vala_code_node_unref0 (index);
					_vala_code_node_unref0 (pointer_type);
					_vala_code_node_unref0 (container_type);
				...
				_tmp244_ = vala_element_access_get_container (self);
				_tmp245_ = _tmp244_;
				_tmp246_ = vala_expression_get_value_type (_tmp245_);
				_tmp247_ = _tmp246_;
				_tmp248_ = vala_data_type_get_type_arguments (_tmp247_);
				_tmp249_ = _tmp248_;
				_tmp250_ = i;
				...
				_tmp253_ = vala_element_access_get_container (self);
				_tmp254_ = _tmp253_;
				_tmp255_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
				_tmp256_ = _tmp255_;
				_tmp257_ = vala_member_access_new (_tmp254_, "get", _tmp256_);
				ma = _tmp257_;
				_tmp258_ = ma;
				_tmp259_ = vala_expression_get_value_type ((ValaExpression*) self);
				_tmp260_ = _tmp259_;
				vala_member_access_add_type_argument (_tmp258_, _tmp260_);
				_tmp261_ = ma;
				_tmp262_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
				_tmp263_ = _tmp262_;
				_tmp264_ = vala_method_call_new ((ValaExpression*) _tmp261_, _tmp263_);
				get_call = _tmp264_;
				_tmp265_ = get_call;
				_tmp266_ = index;
				vala_method_call_add_argument (_tmp265_, (ValaExpression*) _tmp266_);
				_tmp267_ = get_call;
				...
				_tmp270_ = vala_code_node_get_parent_node ((ValaCodeNode*) self);
				_tmp271_ = _tmp270_;
				_tmp272_ = get_call;
				vala_code_node_replace_expression (_tmp271_, (ValaExpression*) self, (ValaExpression*) _tmp272_);
				_tmp273_ = get_call;
				_tmp274_ = context;
				_tmp275_ = vala_code_node_check ((ValaCodeNode*) _tmp273_, _tmp274_);
				result = _tmp275_;
				...
				gboolean _tmp283_;
				_tmp277_ = vala_element_access_get_container (self);
				_tmp278_ = _tmp277_;
				if (VALA_IS_MEMBER_ACCESS (_tmp278_)) {
					...
					ValaSymbol* _tmp281_;
					ValaSymbol* _tmp282_;
					_tmp279_ = vala_element_access_get_container (self);
					_tmp280_ = _tmp279_;
					_tmp281_ = vala_expression_get_symbol_reference (_tmp280_);
					_tmp282_ = _tmp281_;
					_tmp276_ = VALA_IS_SIGNAL (_tmp282_);
				} else {
					_tmp276_ = FALSE;
				}
				_tmp283_ = _tmp276_;
				if (_tmp283_) {
					...
					_tmp284_ = vala_element_access_get_container (self);
					_tmp285_ = _tmp284_;
					_tmp286_ = vala_expression_get_symbol_reference (_tmp285_);
					_tmp287_ = _tmp286_;
					vala_expression_set_symbol_reference ((ValaExpression*) self, _tmp287_);
					_tmp288_ = vala_element_access_get_container (self);
					_tmp289_ = _tmp288_;
					_tmp290_ = vala_expression_get_value_type (_tmp289_);
					_tmp291_ = _tmp290_;
					vala_expression_set_value_type ((ValaExpression*) self, _tmp291_);
				} else {
					gboolean _tmp292_;
					gboolean _tmp293_;
					...
					gchar* _tmp361_ = NULL;
					gchar* _tmp362_;
					_tmp292_ = vala_expression_get_lvalue ((ValaExpression*) self);
					_tmp293_ = _tmp292_;
					if (_tmp293_) {
						...
						gboolean _tmp308_;
						gboolean _tmp310_;
						_tmp294_ = vala_element_access_get_container (self);
						_tmp295_ = _tmp294_;
						_tmp296_ = vala_expression_get_value_type (_tmp295_);
						_tmp297_ = _tmp296_;
						_tmp298_ = vala_data_type_get_member (_tmp297_, "set");
						set_method = VALA_IS_METHOD (_tmp298_) ? ((ValaMethod*) _tmp298_) : NULL;
						_tmp299_ = vala_code_node_get_parent_node ((ValaCodeNode*) self);
						_tmp300_ = _tmp299_;
						_tmp301_ = _vala_code_node_ref0 (VALA_IS_ASSIGNMENT (_tmp300_) ? ((ValaAssignment*) _tmp300_) : NULL);
						assignment = _tmp301_;
						_tmp304_ = set_method;
						if (_tmp304_ != NULL) {
							ValaMethod* _tmp305_;
							...
							_tmp305_ = set_method;
							_tmp306_ = vala_method_get_return_type (_tmp305_);
							_tmp307_ = _tmp306_;
							_tmp303_ = VALA_IS_VOID_TYPE (_tmp307_);
						} else {
							_tmp303_ = FALSE;
						}
						_tmp308_ = _tmp303_;
						if (_tmp308_) {
							ValaAssignment* _tmp309_;
							_tmp309_ = assignment;
							_tmp302_ = _tmp309_ != NULL;
						} else {
							_tmp302_ = FALSE;
						}
						_tmp310_ = _tmp302_;
						if (_tmp310_) {
							gboolean _tmp311_;
							gboolean _tmp312_;
							_tmp311_ = vala_code_node_get_error ((ValaCodeNode*) self);
							_tmp312_ = _tmp311_;
							result = !_tmp312_;
						...
						ValaMethod* _tmp318_;
						_tmp313_ = vala_element_access_get_container (self);
						_tmp314_ = _tmp313_;
						_tmp315_ = vala_expression_get_value_type (_tmp314_);
						_tmp316_ = _tmp315_;
						_tmp317_ = vala_data_type_get_member (_tmp316_, "get");
						get_method = VALA_IS_METHOD (_tmp317_) ? ((ValaMethod*) _tmp317_) : NULL;
						_tmp318_ = get_method;
						if (_tmp318_ != NULL) {
							...
							_tmp319_ = vala_element_access_get_container (self);
							_tmp320_ = _tmp319_;
							_tmp321_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
							_tmp322_ = _tmp321_;
							_tmp323_ = vala_member_access_new (_tmp320_, "get", _tmp322_);
							_tmp324_ = _tmp323_;
							_tmp325_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
							_tmp326_ = _tmp325_;
							_tmp327_ = vala_method_call_new ((ValaExpression*) _tmp324_, _tmp326_);
							_tmp328_ = _tmp327_;
							...
							get_call = _tmp328_;
							{
								...
								gint _e_size;
								gint _e_index;
								_tmp329_ = vala_element_access_get_indices (self);
								_e_list = _tmp329_;
								_tmp330_ = _e_list;
								...
								while (TRUE) {
									...
									_tmp336_ = _e_list;
									_tmp337_ = _e_index;
									_tmp338_ = vala_list_get (_tmp336_, _tmp337_);
									e = (ValaExpression*) _tmp338_;
									_tmp339_ = get_call;
									_tmp340_ = e;
									vala_method_call_add_argument (_tmp339_, _tmp340_);
									_vala_code_node_unref0 (e);
								}
								_vala_iterable_unref0 (_e_list);
							}
							_tmp341_ = get_call;
							_tmp342_ = vala_expression_get_formal_target_type ((ValaExpression*) self);
							_tmp343_ = _tmp342_;
							vala_expression_set_formal_target_type ((ValaExpression*) _tmp341_, _tmp343_);
							_tmp344_ = get_call;
							_tmp345_ = vala_expression_get_target_type ((ValaExpression*) self);
							_tmp346_ = _tmp345_;
							vala_expression_set_target_type ((ValaExpression*) _tmp344_, _tmp346_);
							_tmp347_ = vala_code_node_get_parent_node ((ValaCodeNode*) self);
							_tmp348_ = _tmp347_;
							_tmp349_ = get_call;
							vala_code_node_replace_expression (_tmp348_, (ValaExpression*) self, (ValaExpression*) _tmp349_);
							_tmp350_ = get_call;
							_tmp351_ = context;
							_tmp352_ = vala_code_node_check ((ValaCodeNode*) _tmp350_, _tmp351_);
							result = _tmp352_;
							_vala_code_node_unref0 (get_call);
					...
					_tmp354_ = _tmp353_;
					_tmp355_ = vala_element_access_get_container (self);
					_tmp356_ = _tmp355_;
					_tmp357_ = vala_expression_get_value_type (_tmp356_);
					_tmp358_ = _tmp357_;
					_tmp359_ = vala_code_node_to_string ((ValaCodeNode*) _tmp358_);
					_tmp360_ = _tmp359_;
					_tmp361_ = g_strdup_printf ("The expression `%s' does not denote an array", _tmp360_);
					_tmp362_ = _tmp361_;
	...
	_tmp363_ = index_int_type_check;
	if (_tmp363_) {
		{
			ValaList* _tmp364_ = NULL;
			ValaList* _e_list;
			ValaList* _tmp365_;
			gint _tmp366_;
			gint _tmp367_;
			gint _e_size;
			gint _e_index;
			_tmp364_ = vala_element_access_get_indices (self);
			_e_list = _tmp364_;
			_tmp365_ = _e_list;
			...
			while (TRUE) {
				...
				_tmp380_ = _tmp379_;
				if (VALA_IS_INTEGER_TYPE (_tmp380_)) {
					_tmp377_ = TRUE;
				} else {
					...
					_tmp383_ = _tmp382_;
					_tmp377_ = VALA_IS_ENUM_VALUE_TYPE (_tmp383_);
				}
				_tmp384_ = _tmp377_;
				if (!_tmp384_) {
					...
					vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
					_tmp385_ = e;
					_tmp386_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp385_);
					_tmp387_ = _tmp386_;
					vala_report_error (_tmp387_, "Expression of integer type expected");
				}
				_vala_code_node_unref0 (e);
			}
			_vala_iterable_unref0 (_e_list);

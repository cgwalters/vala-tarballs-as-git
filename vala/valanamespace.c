...
static void vala_namespace_real_add_namespace (ValaSymbol* base, ValaNamespace* ns) {
	...
	_tmp15_ = _tmp14_;
	_tmp16_ = VALA_IS_NAMESPACE (_tmp15_);
	...
	if (_tmp16_) {
		...
		ValaScope* _tmp194_;
		ValaScope* _tmp195_;
		ValaNamespace* _tmp196_;
		const gchar* _tmp197_;
		const gchar* _tmp198_;
		ValaNamespace* _tmp199_;
		_tmp192_ = self->priv->namespaces;
		_tmp193_ = ns;
		vala_collection_add ((ValaCollection*) _tmp192_, _tmp193_);
		_tmp194_ = vala_symbol_get_scope ((ValaSymbol*) self);
		_tmp195_ = _tmp194_;
		_tmp196_ = ns;
		_tmp197_ = vala_symbol_get_name ((ValaSymbol*) _tmp196_);
		_tmp198_ = _tmp197_;
		_tmp199_ = ns;
		vala_scope_add (_tmp195_, _tmp198_, (ValaSymbol*) _tmp199_);
	}
}
...
static void vala_namespace_real_add_method (ValaSymbol* base, ValaMethod* m) {
	...
	_tmp8_ = m;
	if (VALA_IS_CREATION_METHOD (_tmp8_)) {
		ValaMethod* _tmp9_;
	...
	if (!VALA_IS_VOID_TYPE (_tmp30_)) {
		...
		_tmp35_ = _tmp34_;
		_tmp36_ = _tmp35_ == VALA_PROFILE_DOVA;
	...
	if (_tmp43_) {
		...
		_tmp51_ = _tmp50_;
		_tmp52_ = vala_local_variable_new (_tmp49_, "result", NULL, _tmp51_);
		_tmp53_ = _tmp52_;
		vala_subroutine_set_result_var ((ValaSubroutine*) _tmp44_, _tmp53_);
		_vala_code_node_unref0 (_tmp53_);
		_vala_code_node_unref0 (_tmp49_);
		_tmp54_ = m;
		_tmp55_ = vala_subroutine_get_result_var ((ValaSubroutine*) _tmp54_);
		_tmp56_ = _tmp55_;
		vala_local_variable_set_is_result (_tmp56_, TRUE);
	}
	_tmp57_ = m;
	_tmp58_ = vala_symbol_get_owner ((ValaSymbol*) _tmp57_);
	_tmp59_ = _tmp58_;
	if (_tmp59_ == NULL) {
		ValaMethod* _tmp60_;
		...
		_tmp64_ = _tmp63_;
		_tmp65_ = m;
		vala_source_file_add_node (_tmp64_, (ValaCodeNode*) _tmp65_);
	}
	_tmp66_ = self->priv->methods;
	_tmp67_ = m;
	vala_collection_add ((ValaCollection*) _tmp66_, _tmp67_);
	_tmp68_ = vala_symbol_get_scope ((ValaSymbol*) self);
	_tmp69_ = _tmp68_;
	_tmp70_ = m;
	_tmp71_ = vala_symbol_get_name ((ValaSymbol*) _tmp70_);
	_tmp72_ = _tmp71_;
	_tmp73_ = m;
	vala_scope_add (_tmp69_, _tmp72_, (ValaSymbol*) _tmp73_);
}

...
static gboolean vala_switch_statement_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	if (_tmp12_ == NULL) {
		...
		_tmp18_ = _tmp17_;
		if (!VALA_IS_INTEGER_TYPE (_tmp18_)) {
			...
			_tmp22_ = _tmp21_;
			_tmp14_ = !VALA_IS_ENUM_VALUE_TYPE (_tmp22_);
		} else {
			_tmp14_ = FALSE;
		}
		_tmp23_ = _tmp14_;
			...
			vala_code_node_check ((ValaCodeNode*) _tmp65_, _tmp66_);
			{
				...
				while (TRUE) {
					...
					if (_tmp80_ != NULL) {
						...
						_tmp83_ = _tmp82_;
						if (VALA_IS_STRING_LITERAL (_tmp83_)) {
							...
							_tmp86_ = _tmp85_;
							_tmp87_ = vala_string_literal_eval (VALA_STRING_LITERAL (_tmp86_));
							_g_free0 (value);
							value = _tmp87_;
						} else {
							...
							if (VALA_IS_LITERAL (_tmp90_)) {
								...
								_tmp93_ = _tmp92_;
								_tmp94_ = vala_code_node_to_string ((ValaCodeNode*) VALA_LITERAL (_tmp93_));
								_g_free0 (value);
								value = _tmp94_;
							} else {

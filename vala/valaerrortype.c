...
static gboolean vala_error_type_real_compatible (ValaDataType* base, ValaDataType* target_type) {
	...
	_tmp3_ = target_type;
	_tmp4_ = _vala_code_node_ref0 (VALA_IS_ERROR_TYPE (_tmp3_) ? ((ValaErrorType*) _tmp3_) : NULL);
	et = _tmp4_;
	_tmp5_ = et;
	if (_tmp5_ == NULL) {
		result = FALSE;
...
static gboolean vala_error_type_real_equals (ValaDataType* base, ValaDataType* type2) {
	...
	_tmp0_ = type2;
	_tmp1_ = _vala_code_node_ref0 (VALA_IS_ERROR_TYPE (_tmp0_) ? ((ValaErrorType*) _tmp0_) : NULL);
	et = _tmp1_;
	_tmp2_ = et;
	if (_tmp2_ == NULL) {
		result = FALSE;

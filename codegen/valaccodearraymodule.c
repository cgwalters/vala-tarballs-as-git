	...
	g_return_if_fail (initializer_list != NULL);
	{
		...
		while (TRUE) {
			...
			if (_tmp11_ > 1) {
				...
				_tmp13_ = e;
				_tmp14_ = rank;
				vala_ccode_array_module_append_initializer_list (self, _tmp12_, VALA_INITIALIZER_LIST (_tmp13_), _tmp14_ - 1, i);
			} else {
...
static void vala_ccode_array_module_real_visit_array_creation_expression (ValaCodeVisitor* base, ValaArrayCreationExpression* expr) {
	...
	ValaProfile _tmp88_;
	ValaProfile _tmp89_;
	ValaArrayCreationExpression* _tmp104_;
	ValaDataType* _tmp105_;
	ValaDataType* _tmp106_;
	ValaArrayCreationExpression* _tmp107_;
	ValaLocalVariable* _tmp108_ = NULL;
	...
	ValaArrayCreationExpression* _tmp118_;
	ValaInitializerList* _tmp119_;
	ValaInitializerList* _tmp120_;
	ValaArrayCreationExpression* _tmp128_;
	...
	if (_tmp30_ == VALA_PROFILE_POSIX) {
		...
		vala_ccode_file_add_include (_tmp31_, "stdlib.h", FALSE);
		_tmp32_ = vala_ccode_identifier_new ("calloc");
		_tmp33_ = _tmp32_;
		...
		_tmp35_ = vala_ccode_identifier_new ("g_new0");
		_tmp36_ = _tmp35_;
		...
		_tmp38_ = gnew;
		_tmp39_ = expr;
		_tmp40_ = vala_array_creation_expression_get_element_type (_tmp39_);
		_tmp41_ = _tmp40_;
		_tmp42_ = vala_ccode_base_module_get_ccode_name ((ValaCodeNode*) _tmp41_);
		_tmp43_ = _tmp42_;
		_tmp44_ = vala_ccode_identifier_new (_tmp43_);
		_tmp45_ = _tmp44_;
		vala_ccode_function_call_add_argument (_tmp38_, (ValaCCodeExpression*) _tmp45_);
	...
	cexpr = NULL;
	{
		...
		gint _size_index;
		_tmp46_ = expr;
		_tmp47_ = vala_array_creation_expression_get_sizes (_tmp46_);
		_size_list = _tmp47_;
		_tmp48_ = _size_list;
		...
		while (TRUE) {
			...
			size = (ValaExpression*) _tmp56_;
			_tmp57_ = size;
			_tmp58_ = vala_ccode_base_module_get_cvalue ((ValaCCodeBaseModule*) self, _tmp57_);
			csize = _tmp58_;
			_tmp59_ = expr;
			_tmp60_ = csize;
			vala_ccode_base_module_append_array_length ((ValaCCodeBaseModule*) self, (ValaExpression*) _tmp59_, _tmp60_);
			_tmp61_ = first;
			if (_tmp61_) {
				ValaCCodeExpression* _tmp62_;
				ValaCCodeExpression* _tmp63_;
				_tmp62_ = csize;
				_tmp63_ = _vala_ccode_node_ref0 (_tmp62_);
				...
				_tmp64_ = cexpr;
				_tmp65_ = csize;
				_tmp66_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_MUL, _tmp64_, _tmp65_);
				_vala_ccode_node_unref0 (cexpr);
	...
	_tmp68_ = expr;
	_tmp69_ = vala_array_creation_expression_get_element_type (_tmp68_);
	_tmp70_ = _tmp69_;
	_tmp71_ = vala_data_type_get_data_type (_tmp70_);
	_tmp72_ = _tmp71_;
	if (_tmp72_ != NULL) {
		ValaArrayCreationExpression* _tmp73_;
		...
		_tmp73_ = expr;
		_tmp74_ = vala_array_creation_expression_get_element_type (_tmp73_);
		_tmp75_ = _tmp74_;
		_tmp76_ = vala_data_type_get_data_type (_tmp75_);
		_tmp77_ = _tmp76_;
		_tmp78_ = vala_typesymbol_is_reference_type (_tmp77_);
		_tmp67_ = _tmp78_;
	} else {
		_tmp67_ = FALSE;
	}
	...
	if (_tmp79_) {
		...
		_tmp80_ = cexpr;
		_tmp81_ = vala_ccode_constant_new ("1");
		_tmp82_ = _tmp81_;
		_tmp83_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_PLUS, _tmp80_, (ValaCCodeExpression*) _tmp82_);
		_vala_ccode_node_unref0 (cexpr);
	...
	if (_tmp89_ == VALA_PROFILE_POSIX) {
		...
		ValaArrayCreationExpression* _tmp95_;
		...
		_tmp90_ = vala_ccode_identifier_new ("sizeof");
		_tmp91_ = _tmp90_;
		...
		_tmp94_ = csizeof;
		_tmp95_ = expr;
		_tmp96_ = vala_array_creation_expression_get_element_type (_tmp95_);
		_tmp97_ = _tmp96_;
		_tmp98_ = vala_ccode_base_module_get_ccode_name ((ValaCodeNode*) _tmp97_);
		_tmp99_ = _tmp98_;
	...
	_tmp104_ = expr;
	_tmp105_ = vala_expression_get_value_type ((ValaExpression*) _tmp104_);
	_tmp106_ = _tmp105_;
	_tmp107_ = expr;
	_tmp108_ = vala_ccode_base_module_get_temp_variable ((ValaCCodeBaseModule*) self, _tmp106_, TRUE, (ValaCodeNode*) _tmp107_, TRUE);
	temp_var = _tmp108_;
	_tmp109_ = temp_var;
	...
	i = 0;
	_tmp113_ = temp_var;
	vala_ccode_base_module_emit_temp_var ((ValaCCodeBaseModule*) self, _tmp113_);
	_tmp114_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
	_tmp115_ = _tmp114_;
	_tmp116_ = name_cnode;
	_tmp117_ = gnew;
	vala_ccode_function_add_assignment (_tmp115_, _tmp116_, (ValaCCodeExpression*) _tmp117_);
	_tmp118_ = expr;
	_tmp119_ = vala_array_creation_expression_get_initializer_list (_tmp118_);
	_tmp120_ = _tmp119_;
	if (_tmp120_ != NULL) {
		ValaCCodeExpression* _tmp121_;
		ValaArrayCreationExpression* _tmp122_;
		ValaInitializerList* _tmp123_;
		ValaInitializerList* _tmp124_;
		ValaArrayCreationExpression* _tmp125_;
		gint _tmp126_;
		gint _tmp127_;
		_tmp121_ = name_cnode;
		_tmp122_ = expr;
		_tmp123_ = vala_array_creation_expression_get_initializer_list (_tmp122_);
		_tmp124_ = _tmp123_;
		_tmp125_ = expr;
		_tmp126_ = vala_array_creation_expression_get_rank (_tmp125_);
		_tmp127_ = _tmp126_;
		vala_ccode_array_module_append_initializer_list (self, _tmp121_, _tmp124_, _tmp127_, &i);
	}
	_tmp128_ = expr;
	_tmp129_ = name_cnode;
	vala_ccode_base_module_set_cvalue ((ValaCCodeBaseModule*) self, (ValaExpression*) _tmp128_, _tmp129_);
	_vala_ccode_node_unref0 (name_cnode);
	_vala_code_node_unref0 (temp_var);
	_vala_ccode_node_unref0 (cexpr);
	_vala_ccode_node_unref0 (gnew);
...
static ValaCCodeExpression* vala_ccode_array_module_real_get_array_length_cvalue (ValaCCodeBaseModule* base, ValaTargetValue* value, gint dim) {
	...
	_tmp39_ = value;
	_tmp40_ = VALA_GLIB_VALUE (_tmp39_)->array_length_cvalues;
...
static void vala_ccode_array_module_real_visit_element_access (ValaCodeVisitor* base, ValaElementAccess* expr) {
	...
	_tmp18_ = _tmp17_;
	if (VALA_IS_ARRAY_LENGTH_FIELD (_tmp18_)) {
		ValaList* _tmp19_;
		...
		lit = VALA_IS_INTEGER_LITERAL ((ValaExpression*) _tmp20_) ? ((ValaIntegerLiteral*) ((ValaExpression*) _tmp20_)) : NULL;
		_tmp21_ = expr;
	...
	_tmp90_ = _tmp89_;
	VALA_GLIB_VALUE (_tmp90_)->lvalue = TRUE;
	_vala_ccode_node_unref0 (cindex);
...
static void vala_ccode_array_module_real_append_vala_array_move (ValaCCodeBaseModule* base) {
	...
	src = _tmp18_;
	_tmp19_ = vala_ccode_identifier_new ("dest");
	dest = _tmp19_;
	_tmp20_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_MUL, (ValaCCodeExpression*) src, (ValaCCodeExpression*) element_size);
	_tmp21_ = _tmp20_;
	_tmp22_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_PLUS, (ValaCCodeExpression*) array, (ValaCCodeExpression*) _tmp21_);
	_tmp23_ = _tmp22_;
	_vala_ccode_node_unref0 (_tmp21_);
	src_address = _tmp23_;
	_tmp24_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_MUL, (ValaCCodeExpression*) dest, (ValaCCodeExpression*) element_size);
	_tmp25_ = _tmp24_;
	_tmp26_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_PLUS, (ValaCCodeExpression*) array, (ValaCCodeExpression*) _tmp25_);
	_tmp27_ = _tmp26_;
	_vala_ccode_node_unref0 (_tmp25_);
	dest_address = _tmp27_;
	_tmp28_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_PLUS, (ValaCCodeExpression*) dest, (ValaCCodeExpression*) length);
	_tmp29_ = _tmp28_;
	_tmp30_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_MUL, (ValaCCodeExpression*) _tmp29_, (ValaCCodeExpression*) element_size);
	_tmp31_ = _tmp30_;
	...
	_tmp45_ = _tmp44_;
	vala_ccode_function_open_if (_tmp43_, (ValaCCodeExpression*) _tmp45_);
	_vala_ccode_node_unref0 (_tmp45_);
	_tmp46_ = vala_ccode_identifier_new ("memset");
	_tmp47_ = _tmp46_;
	...
	_tmp51_ = _tmp50_;
	vala_ccode_function_call_add_argument (czero1, (ValaCCodeExpression*) _tmp51_);
	_vala_ccode_node_unref0 (_tmp51_);
	_tmp52_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_MINUS, (ValaCCodeExpression*) dest, (ValaCCodeExpression*) src);
	_tmp53_ = _tmp52_;
	_tmp54_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_MUL, (ValaCCodeExpression*) _tmp53_, (ValaCCodeExpression*) element_size);
	_tmp55_ = _tmp54_;
	...
	_tmp57_ = _tmp56_;
	vala_ccode_function_add_expression (_tmp57_, (ValaCCodeExpression*) czero1);
	_tmp58_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
	_tmp59_ = _tmp58_;
	vala_ccode_function_add_else (_tmp59_);
	_tmp60_ = vala_ccode_identifier_new ("memset");
	_tmp61_ = _tmp60_;
	...
	_tmp65_ = _tmp64_;
	vala_ccode_function_call_add_argument (czero2, (ValaCCodeExpression*) _tmp65_);
	_vala_ccode_node_unref0 (_tmp65_);
	_tmp66_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_MINUS, (ValaCCodeExpression*) src, (ValaCCodeExpression*) dest);
	_tmp67_ = _tmp66_;
	_tmp68_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_MUL, (ValaCCodeExpression*) _tmp67_, (ValaCCodeExpression*) element_size);
	_tmp69_ = _tmp68_;
	vala_ccode_function_call_add_argument (czero2, (ValaCCodeExpression*) _tmp69_);
	_vala_ccode_node_unref0 (_tmp69_);
	_vala_ccode_node_unref0 (_tmp67_);
	_tmp70_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
	_tmp71_ = _tmp70_;
	vala_ccode_function_add_expression (_tmp71_, (ValaCCodeExpression*) czero2);
	_tmp72_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
	_tmp73_ = _tmp72_;
	vala_ccode_function_close (_tmp73_);
	vala_ccode_base_module_pop_function ((ValaCCodeBaseModule*) self);
	_tmp74_ = ((ValaCCodeBaseModule*) self)->cfile;
	vala_ccode_file_add_function_declaration (_tmp74_, fun);
	_tmp75_ = ((ValaCCodeBaseModule*) self)->cfile;
	vala_ccode_file_add_function (_tmp75_, fun);
...
static ValaTargetValue* vala_ccode_array_module_real_copy_value (ValaCCodeBaseModule* base, ValaTargetValue* value, ValaCodeNode* node) {
	...
	if (VALA_IS_ARRAY_TYPE (_tmp6_)) {
		...
		_tmp7_ = type;
		_tmp8_ = _vala_code_node_ref0 (VALA_ARRAY_TYPE (_tmp7_));
		array_type = _tmp8_;
		_tmp9_ = array_type;
		...
		if (!_tmp11_) {
			...
			_tmp12_ = value;
			_tmp13_ = node;
			_tmp14_ = VALA_CCODE_BASE_MODULE_CLASS (vala_ccode_array_module_parent_class)->copy_value ((ValaCCodeBaseModule*) VALA_CCODE_METHOD_CALL_MODULE (self), _tmp12_, _tmp13_);
			result = _tmp14_;
			_vala_code_node_unref0 (array_type);
			_vala_ccode_node_unref0 (cexpr);
		...
		_tmp34_ = value;
		_tmp35_ = node;
		_tmp36_ = VALA_CCODE_BASE_MODULE_CLASS (vala_ccode_array_module_parent_class)->copy_value ((ValaCCodeBaseModule*) VALA_CCODE_METHOD_CALL_MODULE (self), _tmp34_, _tmp35_);
		result = _tmp36_;
		_vala_ccode_node_unref0 (cexpr);
		_vala_code_node_unref0 (type);
		return result;
...
static ValaCCodeExpression* vala_ccode_array_module_real_get_dup_func_expression (ValaCCodeBaseModule* base, ValaDataType* type, ValaSourceReference* source_reference, gboolean is_chainup) {
	...
	if (VALA_IS_ARRAY_TYPE (_tmp0_)) {
		...
		_tmp13_ = is_chainup;
		_tmp14_ = VALA_CCODE_BASE_MODULE_CLASS (vala_ccode_array_module_parent_class)->get_dup_func_expression ((ValaCCodeBaseModule*) VALA_CCODE_METHOD_CALL_MODULE (self), _tmp11_, _tmp12_, _tmp13_);
		result = _tmp14_;
		return result;
	}
}
...
static ValaCCodeExpression* vala_ccode_array_module_real_destroy_value (ValaCCodeBaseModule* base, ValaTargetValue* value, gboolean is_macro_definition) {
	...
	if (VALA_IS_ARRAY_TYPE (_tmp4_)) {
		...
		if (!_tmp9_) {
			...
			_tmp12_ = VALA_CCODE_BASE_MODULE_CLASS (vala_ccode_array_module_parent_class)->destroy_value ((ValaCCodeBaseModule*) VALA_CCODE_METHOD_CALL_MODULE (self), _tmp10_, _tmp11_);
			result = _tmp12_;
			_vala_code_node_unref0 (array_type);
			_vala_code_node_unref0 (type);
			return result;
		...
		_tmp43_ = VALA_CCODE_BASE_MODULE_CLASS (vala_ccode_array_module_parent_class)->destroy_value ((ValaCCodeBaseModule*) VALA_CCODE_METHOD_CALL_MODULE (self), _tmp41_, _tmp42_);
		result = _tmp43_;
		_vala_code_node_unref0 (type);
		return result;
	}
...
static gchar* vala_ccode_array_module_generate_array_dup_wrapper (ValaCCodeArrayModule* self, ValaArrayType* array_type) {
	...
	_tmp23_ = _tmp22_;
	if (VALA_IS_GENERIC_TYPE (_tmp23_)) {
...
static gboolean vala_ccode_array_module_is_array_add (ValaCCodeArrayModule* self, ValaAssignment* assignment) {
	...
	_tmp2_ = _tmp1_;
	_tmp3_ = _vala_code_node_ref0 (VALA_IS_BINARY_EXPRESSION (_tmp2_) ? ((ValaBinaryExpression*) _tmp2_) : NULL);
	binary = _tmp3_;
	_tmp5_ = binary;
	if (_tmp5_ != NULL) {
		...
		_tmp10_ = _tmp9_;
		_tmp4_ = VALA_IS_ARRAY_TYPE (_tmp10_);
	} else {
		_tmp4_ = FALSE;
	}
	_tmp11_ = _tmp4_;
...
static void vala_ccode_array_module_real_visit_assignment (ValaCodeVisitor* base, ValaAssignment* assignment) {
	...
	if (!_tmp1_) {
		...
		_tmp2_ = assignment;
		VALA_CODE_VISITOR_CLASS (vala_ccode_array_module_parent_class)->visit_assignment ((ValaCodeVisitor*) VALA_CCODE_METHOD_CALL_MODULE (self), _tmp2_);
		return;
	}
	_tmp3_ = assignment;
	_tmp4_ = vala_assignment_get_right (_tmp3_);
	_tmp5_ = _tmp4_;
	_tmp6_ = _vala_code_node_ref0 (VALA_BINARY_EXPRESSION (_tmp5_));
	binary = _tmp6_;
	_tmp7_ = assignment;
	...
	_tmp13_ = _tmp12_;
	_tmp14_ = _vala_code_node_ref0 (VALA_ARRAY_TYPE (_tmp13_));
	array_type = _tmp14_;
	_tmp15_ = binary;
	...
	if (_tmp33_) {
		...
		gboolean _tmp37_;
		_tmp35_ = array_var;
		if (VALA_IS_LOCAL_VARIABLE (_tmp35_)) {
			_tmp34_ = TRUE;
		} else {
			ValaSymbol* _tmp36_;
			_tmp36_ = array_var;
			_tmp34_ = VALA_IS_FIELD (_tmp36_);
		}
		_tmp37_ = _tmp34_;
		_tmp23_ = _tmp37_;
	} else {
...
static ValaCCodeParameter* vala_ccode_array_module_real_generate_parameter (ValaCCodeMethodModule* base, ValaParameter* param, ValaCCodeFile* decl_space, ValaMap* cparam_map, ValaMap* carg_map) {
	...
	if (!VALA_IS_ARRAY_TYPE (_tmp2_)) {
		...
		_tmp5_ = cparam_map;
		_tmp6_ = carg_map;
		_tmp7_ = VALA_CCODE_METHOD_MODULE_CLASS (vala_ccode_array_module_parent_class)->generate_parameter ((ValaCCodeMethodModule*) VALA_CCODE_METHOD_CALL_MODULE (self), _tmp3_, _tmp4_, _tmp5_, _tmp6_);
		result = _tmp7_;
		return result;
	}
	_tmp8_ = param;
	...
	_tmp27_ = _tmp26_;
	_tmp28_ = _vala_code_node_ref0 (VALA_ARRAY_TYPE (_tmp27_));
	array_type = _tmp28_;
	_tmp29_ = array_type;
	...
	_tmp37_ = main_cparam;
	vala_map_set (_tmp33_, GINT_TO_POINTER (_tmp36_), _tmp37_);
	_tmp38_ = carg_map;
	if (_tmp38_ != NULL) {
		ValaMap* _tmp39_;
		...
		_tmp47_ = _tmp46_;
		vala_map_set (_tmp39_, GINT_TO_POINTER (_tmp42_), _tmp47_);
		_vala_ccode_node_unref0 (_tmp47_);
	}
	_tmp48_ = param;
		...
		}
		{
			...
			dim = 1;
			{
				...
				while (TRUE) {
					...
					_tmp81_ = cparam;
					vala_map_set (_tmp76_, GINT_TO_POINTER (_tmp80_), _tmp81_);
					_tmp82_ = carg_map;
					if (_tmp82_ != NULL) {
						ValaMap* _tmp83_;
						...
						_tmp92_ = _tmp91_;
						vala_map_set (_tmp83_, GINT_TO_POINTER (_tmp87_), _tmp92_);
						_vala_ccode_node_unref0 (_tmp92_);
					}

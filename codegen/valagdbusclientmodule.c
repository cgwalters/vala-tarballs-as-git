...
static void vala_gd_bus_client_module_real_generate_dynamic_method_wrapper (ValaCCodeBaseModule* base, ValaDynamicMethod* method) {
	...
	_tmp0_ = method;
	_tmp1_ = _vala_code_node_ref0 (VALA_DYNAMIC_METHOD (_tmp0_));
	...
	g_return_if_fail (iface != NULL);
	{
		...
		while (TRUE) {
			...
			if (VALA_IS_INTERFACE (_tmp13_)) {
				...
				_tmp17_ = _tmp16_;
				vala_gd_bus_client_module_generate_proxy_interface_init (self, _tmp14_, VALA_INTERFACE (_tmp17_));
			}
	...
	_result_ = _tmp0_;
	{
		...
		while (TRUE) {
			...
			if (VALA_IS_INTERFACE (_tmp14_)) {
				...
				_tmp20_ = _tmp19_;
				_tmp21_ = vala_gd_bus_client_module_implement_interface (self, _tmp16_, _tmp17_, VALA_INTERFACE (_tmp20_));
				_tmp22_ = _tmp21_;
...
static void vala_gd_bus_client_module_real_generate_interface_declaration (ValaCCodeBaseModule* base, ValaInterface* iface, ValaCCodeFile* decl_space) {
	...
	_tmp0_ = iface;
	_tmp1_ = decl_space;
	VALA_CCODE_BASE_MODULE_CLASS (vala_gd_bus_client_module_parent_class)->generate_interface_declaration ((ValaCCodeBaseModule*) VALA_GD_BUS_MODULE (self), _tmp0_, _tmp1_);
	_tmp2_ = iface;
...
static void vala_gd_bus_client_module_real_visit_interface (ValaCodeVisitor* base, ValaInterface* iface) {
	...
	g_return_if_fail (iface != NULL);
	_tmp0_ = iface;
	VALA_CODE_VISITOR_CLASS (vala_gd_bus_client_module_parent_class)->visit_interface ((ValaCodeVisitor*) VALA_GD_BUS_MODULE (self), _tmp0_);
	_tmp1_ = iface;
...
static void vala_gd_bus_client_module_real_visit_method_call (ValaCodeVisitor* base, ValaMethodCall* expr) {
	...
	_tmp4_ = _tmp3_;
	_tmp5_ = _vala_code_node_ref0 (VALA_IS_METHOD_TYPE (_tmp4_) ? ((ValaMethodType*) _tmp4_) : NULL);
	mtype = _tmp5_;
	_tmp7_ = mtype;
	if (_tmp7_ != NULL) {
	...
	if (_tmp47_) {
		...
		_tmp48_ = expr;
		VALA_CODE_VISITOR_CLASS (vala_gd_bus_client_module_parent_class)->visit_method_call ((ValaCodeVisitor*) VALA_GD_BUS_MODULE (self), _tmp48_);
	...
	_tmp51_ = _tmp50_;
	_tmp52_ = _vala_code_node_ref0 (VALA_MEMBER_ACCESS (_tmp51_));
	ma = _tmp52_;
	_tmp53_ = ma;
	...
	type_arg = _tmp57_;
	_tmp58_ = type_arg;
	_tmp59_ = _vala_code_node_ref0 (VALA_IS_OBJECT_TYPE (_tmp58_) ? ((ValaObjectType*) _tmp58_) : NULL);
	object_type = _tmp59_;
	_tmp60_ = object_type;
	if (_tmp60_ != NULL) {
		...
		_tmp63_ = _tmp62_;
		_tmp64_ = _vala_code_node_ref0 (VALA_INTERFACE (_tmp63_));
		iface = _tmp64_;
		_tmp65_ = iface;
	...
	if (_tmp309_) {
		...
		if (_tmp335_) {
			...
			_tmp338_ = _tmp337_;
			_tmp339_ = _vala_code_node_ref0 (VALA_MEMBER_ACCESS (_tmp338_));
			inner_ma = _tmp339_;
			_tmp340_ = inner_ma;
...
static gchar* vala_gd_bus_client_module_generate_dbus_signal_handler (ValaGDBusClientModule* self, ValaSignal* sig, ValaObjectTypeSymbol* sym) {
	...
	_vala_ccode_node_unref0 (_tmp52_);
	{
		...
		while (TRUE) {
			...
			_tmp90_ = _tmp89_;
			_tmp91_ = _vala_code_node_ref0 (VALA_IS_STRUCT (_tmp90_) ? ((ValaStruct*) _tmp90_) : NULL);
			st = _tmp91_;
			_tmp93_ = st;
			if (_tmp93_ != NULL) {
				ValaStruct* _tmp94_;
			...
			if (VALA_IS_ARRAY_TYPE (_tmp109_)) {
				...
				_tmp112_ = _tmp111_;
				_tmp113_ = _vala_code_node_ref0 (VALA_ARRAY_TYPE (_tmp112_));
				array_type = _tmp113_;
				{
					gint dim;
					dim = 1;
...
static void vala_gd_bus_client_module_generate_marshalling (ValaGDBusClientModule* self, ValaMethod* m, ValaGDBusClientModuleCallType call_type, const gchar* iface_name, const gchar* method_name) {
	...
	if (_tmp14_ != VALA_GD_BUS_CLIENT_MODULE_CALL_TYPE_FINISH) {
		...
		vala_ccode_function_call_add_argument (_tmp37_, (ValaCCodeExpression*) _tmp38_);
		{
			...
			while (TRUE) {
				...
				_tmp50_ = error_type;
				_tmp51_ = _vala_code_node_ref0 (VALA_ERROR_TYPE (_tmp50_));
				errtype = _tmp51_;
				_tmp52_ = errtype;
		...
		cancellable = (ValaCCodeExpression*) _tmp132_;
		{
			...
			while (TRUE) {
				...
				if (_tmp146_ == VALA_PARAMETER_DIRECTION_IN) {
					...
					_tmp163_ = _tmp162_;
					if (VALA_IS_OBJECT_TYPE (_tmp163_)) {
					...
					_tmp177_ = _tmp176_;
					if (VALA_IS_OBJECT_TYPE (_tmp177_)) {
	...
	if (_tmp387_) {
		...
		_tmp434_ = _tmp433_;
		has_result = !VALA_IS_VOID_TYPE (_tmp434_);
		_tmp435_ = uses_fd;
		if (_tmp435_) {
		...
		if (_tmp456_) {
			...
			vala_ccode_function_add_expression (_tmp489_, (ValaCCodeExpression*) _tmp490_);
			{
				...
				while (TRUE) {
					...
					if (_tmp504_ == VALA_PARAMETER_DIRECTION_OUT) {
						...
						_tmp521_ = _tmp520_;
						_tmp522_ = _vala_code_node_ref0 (VALA_IS_ARRAY_TYPE (_tmp521_) ? ((ValaArrayType*) _tmp521_) : NULL);
						array_type = _tmp522_;
						_tmp523_ = array_type;
						if (_tmp523_ != NULL) {
							{
			...
			if (!VALA_IS_VOID_TYPE (_tmp623_)) {
				...
				if (_tmp627_) {
					...
					_tmp652_ = _tmp651_;
					_tmp653_ = _vala_code_node_ref0 (VALA_IS_ARRAY_TYPE (_tmp652_) ? ((ValaArrayType*) _tmp652_) : NULL);
					array_type = _tmp653_;
					_tmp654_ = array_type;
					if (_tmp654_ != NULL) {
						{
...
static gchar* vala_gd_bus_client_module_generate_async_dbus_proxy_method (ValaGDBusClientModule* self, ValaInterface* main_iface, ValaInterface* iface, ValaMethod* m) {
	...
	_tmp17_ = _tmp16_;
	vala_map_set ((ValaMap*) cparam_map, GINT_TO_POINTER (_tmp15_), _tmp17_);
	...
	_tmp20_ = _tmp19_;
	vala_map_set ((ValaMap*) cparam_map, GINT_TO_POINTER (_tmp18_), _tmp20_);
	_vala_ccode_node_unref0 (_tmp20_);
	_tmp21_ = m;
...
static gchar* vala_gd_bus_client_module_generate_dbus_proxy_property_get (ValaGDBusClientModule* self, ValaInterface* main_iface, ValaInterface* iface, ValaProperty* prop) {
	...
	_tmp39_ = _tmp38_;
	_tmp40_ = _vala_code_node_ref0 (VALA_IS_ARRAY_TYPE (_tmp39_) ? ((ValaArrayType*) _tmp39_) : NULL);
	array_type = _tmp40_;
	_tmp41_ = proxy_name;
...
static gchar* vala_gd_bus_client_module_generate_dbus_proxy_property_set (ValaGDBusClientModule* self, ValaInterface* main_iface, ValaInterface* iface, ValaProperty* prop) {
	...
	_tmp13_ = vala_property_accessor_get_value_type (_tmp12_);
	_tmp14_ = _tmp13_;
	_tmp15_ = _vala_code_node_ref0 (VALA_IS_ARRAY_TYPE (_tmp14_) ? ((ValaArrayType*) _tmp14_) : NULL);
	array_type = _tmp15_;
	_tmp16_ = proxy_name;

...
static ValaCCodeFragment* vala_class_register_function_real_get_type_interface_init_declaration (ValaTypeRegisterFunction* base) {
	...
	frag = _tmp0_;
	{
		...
		while (TRUE) {
			...
			_tmp17_ = _tmp16_;
			_tmp18_ = _vala_code_node_ref0 (VALA_INTERFACE (_tmp17_));
			iface = _tmp18_;
			_tmp19_ = iface;
...
static void vala_class_register_function_real_get_type_interface_init_statements (ValaTypeRegisterFunction* base, ValaCCodeBlock* block, gboolean plugin) {
	...
	g_return_if_fail (block != NULL);
	{
		...
		while (TRUE) {
			...
			_tmp16_ = _tmp15_;
			_tmp17_ = _vala_code_node_ref0 (VALA_INTERFACE (_tmp16_));
			iface = _tmp17_;
			_tmp18_ = iface;
	...
	vala_ccode_base_module_register_dbus_info (VALA_CCODE_BASE_MODULE (_tmp86_), _tmp87_, (ValaObjectTypeSymbol*) _tmp88_);
}

		...
		if (VALA_IS_VOID_TYPE (_tmp7_)) {
			...
			if (_tmp11_ == _tmp14_) {
				...
				if (VALA_IS_CLASS (_tmp19_)) {
					...
					_tmp22_ = _tmp21_;
					_tmp16_ = VALA_IS_INTERFACE (_tmp22_);
				}
				_tmp23_ = _tmp16_;
				if (_tmp23_) {
					gchar* _tmp24_;
...
static ValaCCodeExpression* vala_gsignal_module_get_signal_name_cexpression (ValaGSignalModule* self, ValaSignal* sig, ValaExpression* detail_expr, ValaCodeNode* node) {
	...
	_tmp17_ = detail_expr;
	if (VALA_IS_STRING_LITERAL (_tmp17_)) {
		ValaSignal* _tmp18_;
		...
		_tmp18_ = sig;
		_tmp19_ = detail_expr;
		_tmp20_ = vala_string_literal_eval (VALA_STRING_LITERAL (_tmp19_));
		_tmp21_ = _tmp20_;
	...
	if (_tmp14_ != NULL) {
		{
			...
			while (TRUE) {
				...
				_tmp33_ = _tmp32_;
				_tmp34_ = VALA_IS_SIGNAL (_tmp33_);
...
static void vala_gsignal_module_generate_marshaller (ValaGSignalModule* self, ValaList* params, ValaDataType* return_type) {
		...
		while (TRUE) {
			...
			if (_tmp244_ != VALA_PARAMETER_DIRECTION_IN) {
				...
				if (_tmp246_) {
					...
					_tmp249_ = _tmp248_;
					_tmp250_ = vala_array_type_get_element_type (VALA_ARRAY_TYPE (_tmp249_));
					_tmp251_ = _tmp250_;
					...
					_tmp262_ = _tmp261_;
					if (VALA_IS_POINTER_TYPE (_tmp262_)) {
						_tmp259_ = TRUE;
					} else {
					...
					if (_tmp268_) {
						...
						_tmp272_ = _tmp271_;
						if (VALA_IS_ERROR_TYPE (_tmp272_)) {
							gchar* _tmp273_;
	...
	if (_tmp324_) {
		...
		if (_tmp331_) {
			...
			_tmp333_ = vala_array_type_get_element_type (VALA_ARRAY_TYPE (_tmp332_));
			_tmp334_ = _tmp333_;
			...
			if (_tmp348_ != NULL) {
				...
				if (VALA_IS_ERROR_TYPE (_tmp352_)) {
					...
					if (_tmp358_ == _tmp361_) {
						...
						if (VALA_IS_CLASS (_tmp368_)) {
							...
							_tmp371_ = _tmp370_;
							_tmp365_ = VALA_IS_INTERFACE (_tmp371_);
						}
						_tmp372_ = _tmp365_;
						if (_tmp372_) {
...
static ValaCCodeFunctionCall* vala_gsignal_module_real_get_signal_creation (ValaCCodeBaseModule* base, ValaSignal* sig, ValaTypeSymbol* type) {
	...
	if (_tmp53_ == NULL) {
		...
		if (VALA_IS_CLASS (_tmp61_)) {
			...
			_tmp71_ = type;
			_tmp72_ = vala_ccode_base_module_get_ccode_type_name (VALA_INTERFACE (_tmp71_));
			_tmp73_ = _tmp72_;
	...
	if (_tmp115_) {
		...
		_tmp121_ = _tmp120_;
		if (VALA_IS_ERROR_TYPE (_tmp121_)) {
	...
	_g_free0 (_tmp163_);
	{
		...
		while (TRUE) {
			...
			if (_tmp180_) {
				...
				_tmp183_ = _tmp182_;
				_tmp184_ = vala_array_type_get_element_type (VALA_ARRAY_TYPE (_tmp183_));
				_tmp185_ = _tmp184_;
				...
				if (_tmp214_) {
					...
					_tmp220_ = _tmp219_;
					if (VALA_IS_ERROR_TYPE (_tmp220_)) {
...
static void vala_gsignal_module_real_visit_element_access (ValaCodeVisitor* base, ValaElementAccess* expr) {
	...
	_tmp3_ = _tmp2_;
	if (VALA_IS_MEMBER_ACCESS (_tmp3_)) {
	...
	if (_tmp9_) {
		...
		_tmp12_ = _tmp11_;
		if (VALA_IS_METHOD_CALL (_tmp12_)) {
			...
			_tmp15_ = _tmp14_;
			_tmp16_ = _vala_code_node_ref0 (VALA_SIGNAL (_tmp15_));
			sig = _tmp16_;
			_tmp17_ = expr;
			_tmp18_ = vala_element_access_get_container (_tmp17_);
			_tmp19_ = _tmp18_;
			_tmp20_ = _vala_code_node_ref0 (VALA_MEMBER_ACCESS (_tmp19_));
			ma = _tmp20_;
			_tmp21_ = expr;
		...
		_tmp45_ = expr;
		VALA_CODE_VISITOR_CLASS (vala_gsignal_module_parent_class)->visit_element_access ((ValaCodeVisitor*) VALA_GOBJECT_MODULE (self), _tmp45_);
	}
}
...
static void vala_gsignal_module_real_visit_assignment (ValaCodeVisitor* base, ValaAssignment* assignment) {
	...
	if (VALA_IS_SIGNAL (_tmp4_)) {
		...
		_tmp19_ = assignment;
		VALA_CODE_VISITOR_CLASS (vala_gsignal_module_parent_class)->visit_assignment ((ValaCodeVisitor*) VALA_GOBJECT_MODULE (self), _tmp19_);
	}
}
...
static void vala_gsignal_module_real_visit_member_access (ValaCodeVisitor* base, ValaMemberAccess* expr) {
	...
	if (VALA_IS_SIGNAL (_tmp2_)) {
		...
		_tmp12_ = _tmp11_;
		_tmp13_ = _vala_code_node_ref0 (VALA_SIGNAL (_tmp12_));
		sig = _tmp13_;
		_tmp14_ = sig;
		_tmp15_ = vala_symbol_get_parent_symbol ((ValaSymbol*) _tmp14_);
		_tmp16_ = _tmp15_;
		_tmp17_ = _vala_code_node_ref0 (VALA_TYPESYMBOL (_tmp16_));
		cl = _tmp17_;
		_tmp19_ = expr;
		_tmp20_ = vala_member_access_get_inner (_tmp19_);
		_tmp21_ = _tmp20_;
		if (VALA_IS_BASE_ACCESS (_tmp21_)) {
			ValaSignal* _tmp22_;
			gboolean _tmp23_;
			gboolean _tmp24_;
			_tmp22_ = sig;
		...
		_tmp89_ = expr;
		VALA_CODE_VISITOR_CLASS (vala_gsignal_module_parent_class)->visit_member_access ((ValaCodeVisitor*) VALA_GOBJECT_MODULE (self), _tmp89_);
	}
}
...
static void vala_gsignal_module_real_visit_method_call (ValaCodeVisitor* base, ValaMethodCall* expr) {
	...
	if (_tmp7_ == NULL) {
		...
		_tmp12_ = _tmp11_;
		_tmp6_ = !VALA_IS_SIGNAL (_tmp12_);
	}
	_tmp13_ = _tmp6_;
	if (_tmp13_) {
		ValaMethodCall* _tmp14_;
		_tmp14_ = expr;
		VALA_CODE_VISITOR_CLASS (vala_gsignal_module_parent_class)->visit_method_call ((ValaCodeVisitor*) VALA_GOBJECT_MODULE (self), _tmp14_);
	...
	_tmp19_ = _tmp18_;
	_tmp20_ = _vala_code_node_ref0 (VALA_SIGNAL (_tmp19_));
	sig = _tmp20_;
	_tmp21_ = expr;
	_tmp22_ = vala_method_call_get_call (_tmp21_);
	_tmp23_ = _tmp22_;
	_tmp24_ = vala_member_access_get_inner (VALA_MEMBER_ACCESS (_tmp23_));
	_tmp25_ = _tmp24_;
...
static ValaCCodeExpression* vala_gsignal_module_connect_signal (ValaGSignalModule* self, ValaSignal* sig, ValaExpression* signal_access, ValaExpression* handler, gboolean disconnect, gboolean after, ValaCodeNode* expr) {
	...
	_tmp2_ = _tmp1_;
	_tmp3_ = _vala_code_node_ref0 (VALA_METHOD (_tmp2_));
	m = _tmp3_;
	_tmp4_ = disconnect;
	if (!_tmp4_) {
		ValaSignal* _tmp5_;
		_tmp5_ = sig;
		if (VALA_IS_DYNAMIC_SIGNAL (_tmp5_)) {
			gboolean _tmp6_;
			_tmp6_ = after;
			if (!_tmp6_) {
				ValaSignal* _tmp7_;
				gchar* _tmp8_ = NULL;
				_tmp7_ = sig;
				_tmp8_ = vala_ccode_base_module_get_dynamic_signal_connect_wrapper_name ((ValaCCodeBaseModule*) self, VALA_DYNAMIC_SIGNAL (_tmp7_));
				...
				gchar* _tmp10_ = NULL;
				_tmp9_ = sig;
				_tmp10_ = vala_ccode_base_module_get_dynamic_signal_connect_after_wrapper_name ((ValaCCodeBaseModule*) self, VALA_DYNAMIC_SIGNAL (_tmp9_));
				_g_free0 (connect_func);
		...
		ValaSignal* _tmp25_;
		_tmp21_ = handler;
		if (VALA_IS_LAMBDA_EXPRESSION (_tmp21_)) {
			ValaExpression* _tmp22_;
...
".");
		...
		_tmp25_ = sig;
		if (VALA_IS_DYNAMIC_SIGNAL (_tmp25_)) {
			ValaSignal* _tmp26_;
			gchar* _tmp27_ = NULL;
			_tmp26_ = sig;
			_tmp27_ = vala_ccode_base_module_get_dynamic_signal_disconnect_wrapper_name ((ValaCCodeBaseModule*) self, VALA_DYNAMIC_SIGNAL (_tmp26_));
			_g_free0 (connect_func);
	...
	if (VALA_IS_ELEMENT_ACCESS (_tmp34_)) {
		...
		_tmp36_ = _vala_code_node_ref0 (VALA_ELEMENT_ACCESS (_tmp35_));
		ea = _tmp36_;
		_tmp37_ = ea;
		_tmp38_ = vala_element_access_get_container (_tmp37_);
		_tmp39_ = _tmp38_;
		_tmp40_ = _vala_code_node_ref0 (VALA_MEMBER_ACCESS (_tmp39_));
		_vala_code_node_unref0 (ma);
		ma = _tmp40_;
		_tmp41_ = ea;
	...
	if (_tmp58_ != NULL) {
		...
		_tmp64_ = VALA_CCODE_EXPRESSION (_tmp63_);
	...
	_tmp68_ = sig;
	if (VALA_IS_DYNAMIC_SIGNAL (_tmp68_)) {
		...
		if (!_tmp77_) {
			...
			if (!VALA_IS_ELEMENT_ACCESS (_tmp80_)) {
				ValaCCodeFunctionCall* _tmp81_;
...
"GNAL_MATCH_DATA");
			...
			_tmp98_ = _tmp97_;
			_tmp99_ = _vala_code_node_ref0 (VALA_TYPESYMBOL (_tmp98_));
			decl_type = _tmp99_;
			_tmp100_ = parse_call;
			_tmp101_ = decl_type;
			...
			if (!VALA_IS_ELEMENT_ACCESS (_tmp114_)) {
	...
	if (_tmp165_) {
		...
		if (_tmp184_ == VALA_MEMBER_BINDING_INSTANCE) {
			...
			if (VALA_IS_MEMBER_ACCESS (_tmp185_)) {
				...
				_tmp186_ = handler;
				_tmp187_ = _vala_code_node_ref0 (VALA_MEMBER_ACCESS (_tmp186_));
				right_ma = _tmp187_;
				_tmp188_ = right_ma;
				...
				_tmp200_ = handler;
				if (VALA_IS_LAMBDA_EXPRESSION (_tmp200_)) {
			...
			if (!_tmp206_) {
				ValaSignal* _tmp207_;
				_tmp207_ = sig;
				_tmp205_ = !VALA_IS_DYNAMIC_SIGNAL (_tmp207_);
			} else {
				_tmp205_ = FALSE;
			}
			_tmp208_ = _tmp205_;
	...
	if (_tmp223_) {
		...
		_tmp226_ = _tmp225_;
		_tmp222_ = VALA_IS_EXPRESSION_STATEMENT (_tmp226_);
	}
	_tmp227_ = _tmp222_;
	if (_tmp227_) {

	...
	if (!_tmp129_) {
		...
		}
		{
			...
			while (TRUE) {
				...
				_tmp170_ = _tmp169_;
				if (VALA_IS_OBJECT_TYPE (_tmp170_)) {
				...
				_tmp199_ = _tmp198_;
				_tmp200_ = _vala_code_node_ref0 (VALA_IS_ARRAY_TYPE (_tmp199_) ? ((ValaArrayType*) _tmp199_) : NULL);
				array_type = _tmp200_;
				_tmp201_ = array_type;
				if (_tmp201_ != NULL) {
					{
	...
	}
	{
		...
		while (TRUE) {
			...
			if (_tmp290_) {
				...
				_tmp294_ = _tmp293_;
				if (VALA_IS_OBJECT_TYPE (_tmp294_)) {
				...
				_tmp309_ = _tmp308_;
				if (VALA_IS_OBJECT_TYPE (_tmp309_)) {
				...
				_tmp331_ = _tmp330_;
				_tmp332_ = _vala_code_node_ref0 (VALA_IS_STRUCT (_tmp331_) ? ((ValaStruct*) _tmp331_) : NULL);
				st = _tmp332_;
				_tmp334_ = st;
				if (_tmp334_ != NULL) {
					ValaStruct* _tmp335_;
			...
			_tmp367_ = _tmp366_;
			_tmp368_ = _vala_code_node_ref0 (VALA_IS_ARRAY_TYPE (_tmp367_) ? ((ValaArrayType*) _tmp367_) : NULL);
			array_type = _tmp368_;
			_tmp369_ = array_type;
			if (_tmp369_ != NULL) {
				{
	...
	if (_tmp415_) {
		...
		if (!VALA_IS_VOID_TYPE (_tmp418_)) {
			...
			if (_tmp422_) {
				...
				_tmp430_ = _tmp429_;
				_tmp431_ = _vala_code_node_ref0 (VALA_IS_ARRAY_TYPE (_tmp430_) ? ((ValaArrayType*) _tmp430_) : NULL);
				array_type = _tmp431_;
				_tmp432_ = array_type;
				if (_tmp432_ != NULL) {
					{
	...
	if (_tmp490_) {
		...
		}
		{
			...
			while (TRUE) {
				...
				_tmp630_ = _tmp629_;
				_tmp631_ = _vala_code_node_ref0 (VALA_IS_ARRAY_TYPE (_tmp630_) ? ((ValaArrayType*) _tmp630_) : NULL);
				array_type = _tmp631_;
				_tmp632_ = array_type;
				if (_tmp632_ != NULL) {
					{
		...
		if (!VALA_IS_VOID_TYPE (_tmp661_)) {
			...
			if (_tmp665_) {
				...
				_tmp712_ = _tmp711_;
				_tmp713_ = _vala_code_node_ref0 (VALA_IS_ARRAY_TYPE (_tmp712_) ? ((ValaArrayType*) _tmp712_) : NULL);
				array_type = _tmp713_;
				_tmp714_ = array_type;
				if (_tmp714_ != NULL) {
					{
	...
	}
	{
		...
		while (TRUE) {
			...
			if (_tmp836_) {
				...
				_tmp840_ = _tmp839_;
				if (VALA_IS_OBJECT_TYPE (_tmp840_)) {
				...
				_tmp852_ = _tmp851_;
				if (VALA_IS_OBJECT_TYPE (_tmp852_)) {
	...
	_vala_ccode_node_unref0 (_tmp13_);
	{
		...
		while (TRUE) {
			...
			if (VALA_IS_ARRAY_TYPE (_tmp38_)) {
				...
				_tmp41_ = _tmp40_;
				_tmp42_ = _vala_code_node_ref0 (VALA_ARRAY_TYPE (_tmp41_));
				array_type = _tmp42_;
				{
					gint dim;
					dim = 1;
...
static gchar* vala_gd_bus_server_module_generate_dbus_property_get_wrapper (ValaGDBusServerModule* self, ValaProperty* prop, ValaObjectTypeSymbol* sym) {
	...
	if (_tmp36_) {
		...
		_tmp83_ = _tmp82_;
		_tmp84_ = _vala_code_node_ref0 (VALA_IS_ARRAY_TYPE (_tmp83_) ? ((ValaArrayType*) _tmp83_) : NULL);
		array_type = _tmp84_;
		_tmp85_ = array_type;
		if (_tmp85_ != NULL) {
			{
				...
				dim = 1;
				{
					...
					while (TRUE) {
						...
						_tmp99_ = _tmp98_;
						vala_ccode_function_add_declaration (_tmp96_, "int", (ValaCCodeDeclarator*) _tmp99_, 0);
						_vala_ccode_node_unref0 (_tmp99_);
						_tmp100_ = ccall;
						_tmp101_ = length_cname;
	...
	_tmp108_ = _tmp107_;
	_tmp109_ = vala_property_accessor_get_value_type (_tmp108_);
	_tmp110_ = _tmp109_;
	_tmp111_ = vala_ccode_identifier_new ("result");
	_tmp112_ = _tmp111_;
	_tmp113_ = vala_ccode_base_module_serialize_expression ((ValaCCodeBaseModule*) self, _tmp110_, (ValaCCodeExpression*) _tmp112_);
	_tmp114_ = _tmp113_;
	...
	_tmp124_ = prop;
	_tmp125_ = vala_property_get_get_accessor (_tmp124_);
	_tmp126_ = _tmp125_;
	_tmp127_ = vala_property_accessor_get_value_type (_tmp126_);
	_tmp128_ = _tmp127_;
	_tmp129_ = vala_ccode_base_module_requires_destroy ((ValaCCodeBaseModule*) self, _tmp128_);
	if (_tmp129_) {
		...
		ValaLocalVariable* _tmp138_;
		ValaCCodeExpression* _tmp139_ = NULL;
		ValaCCodeExpression* _tmp140_;
		_tmp130_ = prop;
		_tmp131_ = vala_property_get_get_accessor (_tmp130_);
		_tmp132_ = _tmp131_;
		_tmp133_ = vala_property_accessor_get_value_type (_tmp132_);
		_tmp134_ = _tmp133_;
		_tmp135_ = vala_local_variable_new (_tmp134_, ".result", NULL, NULL);
		local = _tmp135_;
		_tmp136_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
		_tmp137_ = _tmp136_;
		_tmp138_ = local;
		_tmp139_ = vala_ccode_base_module_destroy_local ((ValaCCodeBaseModule*) self, _tmp138_);
		_tmp140_ = _tmp139_;
		vala_ccode_function_add_expression (_tmp137_, _tmp140_);
		_vala_ccode_node_unref0 (_tmp140_);
		_vala_code_node_unref0 (local);
	}
	_tmp141_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
	_tmp142_ = _tmp141_;
	_tmp143_ = vala_ccode_identifier_new ("_reply");
	_tmp144_ = _tmp143_;
	vala_ccode_function_add_return (_tmp142_, (ValaCCodeExpression*) _tmp144_);
...
static gchar* vala_gd_bus_server_module_generate_dbus_property_set_wrapper (ValaGDBusServerModule* self, ValaProperty* prop, ValaObjectTypeSymbol* sym) {
	...
	_tmp55_ = _tmp54_;
	_tmp56_ = _vala_code_node_ref0 (VALA_IS_STRUCT (_tmp55_) ? ((ValaStruct*) _tmp55_) : NULL);
	st = _tmp56_;
	_tmp58_ = st;
	if (_tmp58_ != NULL) {
		ValaStruct* _tmp59_;
	...
	if (_tmp61_) {
		...
		_tmp72_ = _tmp71_;
		_tmp73_ = _vala_code_node_ref0 (VALA_IS_ARRAY_TYPE (_tmp72_) ? ((ValaArrayType*) _tmp72_) : NULL);
		array_type = _tmp73_;
		_tmp74_ = array_type;
		if (_tmp74_ != NULL) {
			{
...
static ValaCCodeExpression* vala_gd_bus_server_module_get_method_info (ValaGDBusServerModule* self, ValaObjectTypeSymbol* sym) {
	...
	infos = _tmp0_;
	{
		...
		while (TRUE) {
			...
			_tmp15_ = m;
			if (VALA_IS_CREATION_METHOD (_tmp15_)) {
				_tmp14_ = TRUE;
			} else {
				ValaMethod* _tmp16_;
			...
			out_args_info = _tmp31_;
			{
				...
				while (TRUE) {
					...
					_tmp46_ = _tmp45_;
					if (VALA_IS_OBJECT_TYPE (_tmp46_)) {
					...
					_tmp58_ = _tmp57_;
					if (VALA_IS_OBJECT_TYPE (_tmp58_)) {
...
static void vala_gd_bus_server_module_real_visit_method_call (ValaCodeVisitor* base, ValaMethodCall* expr) {
	...
	if (_tmp13_) {
		...
		_tmp14_ = expr;
		VALA_CODE_VISITOR_CLASS (vala_gd_bus_server_module_parent_class)->visit_method_call ((ValaCodeVisitor*) VALA_GD_BUS_CLIENT_MODULE (self), _tmp14_);
	...
	_tmp17_ = _tmp16_;
	_tmp18_ = _vala_code_node_ref0 (VALA_MEMBER_ACCESS (_tmp17_));
	ma = _tmp18_;
	_tmp19_ = ma;
	...
	type_arg = _tmp23_;
	_tmp24_ = type_arg;
	_tmp25_ = _vala_code_node_ref0 (VALA_IS_OBJECT_TYPE (_tmp24_) ? ((ValaObjectType*) _tmp24_) : NULL);
	object_type = _tmp25_;
	_tmp26_ = object_type;
	if (_tmp26_ != NULL) {
...
" = ...)] attribute");
	...
	_tmp82_ = _tmp81_;
	if (VALA_IS_EXPRESSION_STATEMENT (_tmp82_)) {
		ValaCCodeFunction* _tmp83_;
...
static void vala_gd_bus_server_module_real_generate_class_declaration (ValaCCodeBaseModule* base, ValaClass* cl, ValaCCodeFile* decl_space) {
	...
	_tmp0_ = cl;
	_tmp1_ = decl_space;
	VALA_CCODE_BASE_MODULE_CLASS (vala_gd_bus_server_module_parent_class)->generate_class_declaration ((ValaCCodeBaseModule*) VALA_GD_BUS_CLIENT_MODULE (self), _tmp0_, _tmp1_);
	_tmp2_ = cl;
	_tmp3_ = decl_space;
...
static void vala_gd_bus_server_module_real_generate_interface_declaration (ValaCCodeBaseModule* base, ValaInterface* iface, ValaCCodeFile* decl_space) {
	...
	_tmp0_ = iface;
	_tmp1_ = decl_space;
	VALA_CCODE_BASE_MODULE_CLASS (vala_gd_bus_server_module_parent_class)->generate_interface_declaration ((ValaCCodeBaseModule*) VALA_GD_BUS_CLIENT_MODULE (self), _tmp0_, _tmp1_);
	_tmp2_ = iface;
	_tmp3_ = decl_space;
	vala_gd_bus_server_module_generate_object_type_symbol_declaration (self, (ValaObjectTypeSymbol*) _tmp2_, _tmp3_);
}
...
static void vala_gd_bus_server_module_real_visit_class (ValaCodeVisitor* base, ValaClass* cl) {
	...
	g_return_if_fail (cl != NULL);
	_tmp0_ = cl;
	VALA_CODE_VISITOR_CLASS (vala_gd_bus_server_module_parent_class)->visit_class ((ValaCodeVisitor*) VALA_GD_BUS_CLIENT_MODULE (self), _tmp0_);
	_tmp1_ = cl;
...
static void vala_gd_bus_server_module_real_visit_interface (ValaCodeVisitor* base, ValaInterface* iface) {
	...
	g_return_if_fail (iface != NULL);
	_tmp0_ = iface;
	VALA_CODE_VISITOR_CLASS (vala_gd_bus_server_module_parent_class)->visit_interface ((ValaCodeVisitor*) VALA_GD_BUS_CLIENT_MODULE (self), _tmp0_);
	_tmp1_ = iface;
	vala_gd_bus_server_module_visit_object_type_symbol (self, (ValaObjectTypeSymbol*) _tmp1_);
}
...
static void vala_gd_bus_server_module_real_register_dbus_info (ValaCCodeBaseModule* base, ValaCCodeBlock* block, ValaObjectTypeSymbol* sym) {
	...
	_tmp3_ = block;
	_tmp4_ = sym;
	VALA_CCODE_BASE_MODULE_CLASS (vala_gd_bus_server_module_parent_class)->register_dbus_info ((ValaCCodeBaseModule*) VALA_GD_BUS_CLIENT_MODULE (self), _tmp3_, _tmp4_);
